...
void main() {
	...
	`}class O$ extends d8{constructor(J=1,Q={}){super(J,J,Q);this.isWebGLCubeRenderTarget=!0;let $={width:J,height:J,depth:1},W=[$,$,$,$,$,$];this.texture=new s7(W),this._setTextureOptions(Q),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(J,Q){this.texture.type=Q.type,this.texture.colorSpace=Q.colorSpace,this.texture.generateMipmaps=Q.generateMipmaps,this.texture.minFilter=Q.minFilter,this.texture.magFilter=Q.magFilter;let $={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},W=new V6(5,5,5),Z=new T8({name:"CubemapFromEquirect",uniforms:s9($.uniforms),vertexShader:$.vertexShader,fragmentShader:$.fragmentShader,side:P8,blending:e8});Z.uniforms.tEquirect.value=Q;let K=new b8(W,Z),H=Q.minFilter;if(Q.minFilter===p9)Q.minFilter=A8;return new Q$(1,10,this).update(J,K),Q.minFilter=H,K.geometry.dispose(),K.material.dispose(),this}clear(J,Q=!0,$=!0,W=!0){let Z=J.getRenderTarget();for(let K=0;K<6;K++)J.setRenderTarget(this,K),J.clear(Q,$,W);J.setRenderTarget(Z)}}function hX(J){let Q=new WeakMap,$=new WeakMap,W=null;function Z(G,D=!1){if(G===null||G===void 0)return null;if(D)return H(G);return K(G)}function K(G){if(G&&G.isTexture){let D=G.mapping;if(D===z7||D===I7)if(Q.has(G)){let k=Q.get(G).texture;return Y(k,G.mapping)}else{let k=G.image;if(k&&k.height>0){let z=new O$(k.height);return z.fromEquirectangularTexture(J,G),Q.set(G,z),G.addEventListener("dispose",U),Y(z.texture,G.mapping)}else return null}}return G}function H(G){if(G&&G.isTexture){let D=G.mapping,k=D===z7||D===I7,z=D===k6||D===g9;if(k||z){let F=$.get(G),q=F!==void 0?F.texture.pmremVersion:0;if(G.isRenderTargetTexture&&G.pmremVersion!==q){if(W===null)W=new q$(J);return F=k?W.fromEquirectangular(G,F):W.fromCubemap(G,F),F.texture.pmremVersion=G.pmremVersion,$.set(G,F),F.texture}else if(F!==void 0)return F.texture;else{let A=G.image;if(k&&A&&A.height>0||z&&A&&X(A)){if(W===null)W=new q$(J);return F=k?W.fromEquirectangular(G):W.fromCubemap(G),F.texture.pmremVersion=G.pmremVersion,$.set(G,F),G.addEventListener("dispose",N),F.texture}else return null}}}return G}function Y(G,D){if(D===z7)G.mapping=k6;else if(D===I7)G.mapping=g9;return G}function X(G){let D=0,k=6;for(let z=0;z<k;z++)if(G[z]!==void 0)D++;return D===k}function U(G){let D=G.target;D.removeEventListener("dispose",U);let k=Q.get(D);if(k!==void 0)Q.delete(D),k.dispose()}function N(G){let D=G.target;D.removeEventListener("dispose",N);let k=$.get(D);if(k!==void 0)$.delete(D),k.dispose()}function E(){if(Q=new WeakMap,$=new WeakMap,W!==null)W.dispose(),W=null}return{get:Z,dispose:E}}function bX(J){let Q={};function $(W){if(Q[W]!==void 0)return Q[W];let Z=J.getExtension(W);return Q[W]=Z,Z}return{has:function(W){return $(W)!==null},init:function(){$("EXT_color_buffer_float"),$("WEBGL_clip_cull_distance"),$("OES_texture_float_linear"),$("EXT_color_buffer_half_float"),$("WEBGL_multisampled_render_to_texture"),$("WEBGL_render_shared_exponent")},get:function(W){let Z=$(W);if(Z===null)x9("WebGLRenderer: "+W+" extension not supported.");return Z}}}function xX(J,Q,$,W){let Z={},K=new WeakMap;function H(E){let G=E.target;if(G.index!==null)Q.remove(G.index);for(let k in G.attributes)Q.remove(G.attributes[k]);G.removeEventListener("dispose",H),delete Z[G.id];let D=K.get(G);if(D)Q.remove(D),K.delete(G);if(W.releaseStatesOfGeometry(G),G.isInstancedBufferGeometry===!0)delete G._maxInstanceCount;$.memory.geometries--}function Y(E,G){if(Z[G.id]===!0)return G;return G.addEventListener("dispose",H),Z[G.id]=!0,$.memory.geometries++,G}function X(E){let G=E.attributes;for(let D in G)Q.update(G[D],J.ARRAY_BUFFER)}function U(E){let G=[],D=E.index,k=E.attributes.position,z=0;if(k===void 0)return;if(D!==null){let A=D.array;z=D.version;for(let C=0,V=A.length;C<V;C+=3){let _=A[C+0],I=A[C+1],P=A[C+2];G.push(_,I,I,P,P,_)}}else{let A=k.array;z=k.version;for(let C=0,V=A.length/3-1;C<V;C+=3){let _=C+0,I=C+1,P=C+2;G.push(_,I,I,P,P,_)}}let F=new(k.count>=65535?l7:m7)(G,1);F.version=z;let q=K.get(E);if(q)Q.remove(q);K.set(E,F)}function N(E){let G=K.get(E);if(G){let D=E.index;if(D!==null){if(G.version<D.version)U(E)}}else U(E);return K.get(E)}return{get:Y,update:X,getWireframeAttribute:N}}function gX(J,Q,$){let W;function Z(E){W=E}let K,H;function Y(E){K=E.type,H=E.bytesPerElement}function X(E,G){J.drawElements(W,G,K,E*H),$.update(G,W,1)}function U(E,G,D){if(D===0)return;J.drawElementsInstanced(W,G,K,E*H,D),$.update(G,W,D)}function N(E,G,D){if(D===0)return;Q.get("WEBGL_multi_draw").multiDrawElementsWEBGL(W,G,0,K,E,0,D);let z=0;for(let F=0;F<D;F++)z+=G[F];$.update(z,W,1)}this.setMode=Z,this.setIndex=Y,this.render=X,this.renderInstances=U,this.renderMultiDraw=N}function pX(J){let Q={geometries:0,textures:0},$={frame:0,calls:0,triangles:0,points:0,lines:0};function W(K,H,Y){switch($.calls++,H){case J.TRIANGLES:$.triangles+=Y*(K/3);break;case J.LINES:$.lines+=Y*(K/2);break;case J.LINE_STRIP:$.lines+=Y*(K-1);break;case J.LINE_LOOP:$.lines+=Y*K;break;case J.POINTS:$.points+=Y*K;break;default:w0("WebGLInfo: Unknown draw mode:",H);break}}function Z(){$.calls=0,$.triangles=0,$.points=0,$.lines=0}return{memory:Q,render:$,programs:null,autoReset:!0,reset:Z,update:W}}function mX(J,Q,$){let W=new WeakMap,Z=new K8;function K(H,Y,X){let U=H.morphTargetInfluences,N=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,E=N!==void 0?N.length:0,G=W.get(Y);if(G===void 0||G.count!==E){let B=function(){P.dispose(),W.delete(Y),Y.removeEventListener("dispose",B)};if(G!==void 0)G.texture.dispose();let D=Y.morphAttributes.position!==void 0,k=Y.morphAttributes.normal!==void 0,z=Y.morphAttributes.color!==void 0,F=Y.morphAttributes.position||[],q=Y.morphAttributes.normal||[],A=Y.morphAttributes.color||[],C=0;if(D===!0)C=1;if(k===!0)C=2;if(z===!0)C=3;let V=Y.attributes.position.count*C,_=1;if(V>Q.maxTextureSize)_=Math.ceil(V/Q.maxTextureSize),V=Q.maxTextureSize;let I=new Float32Array(V*_*4*E),P=new x7(I,V,_,E);P.type=E9,P.needsUpdate=!0;let M=C*4;for(let l=0;l<E;l++){let w=F[l],m=q[l],o=A[l],p=V*_*4*l;for(let n=0;n<w.count;n++){let u=n*M;if(D===!0)Z.fromBufferAttribute(w,n),I[p+u+0]=Z.x,I[p+u+1]=Z.y,I[p+u+2]=Z.z,I[p+u+3]=0;if(k===!0)Z.fromBufferAttribute(m,n),I[p+u+4]=Z.x,I[p+u+5]=Z.y,I[p+u+6]=Z.z,I[p+u+7]=0;if(z===!0)Z.fromBufferAttribute(o,n),I[p+u+8]=Z.x,I[p+u+9]=Z.y,I[p+u+10]=Z.z,I[p+u+11]=o.itemSize===4?Z.w:1}}G={count:E,texture:P,size:new u0(V,_)},W.set(Y,G),Y.addEventListener("dispose",B)}if(H.isInstancedMesh===!0&&H.morphTexture!==null)X.getUniforms().setValue(J,"morphTexture",H.morphTexture,$);else{let D=0;for(let z=0;z<U.length;z++)D+=U[z];let k=Y.morphTargetsRelative?1:1-D;X.getUniforms().setValue(J,"morphTargetBaseInfluence",k),X.getUniforms().setValue(J,"morphTargetInfluences",U)}X.getUniforms().setValue(J,"morphTargetsTexture",G.texture,$),X.getUniforms().setValue(J,"morphTargetsTextureSize",G.size)}return{update:K}}function lX(J,Q,$,W,Z){let K=new WeakMap;function H(U){let N=Z.render.frame,E=U.geometry,G=Q.get(U,E);if(K.get(G)!==N)Q.update(G),K.set(G,N);if(U.isInstancedMesh){if(U.hasEventListener("dispose",X)===!1)U.addEventListener("dispose",X);if(K.get(U)!==N){if($.update(U.instanceMatrix,J.ARRAY_BUFFER),U.instanceColor!==null)$.update(U.instanceColor,J.ARRAY_BUFFER);K.set(U,N)}}if(U.isSkinnedMesh){let D=U.skeleton;if(K.get(D)!==N)D.update(),K.set(D,N)}return G}function Y(){K=new WeakMap}function X(U){let N=U.target;if(N.removeEventListener("dispose",X),W.releaseStatesOfObject(N),$.remove(N.instanceMatrix),N.instanceColor!==null)$.remove(N.instanceColor)}return{update:H,dispose:Y}}var dX={[xJ]:"LINEAR_TONE_MAPPING",[gJ]:"REINHARD_TONE_MAPPING",[pJ]:"CINEON_TONE_MAPPING",[mJ]:"ACES_FILMIC_TONE_MAPPING",[dJ]:"AGX_TONE_MAPPING",[uJ]:"NEUTRAL_TONE_MAPPING",[lJ]:"CUSTOM_TONE_MAPPING"};function uX(J,Q,$,W,Z,K){let H=new d8(Q,$,{type:J,depthBuffer:Z,stencilBuffer:K,samples:W?4:0,depthTexture:Z?new P9(Q,$):void 0}),Y=new d8(Q,$,{type:q9,depthBuffer:!1,stencilBuffer:!1}),X=new k8;X.setAttribute("position",new f8([-1,3,0,-1,-1,0,3,-1,0],3)),X.setAttribute("uv",new f8([0,2,0,0,2,0],2));let U=new lQ({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
