...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:$9,depthTest:!1,depthWrite:!1})}function NU(J,Q,$){let Z=new Float32Array(e9),W=new y(0,1,0);return new T8({name:"SphericalGaussianBlur",defines:{n:e9,CUBEUV_TEXEL_WIDTH:1/Q,CUBEUV_TEXEL_HEIGHT:1/$,CUBEUV_MAX_MIP:`${J}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:Z},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:W}},vertexShader:KJ(),fragmentShader:`
		...
		`,blending:$9,depthTest:!1,depthWrite:!1})}function wW(){return new T8({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:KJ(),fragmentShader:`
		...
		`,blending:$9,depthTest:!1,depthWrite:!1})}function TW(){return new T8({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:KJ(),fragmentShader:`
	...
	`}class A$ extends c8{constructor(J=1,Q={}){super(J,J,Q);this.isWebGLCubeRenderTarget=!0;let $={width:J,height:J,depth:1},Z=[$,$,$,$,$,$];this.texture=new t7(Z),this._setTextureOptions(Q),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(J,Q){this.texture.type=Q.type,this.texture.colorSpace=Q.colorSpace,this.texture.generateMipmaps=Q.generateMipmaps,this.texture.minFilter=Q.minFilter,this.texture.magFilter=Q.magFilter;let $={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},Z=new z6(5,5,5),W=new T8({name:"CubemapFromEquirect",uniforms:o9($.uniforms),vertexShader:$.vertexShader,fragmentShader:$.fragmentShader,side:w8,blending:$9});W.uniforms.tEquirect.value=Q;let K=new x8(Z,W),H=Q.minFilter;if(Q.minFilter===l9)Q.minFilter=_8;return new E$(1,10,this).update(J,K),Q.minFilter=H,K.geometry.dispose(),K.material.dispose(),this}clear(J,Q=!0,$=!0,Z=!0){let W=J.getRenderTarget();for(let K=0;K<6;K++)J.setRenderTarget(this,K),J.clear(Q,$,Z);J.setRenderTarget(W)}}function EU(J){let Q=new WeakMap,$=new WeakMap,Z=null;function W(G,F=!1){if(G===null||G===void 0)return null;if(F)return H(G);return K(G)}function K(G){if(G&&G.isTexture){let F=G.mapping;if(F===A7||F===P7)if(Q.has(G)){let R=Q.get(G).texture;return Y(R,G.mapping)}else{let R=G.image;if(R&&R.height>0){let z=new A$(R.height);return z.fromEquirectangularTexture(J,G),Q.set(G,z),G.addEventListener("dispose",U),Y(z.texture,G.mapping)}else return null}}return G}function H(G){if(G&&G.isTexture){let F=G.mapping,R=F===A7||F===P7,z=F===V6||F===m9;if(R||z){let D=$.get(G),q=D!==void 0?D.texture.pmremVersion:0;if(G.isRenderTargetTexture&&G.pmremVersion!==q){if(Z===null)Z=new I$(J);return D=R?Z.fromEquirectangular(G,D):Z.fromCubemap(G,D),D.texture.pmremVersion=G.pmremVersion,$.set(G,D),D.texture}else if(D!==void 0)return D.texture;else{let _=G.image;if(R&&_&&_.height>0||z&&_&&X(_)){if(Z===null)Z=new I$(J);return D=R?Z.fromEquirectangular(G):Z.fromCubemap(G),D.texture.pmremVersion=G.pmremVersion,$.set(G,D),G.addEventListener("dispose",E),D.texture}else return null}}}return G}function Y(G,F){if(F===A7)G.mapping=V6;else if(F===P7)G.mapping=m9;return G}function X(G){let F=0,R=6;for(let z=0;z<R;z++)if(G[z]!==void 0)F++;return F===R}function U(G){let F=G.target;F.removeEventListener("dispose",U);let R=Q.get(F);if(R!==void 0)Q.delete(F),R.dispose()}function E(G){let F=G.target;F.removeEventListener("dispose",E);let R=$.get(F);if(R!==void 0)$.delete(F),R.dispose()}function N(){if(Q=new WeakMap,$=new WeakMap,Z!==null)Z.dispose(),Z=null}return{get:W,dispose:N}}function qU(J){let Q={};function $(Z){if(Q[Z]!==void 0)return Q[Z];let W=J.getExtension(Z);return Q[Z]=W,W}return{has:function(Z){return $(Z)!==null},init:function(){$("EXT_color_buffer_float"),$("WEBGL_clip_cull_distance"),$("OES_texture_float_linear"),$("EXT_color_buffer_half_float"),$("WEBGL_multisampled_render_to_texture"),$("WEBGL_render_shared_exponent")},get:function(Z){let W=$(Z);if(W===null)p9("WebGLRenderer: "+Z+" extension not supported.");return W}}}function FU(J,Q,$,Z){let W={},K=new WeakMap;function H(N){let G=N.target;if(G.index!==null)Q.remove(G.index);for(let R in G.attributes)Q.remove(G.attributes[R]);G.removeEventListener("dispose",H),delete W[G.id];let F=K.get(G);if(F)Q.remove(F),K.delete(G);if(Z.releaseStatesOfGeometry(G),G.isInstancedBufferGeometry===!0)delete G._maxInstanceCount;$.memory.geometries--}function Y(N,G){if(W[G.id]===!0)return G;return G.addEventListener("dispose",H),W[G.id]=!0,$.memory.geometries++,G}function X(N){let G=N.attributes;for(let F in G)Q.update(G[F],J.ARRAY_BUFFER)}function U(N){let G=[],F=N.index,R=N.attributes.position,z=0;if(R===void 0)return;if(F!==null){let _=F.array;z=F.version;for(let A=0,V=_.length;A<V;A+=3){let I=_[A+0],C=_[A+1],w=_[A+2];G.push(I,C,C,w,w,I)}}else{let _=R.array;z=R.version;for(let A=0,V=_.length/3-1;A<V;A+=3){let I=A+0,C=A+1,w=A+2;G.push(I,C,C,w,w,I)}}let D=new(R.count>=65535?n7:c7)(G,1);D.version=z;let q=K.get(N);if(q)Q.remove(q);K.set(N,D)}function E(N){let G=K.get(N);if(G){let F=N.index;if(F!==null){if(G.version<F.version)U(N)}}else U(N);return K.get(N)}return{get:Y,update:X,getWireframeAttribute:E}}function DU(J,Q,$){let Z;function W(N){Z=N}let K,H;function Y(N){K=N.type,H=N.bytesPerElement}function X(N,G){J.drawElements(Z,G,K,N*H),$.update(G,Z,1)}function U(N,G,F){if(F===0)return;J.drawElementsInstanced(Z,G,K,N*H,F),$.update(G,Z,F)}function E(N,G,F){if(F===0)return;Q.get("WEBGL_multi_draw").multiDrawElementsWEBGL(Z,G,0,K,N,0,F);let z=0;for(let D=0;D<F;D++)z+=G[D];$.update(z,Z,1)}this.setMode=W,this.setIndex=Y,this.render=X,this.renderInstances=U,this.renderMultiDraw=E}function OU(J){let Q={geometries:0,textures:0},$={frame:0,calls:0,triangles:0,points:0,lines:0};function Z(K,H,Y){switch($.calls++,H){case J.TRIANGLES:$.triangles+=Y*(K/3);break;case J.LINES:$.lines+=Y*(K/2);break;case J.LINE_STRIP:$.lines+=Y*(K-1);break;case J.LINE_LOOP:$.lines+=Y*K;break;case J.POINTS:$.points+=Y*K;break;default:P0("WebGLInfo: Unknown draw mode:",H);break}}function W(){$.calls=0,$.triangles=0,$.points=0,$.lines=0}return{memory:Q,render:$,programs:null,autoReset:!0,reset:W,update:Z}}function MU(J,Q,$){let Z=new WeakMap,W=new K8;function K(H,Y,X){let U=H.morphTargetInfluences,E=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,N=E!==void 0?E.length:0,G=Z.get(Y);if(G===void 0||G.count!==N){let B=function(){w.dispose(),Z.delete(Y),Y.removeEventListener("dispose",B)};if(G!==void 0)G.texture.dispose();let F=Y.morphAttributes.position!==void 0,R=Y.morphAttributes.normal!==void 0,z=Y.morphAttributes.color!==void 0,D=Y.morphAttributes.position||[],q=Y.morphAttributes.normal||[],_=Y.morphAttributes.color||[],A=0;if(F===!0)A=1;if(R===!0)A=2;if(z===!0)A=3;let V=Y.attributes.position.count*A,I=1;if(V>Q.maxTextureSize)I=Math.ceil(V/Q.maxTextureSize),V=Q.maxTextureSize;let C=new Float32Array(V*I*4*N),w=new l7(C,V,I,N);w.type=F9,w.needsUpdate=!0;let M=A*4;for(let d=0;d<N;d++){let P=D[d],h=q[d],o=_[d],g=V*I*4*d;for(let c=0;c<P.count;c++){let p=c*M;if(F===!0)W.fromBufferAttribute(P,c),C[g+p+0]=W.x,C[g+p+1]=W.y,C[g+p+2]=W.z,C[g+p+3]=0;if(R===!0)W.fromBufferAttribute(h,c),C[g+p+4]=W.x,C[g+p+5]=W.y,C[g+p+6]=W.z,C[g+p+7]=0;if(z===!0)W.fromBufferAttribute(o,c),C[g+p+8]=W.x,C[g+p+9]=W.y,C[g+p+10]=W.z,C[g+p+11]=o.itemSize===4?W.w:1}}G={count:N,texture:w,size:new n0(V,I)},Z.set(Y,G),Y.addEventListener("dispose",B)}if(H.isInstancedMesh===!0&&H.morphTexture!==null)X.getUniforms().setValue(J,"morphTexture",H.morphTexture,$);else{let F=0;for(let z=0;z<U.length;z++)F+=U[z];let R=Y.morphTargetsRelative?1:1-F;X.getUniforms().setValue(J,"morphTargetBaseInfluence",R),X.getUniforms().setValue(J,"morphTargetInfluences",U)}X.getUniforms().setValue(J,"morphTargetsTexture",G.texture,$),X.getUniforms().setValue(J,"morphTargetsTextureSize",G.size)}return{update:K}}function RU(J,Q,$,Z,W){let K=new WeakMap;function H(U){let E=W.render.frame,N=U.geometry,G=Q.get(U,N);if(K.get(G)!==E)Q.update(G),K.set(G,E);if(U.isInstancedMesh){if(U.hasEventListener("dispose",X)===!1)U.addEventListener("dispose",X);if(K.get(U)!==E){if($.update(U.instanceMatrix,J.ARRAY_BUFFER),U.instanceColor!==null)$.update(U.instanceColor,J.ARRAY_BUFFER);K.set(U,E)}}if(U.isSkinnedMesh){let F=U.skeleton;if(K.get(F)!==E)F.update(),K.set(F,E)}return G}function Y(){K=new WeakMap}function X(U){let E=U.target;if(E.removeEventListener("dispose",X),Z.releaseStatesOfObject(E),$.remove(E.instanceMatrix),E.instanceColor!==null)$.remove(E.instanceColor)}return{update:H,dispose:Y}}var kU={[oJ]:"LINEAR_TONE_MAPPING",[aJ]:"REINHARD_TONE_MAPPING",[rJ]:"CINEON_TONE_MAPPING",[tJ]:"ACES_FILMIC_TONE_MAPPING",[JQ]:"AGX_TONE_MAPPING",[QQ]:"NEUTRAL_TONE_MAPPING",[eJ]:"CUSTOM_TONE_MAPPING"};function LU(J,Q,$,Z,W,K){let H=new c8(Q,$,{type:J,depthBuffer:W,stencilBuffer:K,samples:Z?4:0,depthTexture:W?new j9(Q,$):void 0}),Y=new c8(Q,$,{type:D9,depthBuffer:!1,stencilBuffer:!1}),X=new C8;X.setAttribute("position",new b8([-1,3,0,-1,-1,0,3,-1,0],3)),X.setAttribute("uv",new b8([0,2,0,0,2,0],2));let U=new eQ({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),E=new x8(X,U),N=new I6(-1,1,1,-1,0,1),G=null,F=null,R=!1,z,D=null,q=[],_=!1;this.setSize=function(A,V){H.setSize(A,V),Y.setSize(A,V);for(let I=0;I<q.length;I++){let C=q[I];if(C.setSize)C.setSize(A,V)}},this.setEffects=function(A){q=A,_=q.length>0&&q[0].isRenderPass===!0;let{width:V,height:I}=H;for(let C=0;C<q.length;C++){let w=q[C];if(w.setSize)w.setSize(V,I)}},this.begin=function(A,V){if(R)return!1;if(A.toneMapping===a8&&q.length===0)return!1;if(D=V,V!==null){let{width:I,height:C}=V;if(H.width!==I||H.height!==C)this.setSize(I,C)}if(_===!1)A.setRenderTarget(H);return z=A.toneMapping,A.toneMapping=a8,!0},this.hasRenderPass=function(){return _},this.end=function(A,V){A.toneMapping=z,R=!0;let I=H,C=Y;for(let w=0;w<q.length;w++){let M=q[w];if(M.enabled===!1)continue;if(M.render(A,C,I,V),M.needsSwap!==!1){let B=I;I=C,C=B}}if(G!==A.outputColorSpace||F!==A.toneMapping){if(G=A.outputColorSpace,F=A.toneMapping,U.defines={},g0.getTransfer(G)===e0)U.defines.SRGB_TRANSFER="";let w=kU[F];if(w)U.defines[w]="";U.needsUpdate=!0}U.uniforms.tDiffuse.value=I.texture,A.setRenderTarget(D),A.render(E,N),D=null,R=!1},this.isCompositing=function(){return R},this.dispose=function(){if(H.depthTexture)H.depthTexture.dispose();H.dispose(),Y.dispose(),X.dispose(),U.dispose()}}var aW=new z8,_$=new j9(1,1),rW=new l7,tW=new sQ,eW=new t7,SW=[],jW=[],vW=new Float32Array(16),fW=new Float32Array(9),yW=new Float32Array(4);function C6(J,Q,$){let Z=J[0];if(Z<=0||Z>0)return J;let W=Q*$,K=SW[W];if(K===void 0)K=new Float32Array(W),SW[W]=K;if(Q!==0){Z.toArray(K,0);for(let H=1,Y=0;H!==Q;++H)Y+=$,J[H].toArray(K,Y)}return K}function q8(J,Q){if(J.length!==Q.length)return!1;for(let $=0,Z=J.length;$<Z;$++)if(J[$]!==Q[$])return!1;return!0}function F8(J,Q){for(let $=0,Z=Q.length;$<Z;$++)J[$]=Q[$]}function HJ(J,Q){let $=jW[Q];if($===void 0)$=new Int32Array(Q),jW[Q]=$;for(let Z=0;Z!==Q;++Z)$[Z]=J.allocateTextureUnit();return $}function VU(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1f(this.addr,Q),$[0]=Q}function BU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2f(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(q8($,Q))return;J.uniform2fv(this.addr,Q),F8($,Q)}}function zU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3f(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else if(Q.r!==void 0){if($[0]!==Q.r||$[1]!==Q.g||$[2]!==Q.b)J.uniform3f(this.addr,Q.r,Q.g,Q.b),$[0]=Q.r,$[1]=Q.g,$[2]=Q.b}else{if(q8($,Q))return;J.uniform3fv(this.addr,Q),F8($,Q)}}function IU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4f(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(q8($,Q))return;J.uniform4fv(this.addr,Q),F8($,Q)}}function _U(J,Q){let $=this.cache,Z=Q.elements;if(Z===void 0){if(q8($,Q))return;J.uniformMatrix2fv(this.addr,!1,Q),F8($,Q)}else{if(q8($,Z))return;yW.set(Z),J.uniformMatrix2fv(this.addr,!1,yW),F8($,Z)}}function CU(J,Q){let $=this.cache,Z=Q.elements;if(Z===void 0){if(q8($,Q))return;J.uniformMatrix3fv(this.addr,!1,Q),F8($,Q)}else{if(q8($,Z))return;fW.set(Z),J.uniformMatrix3fv(this.addr,!1,fW),F8($,Z)}}function AU(J,Q){let $=this.cache,Z=Q.elements;if(Z===void 0){if(q8($,Q))return;J.uniformMatrix4fv(this.addr,!1,Q),F8($,Q)}else{if(q8($,Z))return;vW.set(Z),J.uniformMatrix4fv(this.addr,!1,vW),F8($,Z)}}function PU(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1i(this.addr,Q),$[0]=Q}function wU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2i(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(q8($,Q))return;J.uniform2iv(this.addr,Q),F8($,Q)}}function TU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3i(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(q8($,Q))return;J.uniform3iv(this.addr,Q),F8($,Q)}}function SU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4i(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(q8($,Q))return;J.uniform4iv(this.addr,Q),F8($,Q)}}function jU(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1ui(this.addr,Q),$[0]=Q}function vU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2ui(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(q8($,Q))return;J.uniform2uiv(this.addr,Q),F8($,Q)}}function fU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3ui(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(q8($,Q))return;J.uniform3uiv(this.addr,Q),F8($,Q)}}function yU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4ui(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(q8($,Q))return;J.uniform4uiv(this.addr,Q),F8($,Q)}}function bU(J,Q,$){let Z=this.cache,W=$.allocateTextureUnit();if(Z[0]!==W)J.uniform1i(this.addr,W),Z[0]=W;let K;if(this.type===J.SAMPLER_2D_SHADOW)_$.compareFunction=$.isReversedDepthBuffer()?m7:p7,K=_$;else K=aW;$.setTexture2D(Q||K,W)}function hU(J,Q,$){let Z=this.cache,W=$.allocateTextureUnit();if(Z[0]!==W)J.uniform1i(this.addr,W),Z[0]=W;$.setTexture3D(Q||tW,W)}function xU(J,Q,$){let Z=this.cache,W=$.allocateTextureUnit();if(Z[0]!==W)J.uniform1i(this.addr,W),Z[0]=W;$.setTextureCube(Q||eW,W)}function gU(J,Q,$){let Z=this.cache,W=$.allocateTextureUnit();if(Z[0]!==W)J.uniform1i(this.addr,W),Z[0]=W;$.setTexture2DArray(Q||rW,W)}function pU(J){switch(J){case 5126:return VU;case 35664:return BU;case 35665:return zU;case 35666:return IU;case 35674:return _U;case 35675:return CU;case 35676:return AU;case 5124:case 35670:return PU;case 35667:case 35671:return wU;case 35668:case 35672:return TU;case 35669:case 35673:return SU;case 5125:return jU;case 36294:return vU;case 36295:return fU;case 36296:return yU;case 35678:case 36198:case 36298:case 36306:case 35682:return bU;case 35679:case 36299:case 36307:return hU;case 35680:case 36300:case 36308:case 36293:return xU;case 36289:case 36303:case 36311:case 36292:return gU}}function mU(J,Q){J.uniform1fv(this.addr,Q)}function lU(J,Q){let $=C6(Q,this.size,2);J.uniform2fv(this.addr,$)}function dU(J,Q){let $=C6(Q,this.size,3);J.uniform3fv(this.addr,$)}function uU(J,Q){let $=C6(Q,this.size,4);J.uniform4fv(this.addr,$)}function cU(J,Q){let $=C6(Q,this.size,4);J.uniformMatrix2fv(this.addr,!1,$)}function nU(J,Q){let $=C6(Q,this.size,9);J.uniformMatrix3fv(this.addr,!1,$)}function sU(J,Q){let $=C6(Q,this.size,16);J.uniformMatrix4fv(this.addr,!1,$)}function iU(J,Q){J.uniform1iv(this.addr,Q)}function oU(J,Q){J.uniform2iv(this.addr,Q)}function aU(J,Q){J.uniform3iv(this.addr,Q)}function rU(J,Q){J.uniform4iv(this.addr,Q)}function tU(J,Q){J.uniform1uiv(this.addr,Q)}function eU(J,Q){J.uniform2uiv(this.addr,Q)}function J5(J,Q){J.uniform3uiv(this.addr,Q)}function Q5(J,Q){J.uniform4uiv(this.addr,Q)}function $5(J,Q,$){let Z=this.cache,W=Q.length,K=HJ($,W);if(!q8(Z,K))J.uniform1iv(this.addr,K),F8(Z,K);let H;if(this.type===J.SAMPLER_2D_SHADOW)H=_$;else H=aW;for(let Y=0;Y!==W;++Y)$.setTexture2D(Q[Y]||H,K[Y])}function Z5(J,Q,$){let Z=this.cache,W=Q.length,K=HJ($,W);if(!q8(Z,K))J.uniform1iv(this.addr,K),F8(Z,K);for(let H=0;H!==W;++H)$.setTexture3D(Q[H]||tW,K[H])}function W5(J,Q,$){let Z=this.cache,W=Q.length,K=HJ($,W);if(!q8(Z,K))J.uniform1iv(this.addr,K),F8(Z,K);for(let H=0;H!==W;++H)$.setTextureCube(Q[H]||eW,K[H])}function K5(J,Q,$){let Z=this.cache,W=Q.length,K=HJ($,W);if(!q8(Z,K))J.uniform1iv(this.addr,K),F8(Z,K);for(let H=0;H!==W;++H)$.setTexture2DArray(Q[H]||rW,K[H])}function H5(J){switch(J){case 5126:return mU;case 35664:return lU;case 35665:return dU;case 35666:return uU;case 35674:return cU;case 35675:return nU;case 35676:return sU;case 5124:case 35670:return iU;case 35667:case 35671:return oU;case 35668:case 35672:return aU;case 35669:case 35673:return rU;case 5125:return tU;case 36294:return eU;case 36295:return J5;case 36296:return Q5;case 35678:case 36198:case 36298:case 36306:case 35682:return $5;case 35679:case 36299:case 36307:return Z5;case 35680:case 36300:case 36308:case 36293:return W5;case 36289:case 36303:case 36311:case 36292:return K5}}class JK{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.setValue=pU(Q.type)}}class QK{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.size=Q.size,this.setValue=H5(Q.type)}}class $K{constructor(J){this.id=J,this.seq=[],this.map={}}setValue(J,Q,$){let Z=this.seq;for(let W=0,K=Z.length;W!==K;++W){let H=Z[W];H.setValue(J,Q[H.id],$)}}}var B$=/(\w+)(\])?(\[|\.)?/g;function bW(J,Q){J.seq.push(Q),J.map[Q.id]=Q}function Y5(J,Q,$){let Z=J.name,W=Z.length;B$.lastIndex=0;while(!0){let K=B$.exec(Z),H=B$.lastIndex,Y=K[1],X=K[2]==="]",U=K[3];if(X)Y=Y|0;if(U===void 0||U==="["&&H+2===W){bW($,U===void 0?new JK(Y,J,Q):new QK(Y,J,Q));break}else{let N=$.map[Y];if(N===void 0)N=new $K(Y),bW($,N);$=N}}}class i6{constructor(J,Q){this.seq=[],this.map={};let $=J.getProgramParameter(Q,J.ACTIVE_UNIFORMS);for(let K=0;K<$;++K){let H=J.getActiveUniform(Q,K),Y=J.getUniformLocation(Q,H.name);Y5(H,Y,this)}let Z=[],W=[];for(let K of this.seq)if(K.type===J.SAMPLER_2D_SHADOW||K.type===J.SAMPLER_CUBE_SHADOW||K.type===J.SAMPLER_2D_ARRAY_SHADOW)Z.push(K);else W.push(K);if(Z.length>0)this.seq=Z.concat(W)}setValue(J,Q,$,Z){let W=this.map[Q];if(W!==void 0)W.setValue(J,$,Z)}setOptional(J,Q,$){let Z=Q[$];if(Z!==void 0)this.setValue(J,$,Z)}static upload(J,Q,$,Z){for(let W=0,K=Q.length;W!==K;++W){let H=Q[W],Y=$[H.id];if(Y.needsUpdate!==!1)H.setValue(J,Y.value,Z)}}static seqWithValue(J,Q){let $=[];for(let Z=0,W=J.length;Z!==W;++Z){let K=J[Z];if(K.id in Q)$.push(K)}return $}}function hW(J,Q,$){let Z=J.createShader(Q);return J.shaderSource(Z,$),J.compileShader(Z),Z}var X5=37297,U5=0;function G5(J,Q){let $=J.split(`
`),Z=[],W=Math.max(Q-6,0),K=Math.min(Q+6,$.length);for(let H=W;H<K;H++){let Y=H+1;Z.push(`${Y===Q?">":" "} ${Y}: ${$[H]}`)}return Z.join(`
`)}var xW=new w0;function N5(J){g0._getMatrix(xW,g0.workingColorSpace,J);let Q=`mat3( ${xW.elements.map(($)=>$.toFixed(4))} )`;switch(g0.getTransfer(J)){case pQ:return[Q,"LinearTransferOETF"];case e0:return[Q,"sRGBTransferOETF"];default:return C0("WebGLProgram: Unsupported color space: ",J),[Q,"LinearTransferOETF"]}}function gW(J,Q,$){let Z=J.getShaderParameter(Q,J.COMPILE_STATUS),K=(J.getShaderInfoLog(Q)||"").trim();if(Z&&K==="")return"";let H=/ERROR: 0:(\d+)/.exec(K);if(H){let Y=parseInt(H[1]);return $.toUpperCase()+`

`+K+`

`+G5(J.getShaderSource(Q),Y)}else return K}function E5(J,Q){let $=N5(Q);return[`vec4 ${J}( vec4 value ) {`,`	return ${$[1]}( vec4( value.rgb * ${$[0]}, value.a ) );`,"}"].join(`
`)}var q5={[oJ]:"Linear",[aJ]:"Reinhard",[rJ]:"Cineon",[tJ]:"ACESFilmic",[JQ]:"AgX",[QQ]:"Neutral",[eJ]:"Custom"};function F5(J,Q){let $=q5[Q];if($===void 0)return C0("WebGLProgram: Unsupported toneMapping:",Q),"vec3 "+J+"( vec3 color ) { return LinearToneMapping( color ); }";return"vec3 "+J+"( vec3 color ) { return "+$+"ToneMapping( color ); }"}var WJ=new y;function D5(){g0.getLuminanceCoefficients(WJ);let J=WJ.x.toFixed(4),Q=WJ.y.toFixed(4),$=WJ.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${Q}, ${$} );`,"\treturn dot( weights, rgb );","}"].join(`
`)}function O5(J){return[J.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",J.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(s6).join(`
`)}function M5(J){let Q=[];for(let $ in J){let Z=J[$];if(Z===!1)continue;Q.push("#define "+$+" "+Z)}return Q.join(`
`)}function R5(J,Q){let $={},Z=J.getProgramParameter(Q,J.ACTIVE_ATTRIBUTES);for(let W=0;W<Z;W++){let K=J.getActiveAttrib(Q,W),H=K.name,Y=1;if(K.type===J.FLOAT_MAT2)Y=2;if(K.type===J.FLOAT_MAT3)Y=3;if(K.type===J.FLOAT_MAT4)Y=4;$[H]={type:K.type,location:J.getAttribLocation(Q,H),locationSize:Y}}return $}function s6(J){return J!==""}function pW(J,Q){let $=Q.numSpotLightShadows+Q.numSpotLightMaps-Q.numSpotLightShadowsWithMaps;return J.replace(/NUM_DIR_LIGHTS/g,Q.numDirLights).replace(/NUM_SPOT_LIGHTS/g,Q.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,Q.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,$).replace(/NUM_RECT_AREA_LIGHTS/g,Q.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,Q.numPointLights).replace(/NUM_HEMI_LIGHTS/g,Q.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,Q.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,Q.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,Q.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,Q.numPointLightShadows)}function mW(J,Q){return J.replace(/NUM_CLIPPING_PLANES/g,Q.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,Q.numClippingPlanes-Q.numClipIntersection)}var k5=/^[ \t]*#include +<([\w\d./]+)>/gm;function C$(J){return J.replace(k5,V5)}var L5=new Map;function V5(J,Q){let $=v0[Q];if($===void 0){let Z=L5.get(Q);if(Z!==void 0)$=v0[Z],C0('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',Q,Z);else throw Error("THREE.WebGLProgram: Can not resolve #include <"+Q+">")}return C$($)}var B5=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function lW(J){return J.replace(B5,z5)}function z5(J,Q,$,Z){let W="";for(let K=parseInt(Q);K<parseInt($);K++)W+=Z.replace(/\[\s*i\s*\]/g,"[ "+K+" ]").replace(/UNROLLED_LOOP_INDEX/g,K);return W}function dW(J){let Q=`precision ${J.precision} float;
...
`)+`
`+q;let A=_+D+H,V=_+q+Y,I=hW(W,W.VERTEX_SHADER,A),C=hW(W,W.FRAGMENT_SHADER,V);if(W.attachShader(z,I),W.attachShader(z,C),$.index0AttributeName!==void 0)W.bindAttribLocation(z,0,$.index0AttributeName);else if($.hasPositionAttribute===!0)W.bindAttribLocation(z,0,"position");W.linkProgram(z);function w(P){if(J.debug.checkShaderErrors){let h=W.getProgramInfoLog(z)||"",o=W.getShaderInfoLog(I)||"",g=W.getShaderInfoLog(C)||"",c=h.trim(),p=o.trim(),f=g.trim(),a=!0,e=!0;if(W.getProgramParameter(z,W.LINK_STATUS)===!1)if(a=!1,typeof J.debug.onShaderError==="function")J.debug.onShaderError(W,z,I,C);else{let J0=gW(W,I,"vertex"),k0=gW(W,C,"fragment");P0("WebGLProgram: Shader Error "+W.getError()+" - VALIDATE_STATUS "+W.getProgramParameter(z,W.VALIDATE_STATUS)+`
...
gl_Position=projectionMatrix*modelViewMatrix*vec4(position.xy*(uContext>0.?max(86.,74./uScale):86.)+center,1.,1.);}`,GK=`
...
void main(){vTint=tint;vMeta=leafMeta;vCluster=leafCluster;vLife=leafLife;gl_PointSize=(uContext>1.?23.:17.)*uDpr;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,FK=`
...
void main(){vAlong=along;vOrder=order;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,MK=`
