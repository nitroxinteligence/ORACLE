...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:$9,depthTest:!1,depthWrite:!1})}function eX(J,$,Q){let W=new Float32Array(t9),Z=new y(0,1,0);return new T8({name:"SphericalGaussianBlur",defines:{n:t9,CUBEUV_TEXEL_WIDTH:1/$,CUBEUV_TEXEL_HEIGHT:1/Q,CUBEUV_MAX_MIP:`${J}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:W},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:Z}},vertexShader:WJ(),fragmentShader:`
	...
	`}class BQ extends c8{constructor(J=1,$={}){super(J,J,$);this.isWebGLCubeRenderTarget=!0;let Q={width:J,height:J,depth:1},W=[Q,Q,Q,Q,Q,Q];this.texture=new a7(W),this._setTextureOptions($),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(J,$){this.texture.type=$.type,this.texture.colorSpace=$.colorSpace,this.texture.generateMipmaps=$.generateMipmaps,this.texture.minFilter=$.minFilter,this.texture.magFilter=$.magFilter;let Q={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},W=new V6(5,5,5),Z=new T8({name:"CubemapFromEquirect",uniforms:i9(Q.uniforms),vertexShader:Q.vertexShader,fragmentShader:Q.fragmentShader,side:w8,blending:$9});Z.uniforms.tEquirect.value=$;let K=new b8(W,Z),H=$.minFilter;if($.minFilter===m9)$.minFilter=_8;return new YQ(1,10,this).update(J,K),$.minFilter=H,K.geometry.dispose(),K.material.dispose(),this}clear(J,$=!0,Q=!0,W=!0){let Z=J.getRenderTarget();for(let K=0;K<6;K++)J.setRenderTarget(this,K),J.clear($,Q,W);J.setRenderTarget(Z)}}function JU(J){let $=new WeakMap,Q=new WeakMap,W=null;function Z(G,D=!1){if(G===null||G===void 0)return null;if(D)return H(G);return K(G)}function K(G){if(G&&G.isTexture){let D=G.mapping;if(D===_7||D===A7)if($.has(G)){let k=$.get(G).texture;return Y(k,G.mapping)}else{let k=G.image;if(k&&k.height>0){let z=new BQ(k.height);return z.fromEquirectangularTexture(J,G),$.set(G,z),G.addEventListener("dispose",U),Y(z.texture,G.mapping)}else return null}}return G}function H(G){if(G&&G.isTexture){let D=G.mapping,k=D===_7||D===A7,z=D===k6||D===p9;if(k||z){let F=Q.get(G),E=F!==void 0?F.texture.pmremVersion:0;if(G.isRenderTargetTexture&&G.pmremVersion!==E){if(W===null)W=new kQ(J);return F=k?W.fromEquirectangular(G,F):W.fromCubemap(G,F),F.texture.pmremVersion=G.pmremVersion,Q.set(G,F),F.texture}else if(F!==void 0)return F.texture;else{let C=G.image;if(k&&C&&C.height>0||z&&C&&X(C)){if(W===null)W=new kQ(J);return F=k?W.fromEquirectangular(G):W.fromCubemap(G),F.texture.pmremVersion=G.pmremVersion,Q.set(G,F),G.addEventListener("dispose",q),F.texture}else return null}}}return G}function Y(G,D){if(D===_7)G.mapping=k6;else if(D===A7)G.mapping=p9;return G}function X(G){let D=0,k=6;for(let z=0;z<k;z++)if(G[z]!==void 0)D++;return D===k}function U(G){let D=G.target;D.removeEventListener("dispose",U);let k=$.get(D);if(k!==void 0)$.delete(D),k.dispose()}function q(G){let D=G.target;D.removeEventListener("dispose",q);let k=Q.get(D);if(k!==void 0)Q.delete(D),k.dispose()}function N(){if($=new WeakMap,Q=new WeakMap,W!==null)W.dispose(),W=null}return{get:Z,dispose:N}}function $U(J){let $={};function Q(W){if($[W]!==void 0)return $[W];let Z=J.getExtension(W);return $[W]=Z,Z}return{has:function(W){return Q(W)!==null},init:function(){Q("EXT_color_buffer_float"),Q("WEBGL_clip_cull_distance"),Q("OES_texture_float_linear"),Q("EXT_color_buffer_half_float"),Q("WEBGL_multisampled_render_to_texture"),Q("WEBGL_render_shared_exponent")},get:function(W){let Z=Q(W);if(Z===null)g9("WebGLRenderer: "+W+" extension not supported.");return Z}}}function QU(J,$,Q,W){let Z={},K=new WeakMap;function H(N){let G=N.target;if(G.index!==null)$.remove(G.index);for(let k in G.attributes)$.remove(G.attributes[k]);G.removeEventListener("dispose",H),delete Z[G.id];let D=K.get(G);if(D)$.remove(D),K.delete(G);if(W.releaseStatesOfGeometry(G),G.isInstancedBufferGeometry===!0)delete G._maxInstanceCount;Q.memory.geometries--}function Y(N,G){if(Z[G.id]===!0)return G;return G.addEventListener("dispose",H),Z[G.id]=!0,Q.memory.geometries++,G}function X(N){let G=N.attributes;for(let D in G)$.update(G[D],J.ARRAY_BUFFER)}function U(N){let G=[],D=N.index,k=N.attributes.position,z=0;if(k===void 0)return;if(D!==null){let C=D.array;z=D.version;for(let A=0,V=C.length;A<V;A+=3){let I=C[A+0],_=C[A+1],w=C[A+2];G.push(I,_,_,w,w,I)}}else{let C=k.array;z=k.version;for(let A=0,V=C.length/3-1;A<V;A+=3){let I=A+0,_=A+1,w=A+2;G.push(I,_,_,w,w,I)}}let F=new(k.count>=65535?c7:u7)(G,1);F.version=z;let E=K.get(N);if(E)$.remove(E);K.set(N,F)}function q(N){let G=K.get(N);if(G){let D=N.index;if(D!==null){if(G.version<D.version)U(N)}}else U(N);return K.get(N)}return{get:Y,update:X,getWireframeAttribute:q}}function WU(J,$,Q){let W;function Z(N){W=N}let K,H;function Y(N){K=N.type,H=N.bytesPerElement}function X(N,G){J.drawElements(W,G,K,N*H),Q.update(G,W,1)}function U(N,G,D){if(D===0)return;J.drawElementsInstanced(W,G,K,N*H,D),Q.update(G,W,D)}function q(N,G,D){if(D===0)return;$.get("WEBGL_multi_draw").multiDrawElementsWEBGL(W,G,0,K,N,0,D);let z=0;for(let F=0;F<D;F++)z+=G[F];Q.update(z,W,1)}this.setMode=Z,this.setIndex=Y,this.render=X,this.renderInstances=U,this.renderMultiDraw=q}function ZU(J){let $={geometries:0,textures:0},Q={frame:0,calls:0,triangles:0,points:0,lines:0};function W(K,H,Y){switch(Q.calls++,H){case J.TRIANGLES:Q.triangles+=Y*(K/3);break;case J.LINES:Q.lines+=Y*(K/2);break;case J.LINE_STRIP:Q.lines+=Y*(K-1);break;case J.LINE_LOOP:Q.lines+=Y*K;break;case J.POINTS:Q.points+=Y*K;break;default:P0("WebGLInfo: Unknown draw mode:",H);break}}function Z(){Q.calls=0,Q.triangles=0,Q.points=0,Q.lines=0}return{memory:$,render:Q,programs:null,autoReset:!0,reset:Z,update:W}}function KU(J,$,Q){let W=new WeakMap,Z=new K8;function K(H,Y,X){let U=H.morphTargetInfluences,q=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,N=q!==void 0?q.length:0,G=W.get(Y);if(G===void 0||G.count!==N){let B=function(){w.dispose(),W.delete(Y),Y.removeEventListener("dispose",B)};if(G!==void 0)G.texture.dispose();let D=Y.morphAttributes.position!==void 0,k=Y.morphAttributes.normal!==void 0,z=Y.morphAttributes.color!==void 0,F=Y.morphAttributes.position||[],E=Y.morphAttributes.normal||[],C=Y.morphAttributes.color||[],A=0;if(D===!0)A=1;if(k===!0)A=2;if(z===!0)A=3;let V=Y.attributes.position.count*A,I=1;if(V>$.maxTextureSize)I=Math.ceil(V/$.maxTextureSize),V=$.maxTextureSize;let _=new Float32Array(V*I*4*N),w=new m7(_,V,I,N);w.type=q9,w.needsUpdate=!0;let M=A*4;for(let d=0;d<N;d++){let P=F[d],b=E[d],o=C[d],g=V*I*4*d;for(let c=0;c<P.count;c++){let m=c*M;if(D===!0)Z.fromBufferAttribute(P,c),_[g+m+0]=Z.x,_[g+m+1]=Z.y,_[g+m+2]=Z.z,_[g+m+3]=0;if(k===!0)Z.fromBufferAttribute(b,c),_[g+m+4]=Z.x,_[g+m+5]=Z.y,_[g+m+6]=Z.z,_[g+m+7]=0;if(z===!0)Z.fromBufferAttribute(o,c),_[g+m+8]=Z.x,_[g+m+9]=Z.y,_[g+m+10]=Z.z,_[g+m+11]=o.itemSize===4?Z.w:1}}G={count:N,texture:w,size:new n0(V,I)},W.set(Y,G),Y.addEventListener("dispose",B)}if(H.isInstancedMesh===!0&&H.morphTexture!==null)X.getUniforms().setValue(J,"morphTexture",H.morphTexture,Q);else{let D=0;for(let z=0;z<U.length;z++)D+=U[z];let k=Y.morphTargetsRelative?1:1-D;X.getUniforms().setValue(J,"morphTargetBaseInfluence",k),X.getUniforms().setValue(J,"morphTargetInfluences",U)}X.getUniforms().setValue(J,"morphTargetsTexture",G.texture,Q),X.getUniforms().setValue(J,"morphTargetsTextureSize",G.size)}return{update:K}}function HU(J,$,Q,W,Z){let K=new WeakMap;function H(U){let q=Z.render.frame,N=U.geometry,G=$.get(U,N);if(K.get(G)!==q)$.update(G),K.set(G,q);if(U.isInstancedMesh){if(U.hasEventListener("dispose",X)===!1)U.addEventListener("dispose",X);if(K.get(U)!==q){if(Q.update(U.instanceMatrix,J.ARRAY_BUFFER),U.instanceColor!==null)Q.update(U.instanceColor,J.ARRAY_BUFFER);K.set(U,q)}}if(U.isSkinnedMesh){let D=U.skeleton;if(K.get(D)!==q)D.update(),K.set(D,q)}return G}function Y(){K=new WeakMap}function X(U){let q=U.target;if(q.removeEventListener("dispose",X),W.releaseStatesOfObject(q),Q.remove(q.instanceMatrix),q.instanceColor!==null)Q.remove(q.instanceColor)}return{update:H,dispose:Y}}var YU={[uJ]:"LINEAR_TONE_MAPPING",[cJ]:"REINHARD_TONE_MAPPING",[nJ]:"CINEON_TONE_MAPPING",[sJ]:"ACES_FILMIC_TONE_MAPPING",[oJ]:"AGX_TONE_MAPPING",[aJ]:"NEUTRAL_TONE_MAPPING",[iJ]:"CUSTOM_TONE_MAPPING"};function XU(J,$,Q,W,Z,K){let H=new c8($,Q,{type:J,depthBuffer:Z,stencilBuffer:K,samples:W?4:0,depthTexture:Z?new T9($,Q):void 0}),Y=new c8($,Q,{type:F9,depthBuffer:!1,stencilBuffer:!1}),X=new L8;X.setAttribute("position",new y8([-1,3,0,-1,-1,0,3,-1,0],3)),X.setAttribute("uv",new y8([0,2,0,0,2,0],2));let U=new i$({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),q=new b8(X,U),N=new B6(-1,1,1,-1,0,1),G=null,D=null,k=!1,z,F=null,E=[],C=!1;this.setSize=function(A,V){H.setSize(A,V),Y.setSize(A,V);for(let I=0;I<E.length;I++){let _=E[I];if(_.setSize)_.setSize(A,V)}},this.setEffects=function(A){E=A,C=E.length>0&&E[0].isRenderPass===!0;let{width:V,height:I}=H;for(let _=0;_<E.length;_++){let w=E[_];if(w.setSize)w.setSize(V,I)}},this.begin=function(A,V){if(k)return!1;if(A.toneMapping===a8&&E.length===0)return!1;if(F=V,V!==null){let{width:I,height:_}=V;if(H.width!==I||H.height!==_)this.setSize(I,_)}if(C===!1)A.setRenderTarget(H);return z=A.toneMapping,A.toneMapping=a8,!0},this.hasRenderPass=function(){return C},this.end=function(A,V){A.toneMapping=z,k=!0;let I=H,_=Y;for(let w=0;w<E.length;w++){let M=E[w];if(M.enabled===!1)continue;if(M.render(A,_,I,V),M.needsSwap!==!1){let B=I;I=_,_=B}}if(G!==A.outputColorSpace||D!==A.toneMapping){if(G=A.outputColorSpace,D=A.toneMapping,U.defines={},g0.getTransfer(G)===e0)U.defines.SRGB_TRANSFER="";let w=YU[D];if(w)U.defines[w]="";U.needsUpdate=!0}U.uniforms.tDiffuse.value=I.texture,A.setRenderTarget(F),A.render(q,N),F=null,k=!1},this.isCompositing=function(){return k},this.dispose=function(){if(H.depthTexture)H.depthTexture.dispose();H.dispose(),Y.dispose(),X.dispose(),U.dispose()}}var pZ=new I8,LQ=new T9(1,1),mZ=new m7,lZ=new l$,dZ=new a7,VZ=[],BZ=[],zZ=new Float32Array(16),IZ=new Float32Array(9),CZ=new Float32Array(4);function I6(J,$,Q){let W=J[0];if(W<=0||W>0)return J;let Z=$*Q,K=VZ[Z];if(K===void 0)K=new Float32Array(Z),VZ[Z]=K;if($!==0){W.toArray(K,0);for(let H=1,Y=0;H!==$;++H)Y+=Q,J[H].toArray(K,Y)}return K}function F8(J,$){if(J.length!==$.length)return!1;for(let Q=0,W=J.length;Q<W;Q++)if(J[Q]!==$[Q])return!1;return!0}function D8(J,$){for(let Q=0,W=$.length;Q<W;Q++)J[Q]=$[Q]}function ZJ(J,$){let Q=BZ[$];if(Q===void 0)Q=new Int32Array($),BZ[$]=Q;for(let W=0;W!==$;++W)Q[W]=J.allocateTextureUnit();return Q}function UU(J,$){let Q=this.cache;if(Q[0]===$)return;J.uniform1f(this.addr,$),Q[0]=$}function GU(J,$){let Q=this.cache;if($.x!==void 0){if(Q[0]!==$.x||Q[1]!==$.y)J.uniform2f(this.addr,$.x,$.y),Q[0]=$.x,Q[1]=$.y}else{if(F8(Q,$))return;J.uniform2fv(this.addr,$),D8(Q,$)}}function NU(J,$){let Q=this.cache;if($.x!==void 0){if(Q[0]!==$.x||Q[1]!==$.y||Q[2]!==$.z)J.uniform3f(this.addr,$.x,$.y,$.z),Q[0]=$.x,Q[1]=$.y,Q[2]=$.z}else if($.r!==void 0){if(Q[0]!==$.r||Q[1]!==$.g||Q[2]!==$.b)J.uniform3f(this.addr,$.r,$.g,$.b),Q[0]=$.r,Q[1]=$.g,Q[2]=$.b}else{if(F8(Q,$))return;J.uniform3fv(this.addr,$),D8(Q,$)}}function EU(J,$){let Q=this.cache;if($.x!==void 0){if(Q[0]!==$.x||Q[1]!==$.y||Q[2]!==$.z||Q[3]!==$.w)J.uniform4f(this.addr,$.x,$.y,$.z,$.w),Q[0]=$.x,Q[1]=$.y,Q[2]=$.z,Q[3]=$.w}else{if(F8(Q,$))return;J.uniform4fv(this.addr,$),D8(Q,$)}}function qU(J,$){let Q=this.cache,W=$.elements;if(W===void 0){if(F8(Q,$))return;J.uniformMatrix2fv(this.addr,!1,$),D8(Q,$)}else{if(F8(Q,W))return;CZ.set(W),J.uniformMatrix2fv(this.addr,!1,CZ),D8(Q,W)}}function FU(J,$){let Q=this.cache,W=$.elements;if(W===void 0){if(F8(Q,$))return;J.uniformMatrix3fv(this.addr,!1,$),D8(Q,$)}else{if(F8(Q,W))return;IZ.set(W),J.uniformMatrix3fv(this.addr,!1,IZ),D8(Q,W)}}function DU(J,$){let Q=this.cache,W=$.elements;if(W===void 0){if(F8(Q,$))return;J.uniformMatrix4fv(this.addr,!1,$),D8(Q,$)}else{if(F8(Q,W))return;zZ.set(W),J.uniformMatrix4fv(this.addr,!1,zZ),D8(Q,W)}}function OU(J,$){let Q=this.cache;if(Q[0]===$)return;J.uniform1i(this.addr,$),Q[0]=$}function MU(J,$){let Q=this.cache;if($.x!==void 0){if(Q[0]!==$.x||Q[1]!==$.y)J.uniform2i(this.addr,$.x,$.y),Q[0]=$.x,Q[1]=$.y}else{if(F8(Q,$))return;J.uniform2iv(this.addr,$),D8(Q,$)}}function RU(J,$){let Q=this.cache;if($.x!==void 0){if(Q[0]!==$.x||Q[1]!==$.y||Q[2]!==$.z)J.uniform3i(this.addr,$.x,$.y,$.z),Q[0]=$.x,Q[1]=$.y,Q[2]=$.z}else{if(F8(Q,$))return;J.uniform3iv(this.addr,$),D8(Q,$)}}function kU(J,$){let Q=this.cache;if($.x!==void 0){if(Q[0]!==$.x||Q[1]!==$.y||Q[2]!==$.z||Q[3]!==$.w)J.uniform4i(this.addr,$.x,$.y,$.z,$.w),Q[0]=$.x,Q[1]=$.y,Q[2]=$.z,Q[3]=$.w}else{if(F8(Q,$))return;J.uniform4iv(this.addr,$),D8(Q,$)}}function LU(J,$){let Q=this.cache;if(Q[0]===$)return;J.uniform1ui(this.addr,$),Q[0]=$}function VU(J,$){let Q=this.cache;if($.x!==void 0){if(Q[0]!==$.x||Q[1]!==$.y)J.uniform2ui(this.addr,$.x,$.y),Q[0]=$.x,Q[1]=$.y}else{if(F8(Q,$))return;J.uniform2uiv(this.addr,$),D8(Q,$)}}function BU(J,$){let Q=this.cache;if($.x!==void 0){if(Q[0]!==$.x||Q[1]!==$.y||Q[2]!==$.z)J.uniform3ui(this.addr,$.x,$.y,$.z),Q[0]=$.x,Q[1]=$.y,Q[2]=$.z}else{if(F8(Q,$))return;J.uniform3uiv(this.addr,$),D8(Q,$)}}function zU(J,$){let Q=this.cache;if($.x!==void 0){if(Q[0]!==$.x||Q[1]!==$.y||Q[2]!==$.z||Q[3]!==$.w)J.uniform4ui(this.addr,$.x,$.y,$.z,$.w),Q[0]=$.x,Q[1]=$.y,Q[2]=$.z,Q[3]=$.w}else{if(F8(Q,$))return;J.uniform4uiv(this.addr,$),D8(Q,$)}}function IU(J,$,Q){let W=this.cache,Z=Q.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;let K;if(this.type===J.SAMPLER_2D_SHADOW)LQ.compareFunction=Q.isReversedDepthBuffer()?p7:g7,K=LQ;else K=pZ;Q.setTexture2D($||K,Z)}function CU(J,$,Q){let W=this.cache,Z=Q.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;Q.setTexture3D($||lZ,Z)}function _U(J,$,Q){let W=this.cache,Z=Q.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;Q.setTextureCube($||dZ,Z)}function AU(J,$,Q){let W=this.cache,Z=Q.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;Q.setTexture2DArray($||mZ,Z)}function PU(J){switch(J){case 5126:return UU;case 35664:return GU;case 35665:return NU;case 35666:return EU;case 35674:return qU;case 35675:return FU;case 35676:return DU;case 5124:case 35670:return OU;case 35667:case 35671:return MU;case 35668:case 35672:return RU;case 35669:case 35673:return kU;case 5125:return LU;case 36294:return VU;case 36295:return BU;case 36296:return zU;case 35678:case 36198:case 36298:case 36306:case 35682:return IU;case 35679:case 36299:case 36307:return CU;case 35680:case 36300:case 36308:case 36293:return _U;case 36289:case 36303:case 36311:case 36292:return AU}}function wU(J,$){J.uniform1fv(this.addr,$)}function TU(J,$){let Q=I6($,this.size,2);J.uniform2fv(this.addr,Q)}function SU(J,$){let Q=I6($,this.size,3);J.uniform3fv(this.addr,Q)}function jU(J,$){let Q=I6($,this.size,4);J.uniform4fv(this.addr,Q)}function vU(J,$){let Q=I6($,this.size,4);J.uniformMatrix2fv(this.addr,!1,Q)}function fU(J,$){let Q=I6($,this.size,9);J.uniformMatrix3fv(this.addr,!1,Q)}function yU(J,$){let Q=I6($,this.size,16);J.uniformMatrix4fv(this.addr,!1,Q)}function hU(J,$){J.uniform1iv(this.addr,$)}function bU(J,$){J.uniform2iv(this.addr,$)}function xU(J,$){J.uniform3iv(this.addr,$)}function gU(J,$){J.uniform4iv(this.addr,$)}function pU(J,$){J.uniform1uiv(this.addr,$)}function mU(J,$){J.uniform2uiv(this.addr,$)}function lU(J,$){J.uniform3uiv(this.addr,$)}function dU(J,$){J.uniform4uiv(this.addr,$)}function uU(J,$,Q){let W=this.cache,Z=$.length,K=ZJ(Q,Z);if(!F8(W,K))J.uniform1iv(this.addr,K),D8(W,K);let H;if(this.type===J.SAMPLER_2D_SHADOW)H=LQ;else H=pZ;for(let Y=0;Y!==Z;++Y)Q.setTexture2D($[Y]||H,K[Y])}function cU(J,$,Q){let W=this.cache,Z=$.length,K=ZJ(Q,Z);if(!F8(W,K))J.uniform1iv(this.addr,K),D8(W,K);for(let H=0;H!==Z;++H)Q.setTexture3D($[H]||lZ,K[H])}function nU(J,$,Q){let W=this.cache,Z=$.length,K=ZJ(Q,Z);if(!F8(W,K))J.uniform1iv(this.addr,K),D8(W,K);for(let H=0;H!==Z;++H)Q.setTextureCube($[H]||dZ,K[H])}function sU(J,$,Q){let W=this.cache,Z=$.length,K=ZJ(Q,Z);if(!F8(W,K))J.uniform1iv(this.addr,K),D8(W,K);for(let H=0;H!==Z;++H)Q.setTexture2DArray($[H]||mZ,K[H])}function iU(J){switch(J){case 5126:return wU;case 35664:return TU;case 35665:return SU;case 35666:return jU;case 35674:return vU;case 35675:return fU;case 35676:return yU;case 5124:case 35670:return hU;case 35667:case 35671:return bU;case 35668:case 35672:return xU;case 35669:case 35673:return gU;case 5125:return pU;case 36294:return mU;case 36295:return lU;case 36296:return dU;case 35678:case 36198:case 36298:case 36306:case 35682:return uU;case 35679:case 36299:case 36307:return cU;case 35680:case 36300:case 36308:case 36293:return nU;case 36289:case 36303:case 36311:case 36292:return sU}}class uZ{constructor(J,$,Q){this.id=J,this.addr=Q,this.cache=[],this.type=$.type,this.setValue=PU($.type)}}class cZ{constructor(J,$,Q){this.id=J,this.addr=Q,this.cache=[],this.type=$.type,this.size=$.size,this.setValue=iU($.type)}}class nZ{constructor(J){this.id=J,this.seq=[],this.map={}}setValue(J,$,Q){let W=this.seq;for(let Z=0,K=W.length;Z!==K;++Z){let H=W[Z];H.setValue(J,$[H.id],Q)}}}var MQ=/(\w+)(\])?(\[|\.)?/g;function _Z(J,$){J.seq.push($),J.map[$.id]=$}function oU(J,$,Q){let W=J.name,Z=W.length;MQ.lastIndex=0;while(!0){let K=MQ.exec(W),H=MQ.lastIndex,Y=K[1],X=K[2]==="]",U=K[3];if(X)Y=Y|0;if(U===void 0||U==="["&&H+2===Z){_Z(Q,U===void 0?new uZ(Y,J,$):new cZ(Y,J,$));break}else{let N=Q.map[Y];if(N===void 0)N=new nZ(Y),_Z(Q,N);Q=N}}}class i6{constructor(J,$){this.seq=[],this.map={};let Q=J.getProgramParameter($,J.ACTIVE_UNIFORMS);for(let K=0;K<Q;++K){let H=J.getActiveUniform($,K),Y=J.getUniformLocation($,H.name);oU(H,Y,this)}let W=[],Z=[];for(let K of this.seq)if(K.type===J.SAMPLER_2D_SHADOW||K.type===J.SAMPLER_CUBE_SHADOW||K.type===J.SAMPLER_2D_ARRAY_SHADOW)W.push(K);else Z.push(K);if(W.length>0)this.seq=W.concat(Z)}setValue(J,$,Q,W){let Z=this.map[$];if(Z!==void 0)Z.setValue(J,Q,W)}setOptional(J,$,Q){let W=$[Q];if(W!==void 0)this.setValue(J,Q,W)}static upload(J,$,Q,W){for(let Z=0,K=$.length;Z!==K;++Z){let H=$[Z],Y=Q[H.id];if(Y.needsUpdate!==!1)H.setValue(J,Y.value,W)}}static seqWithValue(J,$){let Q=[];for(let W=0,Z=J.length;W!==Z;++W){let K=J[W];if(K.id in $)Q.push(K)}return Q}}function AZ(J,$,Q){let W=J.createShader($);return J.shaderSource(W,Q),J.compileShader(W),W}var aU=37297,rU=0;function tU(J,$){let Q=J.split(`
`),W=[],Z=Math.max($-6,0),K=Math.min($+6,Q.length);for(let H=Z;H<K;H++){let Y=H+1;W.push(`${Y===$?">":" "} ${Y}: ${Q[H]}`)}return W.join(`
`)}var PZ=new w0;function eU(J){g0._getMatrix(PZ,g0.workingColorSpace,J);let $=`mat3( ${PZ.elements.map((Q)=>Q.toFixed(4))} )`;switch(g0.getTransfer(J)){case y$:return[$,"LinearTransferOETF"];case e0:return[$,"sRGBTransferOETF"];default:return _0("WebGLProgram: Unsupported color space: ",J),[$,"LinearTransferOETF"]}}function wZ(J,$,Q){let W=J.getShaderParameter($,J.COMPILE_STATUS),K=(J.getShaderInfoLog($)||"").trim();if(W&&K==="")return"";let H=/ERROR: 0:(\d+)/.exec(K);if(H){let Y=parseInt(H[1]);return Q.toUpperCase()+`

`+K+`

`+tU(J.getShaderSource($),Y)}else return K}function J5(J,$){let Q=eU($);return[`vec4 ${J}( vec4 value ) {`,`	return ${Q[1]}( vec4( value.rgb * ${Q[0]}, value.a ) );`,"}"].join(`
`)}var $5={[uJ]:"Linear",[cJ]:"Reinhard",[nJ]:"Cineon",[sJ]:"ACESFilmic",[oJ]:"AgX",[aJ]:"Neutral",[iJ]:"Custom"};function Q5(J,$){let Q=$5[$];if(Q===void 0)return _0("WebGLProgram: Unsupported toneMapping:",$),"vec3 "+J+"( vec3 color ) { return LinearToneMapping( color ); }";return"vec3 "+J+"( vec3 color ) { return "+Q+"ToneMapping( color ); }"}var QJ=new y;function W5(){g0.getLuminanceCoefficients(QJ);let J=QJ.x.toFixed(4),$=QJ.y.toFixed(4),Q=QJ.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${$}, ${Q} );`,"\treturn dot( weights, rgb );","}"].join(`
`)}function Z5(J){return[J.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",J.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(s6).join(`
`)}function K5(J){let $=[];for(let Q in J){let W=J[Q];if(W===!1)continue;$.push("#define "+Q+" "+W)}return $.join(`
`)}function H5(J,$){let Q={},W=J.getProgramParameter($,J.ACTIVE_ATTRIBUTES);for(let Z=0;Z<W;Z++){let K=J.getActiveAttrib($,Z),H=K.name,Y=1;if(K.type===J.FLOAT_MAT2)Y=2;if(K.type===J.FLOAT_MAT3)Y=3;if(K.type===J.FLOAT_MAT4)Y=4;Q[H]={type:K.type,location:J.getAttribLocation($,H),locationSize:Y}}return Q}function s6(J){return J!==""}function TZ(J,$){let Q=$.numSpotLightShadows+$.numSpotLightMaps-$.numSpotLightShadowsWithMaps;return J.replace(/NUM_DIR_LIGHTS/g,$.numDirLights).replace(/NUM_SPOT_LIGHTS/g,$.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,$.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,Q).replace(/NUM_RECT_AREA_LIGHTS/g,$.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,$.numPointLights).replace(/NUM_HEMI_LIGHTS/g,$.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,$.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,$.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,$.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,$.numPointLightShadows)}function SZ(J,$){return J.replace(/NUM_CLIPPING_PLANES/g,$.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,$.numClippingPlanes-$.numClipIntersection)}var Y5=/^[ \t]*#include +<([\w\d./]+)>/gm;function VQ(J){return J.replace(Y5,U5)}var X5=new Map;function U5(J,$){let Q=v0[$];if(Q===void 0){let W=X5.get($);if(W!==void 0)Q=v0[W],_0('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',$,W);else throw Error("THREE.WebGLProgram: Can not resolve #include <"+$+">")}return VQ(Q)}var G5=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function jZ(J){return J.replace(G5,N5)}function N5(J,$,Q,W){let Z="";for(let K=parseInt($);K<parseInt(Q);K++)Z+=W.replace(/\[\s*i\s*\]/g,"[ "+K+" ]").replace(/UNROLLED_LOOP_INDEX/g,K);return Z}function vZ(J){let $=`precision ${J.precision} float;
...
}`;class oZ{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(J,$){if(this.texture===null){let Q=new r7(J.texture);if(J.depthNear!==$.depthNear||J.depthFar!==$.depthFar)this.depthNear=J.depthNear,this.depthFar=J.depthFar;this.texture=Q}}getMesh(J){if(this.texture!==null){if(this.mesh===null){let $=J.cameras[0].viewport,Q=new T8({vertexShader:l5,fragmentShader:d5,uniforms:{depthColor:{value:this.texture},depthWidth:{value:$.z},depthHeight:{value:$.w}}});this.mesh=new b8(new S9(20,20),Q)}}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class aZ extends D9{constructor(J,$){super();let Q=this,W=null,Z=1,K=null,H="local-floor",Y=1,X=null,U=null,q=null,N=null,G=null,D=null,k=typeof XRWebGLBinding<"u",z=new oZ,F={},E=$.getContextAttributes(),C=null,A=null,V=[],I=[],_=new n0,w=null,M=new f8;M.viewport=new K8;let B=new f8;B.viewport=new K8;let d=[M,B],P=new XQ,b=null,o=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(n){let W0=V[n];if(W0===void 0)W0=new m6,V[n]=W0;return W0.getTargetRaySpace()},this.getControllerGrip=function(n){let W0=V[n];if(W0===void 0)W0=new m6,V[n]=W0;return W0.getGripSpace()},this.getHand=function(n){let W0=V[n];if(W0===void 0)W0=new m6,V[n]=W0;return W0.getHandSpace()};function g(n){let W0=I.indexOf(n.inputSource);if(W0===-1)return;let K0=V[W0];if(K0!==void 0)K0.update(n.inputSource,n.frame,X||K),K0.dispatchEvent({type:n.type,data:n.inputSource})}function c(){W.removeEventListener("select",g),W.removeEventListener("selectstart",g),W.removeEventListener("selectend",g),W.removeEventListener("squeeze",g),W.removeEventListener("squeezestart",g),W.removeEventListener("squeezeend",g),W.removeEventListener("end",c),W.removeEventListener("inputsourceschange",m);for(let n=0;n<V.length;n++){let W0=I[n];if(W0===null)continue;I[n]=null,V[n].disconnect(W0)}b=null,o=null,z.reset();for(let n in F)delete F[n];J.setRenderTarget(C),G=null,N=null,q=null,W=null,A=null,u0.stop(),Q.isPresenting=!1,J.setPixelRatio(w),J.setSize(_.width,_.height,!1),Q.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(n){if(Z=n,Q.isPresenting===!0)_0("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(n){if(H=n,Q.isPresenting===!0)_0("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return X||K},this.setReferenceSpace=function(n){X=n},this.getBaseLayer=function(){return N!==null?N:G},this.getBinding=function(){if(q===null&&k)q=new XRWebGLBinding(W,$);return q},this.getFrame=function(){return D},this.getSession=function(){return W},this.setSession=async function(n){if(W=n,W!==null){if(C=J.getRenderTarget(),W.addEventListener("select",g),W.addEventListener("selectstart",g),W.addEventListener("selectend",g),W.addEventListener("squeeze",g),W.addEventListener("squeezestart",g),W.addEventListener("squeezeend",g),W.addEventListener("end",c),W.addEventListener("inputsourceschange",m),E.xrCompatible!==!0)await $.makeXRCompatible();if(w=J.getPixelRatio(),J.getSize(_),!(k&&("createProjectionLayer"in XRWebGLBinding.prototype))){let K0={antialias:E.antialias,alpha:!0,depth:E.depth,stencil:E.stencil,framebufferScaleFactor:Z};G=new XRWebGLLayer(W,$,K0),W.updateRenderState({baseLayer:G}),J.setPixelRatio(1),J.setSize(G.framebufferWidth,G.framebufferHeight,!1),A=new c8(G.framebufferWidth,G.framebufferHeight,{format:Q9,type:h8,colorSpace:J.outputColorSpace,stencilBuffer:E.stencil,resolveDepthBuffer:G.ignoreDepthValues===!1,resolveStencilBuffer:G.ignoreDepthValues===!1})}else{let K0=null,H0=null,L0=null;if(E.depth)L0=E.stencil?$.DEPTH24_STENCIL8:$.DEPTH_COMPONENT24,K0=E.stencil?d9:l9,H0=E.stencil?L6:P9;let j0={colorFormat:$.RGBA8,depthFormat:L0,scaleFactor:Z};q=this.getBinding(),N=q.createProjectionLayer(j0),W.updateRenderState({layers:[N]}),J.setPixelRatio(1),J.setSize(N.textureWidth,N.textureHeight,!1),A=new c8(N.textureWidth,N.textureHeight,{format:Q9,type:h8,depthTexture:new T9(N.textureWidth,N.textureHeight,H0,void 0,void 0,void 0,void 0,void 0,void 0,K0),stencilBuffer:E.stencil,colorSpace:J.outputColorSpace,samples:E.antialias?4:0,resolveDepthBuffer:N.ignoreDepthValues===!1,resolveStencilBuffer:N.ignoreDepthValues===!1})}A.isXRRenderTarget=!0,this.setFoveation(Y),X=null,K=await W.requestReferenceSpace(H),u0.setContext(W),u0.start(),Q.isPresenting=!0,Q.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(W!==null)return W.environmentBlendMode},this.getDepthTexture=function(){return z.getDepthTexture()};function m(n){for(let W0=0;W0<n.removed.length;W0++){let K0=n.removed[W0],H0=I.indexOf(K0);if(H0>=0)I[H0]=null,V[H0].disconnect(K0)}for(let W0=0;W0<n.added.length;W0++){let K0=n.added[W0],H0=I.indexOf(K0);if(H0===-1){for(let j0=0;j0<V.length;j0++)if(j0>=I.length){I.push(K0),H0=j0;break}else if(I[j0]===null){I[j0]=K0,H0=j0;break}if(H0===-1)break}let L0=V[H0];if(L0)L0.connect(K0)}}let f=new y,a=new y;function e(n,W0,K0){f.setFromMatrixPosition(W0.matrixWorld),a.setFromMatrixPosition(K0.matrixWorld);let H0=f.distanceTo(a),L0=W0.projectionMatrix.elements,j0=K0.projectionMatrix.elements,f0=L0[14]/(L0[10]-1),y0=L0[14]/(L0[10]+1),o0=(L0[9]+1)/L0[5],b0=(L0[9]-1)/L0[5],x0=(L0[8]-1)/L0[0],O8=(j0[8]+1)/j0[0],p8=f0*x0,Q8=f0*O8,k8=H0/(-x0+O8),M8=k8*-x0;if(W0.matrixWorld.decompose(n.position,n.quaternion,n.scale),n.translateX(M8),n.translateZ(k8),n.matrixWorld.compose(n.position,n.quaternion,n.scale),n.matrixWorldInverse.copy(n.matrixWorld).invert(),L0[10]===-1)n.projectionMatrix.copy(W0.projectionMatrix),n.projectionMatrixInverse.copy(W0.projectionMatrixInverse);else{let q8=f0+k8,j=y0+k8,m8=p8-M8,s0=Q8+(H0-M8),W8=o0*y0/j*q8,L=b0*y0/j*q8;n.projectionMatrix.makePerspective(m8,s0,W8,L,q8,j),n.projectionMatrixInverse.copy(n.projectionMatrix).invert()}}function J0(n,W0){if(W0===null)n.matrixWorld.copy(n.matrix);else n.matrixWorld.multiplyMatrices(W0.matrixWorld,n.matrix);n.matrixWorldInverse.copy(n.matrixWorld).invert()}this.updateCamera=function(n){if(W===null)return;let{near:W0,far:K0}=n;if(z.texture!==null){if(z.depthNear>0)W0=z.depthNear;if(z.depthFar>0)K0=z.depthFar}if(P.near=B.near=M.near=W0,P.far=B.far=M.far=K0,b!==P.near||o!==P.far)W.updateRenderState({depthNear:P.near,depthFar:P.far}),b=P.near,o=P.far;P.layers.mask=n.layers.mask|6,M.layers.mask=P.layers.mask&-5,B.layers.mask=P.layers.mask&-3;let H0=n.parent,L0=P.cameras;J0(P,H0);for(let j0=0;j0<L0.length;j0++)J0(L0[j0],H0);if(L0.length===2)e(P,M,B);else P.projectionMatrix.copy(M.projectionMatrix);k0(n,P,H0)};function k0(n,W0,K0){if(K0===null)n.matrix.copy(W0.matrixWorld);else n.matrix.copy(K0.matrixWorld),n.matrix.invert(),n.matrix.multiply(W0.matrixWorld);if(n.matrix.decompose(n.position,n.quaternion,n.scale),n.updateMatrixWorld(!0),n.projectionMatrix.copy(W0.projectionMatrix),n.projectionMatrixInverse.copy(W0.projectionMatrixInverse),n.isPerspectiveCamera)n.fov=z7*2*Math.atan(1/n.projectionMatrix.elements[5]),n.zoom=1}this.getCamera=function(){return P},this.getFoveation=function(){if(N===null&&G===null)return;return Y},this.setFoveation=function(n){if(Y=n,N!==null)N.fixedFoveation=n;if(G!==null&&G.fixedFoveation!==void 0)G.fixedFoveation=n},this.hasDepthSensing=function(){return z.texture!==null},this.getDepthSensingMesh=function(){return z.getMesh(P)},this.getCameraTexture=function(n){return F[n]};let D0=null;function l0(n,W0){if(U=W0.getViewerPose(X||K),D=W0,U!==null){let K0=U.views;if(G!==null)J.setRenderTargetFramebuffer(A,G.framebuffer),J.setRenderTarget(A);let H0=!1;if(K0.length!==P.cameras.length)P.cameras.length=0,H0=!0;for(let y0=0;y0<K0.length;y0++){let o0=K0[y0],b0=null;if(G!==null)b0=G.getViewport(o0);else{let O8=q.getViewSubImage(N,o0);if(b0=O8.viewport,y0===0)J.setRenderTargetTextures(A,O8.colorTexture,O8.depthStencilTexture),J.setRenderTarget(A)}let x0=d[y0];if(x0===void 0)x0=new f8,x0.layers.enable(y0),x0.viewport=new K8,d[y0]=x0;if(x0.matrix.fromArray(o0.transform.matrix),x0.matrix.decompose(x0.position,x0.quaternion,x0.scale),x0.projectionMatrix.fromArray(o0.projectionMatrix),x0.projectionMatrixInverse.copy(x0.projectionMatrix).invert(),x0.viewport.set(b0.x,b0.y,b0.width,b0.height),y0===0)P.matrix.copy(x0.matrix),P.matrix.decompose(P.position,P.quaternion,P.scale);if(H0===!0)P.cameras.push(x0)}let L0=W.enabledFeatures;if(L0&&L0.includes("depth-sensing")&&W.depthUsage=="gpu-optimized"&&k){q=Q.getBinding();let y0=q.getDepthInformation(K0[0]);if(y0&&y0.isValid&&y0.texture)z.init(y0,W.renderState)}if(L0&&L0.includes("camera-access")&&k){J.state.unbindTexture(),q=Q.getBinding();for(let y0=0;y0<K0.length;y0++){let o0=K0[y0].camera;if(o0){let b0=F[o0];if(!b0)b0=new r7,F[o0]=b0;let x0=q.getCameraImage(o0);b0.sourceTexture=x0}}}}for(let K0=0;K0<V.length;K0++){let H0=I[K0],L0=V[K0];if(H0!==null&&L0!==void 0)L0.update(H0,W0,X||K)}if(D0)D0(n,W0);if(W0.detectedPlanes)Q.dispatchEvent({type:"planesdetected",data:W0});D=null}let u0=new xZ;u0.setAnimationLoop(l0),this.setAnimationLoop=function(n){D0=n},this.dispose=function(){}}}var u5=new Z8,rZ=new w0;rZ.set(-1,0,0,0,1,0,0,0,1);function c5(J,$){function Q(F,E){if(F.matrixAutoUpdate===!0)F.updateMatrix();E.value.copy(F.matrix)}function W(F,E){if(E.color.getRGB(F.fogColor.value,s$(J)),E.isFog)F.fogNear.value=E.near,F.fogFar.value=E.far;else if(E.isFogExp2)F.fogDensity.value=E.density}function Z(F,E,C,A,V){if(E.isNodeMaterial)E.uniformsNeedUpdate=!1;else if(E.isMeshBasicMaterial)K(F,E);else if(E.isMeshLambertMaterial){if(K(F,E),E.envMap)F.envMapIntensity.value=E.envMapIntensity}else if(E.isMeshToonMaterial)K(F,E),N(F,E);else if(E.isMeshPhongMaterial){if(K(F,E),q(F,E),E.envMap)F.envMapIntensity.value=E.envMapIntensity}else if(E.isMeshStandardMaterial){if(K(F,E),G(F,E),E.isMeshPhysicalMaterial)D(F,E,V)}else if(E.isMeshMatcapMaterial)K(F,E),k(F,E);else if(E.isMeshDepthMaterial)K(F,E);else if(E.isMeshDistanceMaterial)K(F,E),z(F,E);else if(E.isMeshNormalMaterial)K(F,E);else if(E.isLineBasicMaterial){if(H(F,E),E.isLineDashedMaterial)Y(F,E)}else if(E.isPointsMaterial)X(F,E,C,A);else if(E.isSpriteMaterial)U(F,E);else if(E.isShadowMaterial)F.color.value.copy(E.color),F.opacity.value=E.opacity;else if(E.isShaderMaterial)E.uniformsNeedUpdate=!1}function K(F,E){if(F.opacity.value=E.opacity,E.color)F.diffuse.value.copy(E.color);if(E.emissive)F.emissive.value.copy(E.emissive).multiplyScalar(E.emissiveIntensity);if(E.map)F.map.value=E.map,Q(E.map,F.mapTransform);if(E.alphaMap)F.alphaMap.value=E.alphaMap,Q(E.alphaMap,F.alphaMapTransform);if(E.bumpMap){if(F.bumpMap.value=E.bumpMap,Q(E.bumpMap,F.bumpMapTransform),F.bumpScale.value=E.bumpScale,E.side===w8)F.bumpScale.value*=-1}if(E.normalMap){if(F.normalMap.value=E.normalMap,Q(E.normalMap,F.normalMapTransform),F.normalScale.value.copy(E.normalScale),E.side===w8)F.normalScale.value.negate()}if(E.displacementMap)F.displacementMap.value=E.displacementMap,Q(E.displacementMap,F.displacementMapTransform),F.displacementScale.value=E.displacementScale,F.displacementBias.value=E.displacementBias;if(E.emissiveMap)F.emissiveMap.value=E.emissiveMap,Q(E.emissiveMap,F.emissiveMapTransform);if(E.specularMap)F.specularMap.value=E.specularMap,Q(E.specularMap,F.specularMapTransform);if(E.alphaTest>0)F.alphaTest.value=E.alphaTest;let C=$.get(E),A=C.envMap,V=C.envMapRotation;if(A){if(F.envMap.value=A,F.envMapRotation.value.setFromMatrix4(u5.makeRotationFromEuler(V)).transpose(),A.isCubeTexture&&A.isRenderTargetTexture===!1)F.envMapRotation.value.premultiply(rZ);F.reflectivity.value=E.reflectivity,F.ior.value=E.ior,F.refractionRatio.value=E.refractionRatio}if(E.lightMap)F.lightMap.value=E.lightMap,F.lightMapIntensity.value=E.lightMapIntensity,Q(E.lightMap,F.lightMapTransform);if(E.aoMap)F.aoMap.value=E.aoMap,F.aoMapIntensity.value=E.aoMapIntensity,Q(E.aoMap,F.aoMapTransform)}function H(F,E){if(F.diffuse.value.copy(E.color),F.opacity.value=E.opacity,E.map)F.map.value=E.map,Q(E.map,F.mapTransform)}function Y(F,E){F.dashSize.value=E.dashSize,F.totalSize.value=E.dashSize+E.gapSize,F.scale.value=E.scale}function X(F,E,C,A){if(F.diffuse.value.copy(E.color),F.opacity.value=E.opacity,F.size.value=E.size*C,F.scale.value=A*0.5,E.map)F.map.value=E.map,Q(E.map,F.uvTransform);if(E.alphaMap)F.alphaMap.value=E.alphaMap,Q(E.alphaMap,F.alphaMapTransform);if(E.alphaTest>0)F.alphaTest.value=E.alphaTest}function U(F,E){if(F.diffuse.value.copy(E.color),F.opacity.value=E.opacity,F.rotation.value=E.rotation,E.map)F.map.value=E.map,Q(E.map,F.mapTransform);if(E.alphaMap)F.alphaMap.value=E.alphaMap,Q(E.alphaMap,F.alphaMapTransform);if(E.alphaTest>0)F.alphaTest.value=E.alphaTest}function q(F,E){F.specular.value.copy(E.specular),F.shininess.value=Math.max(E.shininess,0.0001)}function N(F,E){if(E.gradientMap)F.gradientMap.value=E.gradientMap}function G(F,E){if(F.metalness.value=E.metalness,E.metalnessMap)F.metalnessMap.value=E.metalnessMap,Q(E.metalnessMap,F.metalnessMapTransform);if(F.roughness.value=E.roughness,E.roughnessMap)F.roughnessMap.value=E.roughnessMap,Q(E.roughnessMap,F.roughnessMapTransform);if(E.envMap)F.envMapIntensity.value=E.envMapIntensity}function D(F,E,C){if(F.ior.value=E.ior,E.sheen>0){if(F.sheenColor.value.copy(E.sheenColor).multiplyScalar(E.sheen),F.sheenRoughness.value=E.sheenRoughness,E.sheenColorMap)F.sheenColorMap.value=E.sheenColorMap,Q(E.sheenColorMap,F.sheenColorMapTransform);if(E.sheenRoughnessMap)F.sheenRoughnessMap.value=E.sheenRoughnessMap,Q(E.sheenRoughnessMap,F.sheenRoughnessMapTransform)}if(E.clearcoat>0){if(F.clearcoat.value=E.clearcoat,F.clearcoatRoughness.value=E.clearcoatRoughness,E.clearcoatMap)F.clearcoatMap.value=E.clearcoatMap,Q(E.clearcoatMap,F.clearcoatMapTransform);if(E.clearcoatRoughnessMap)F.clearcoatRoughnessMap.value=E.clearcoatRoughnessMap,Q(E.clearcoatRoughnessMap,F.clearcoatRoughnessMapTransform);if(E.clearcoatNormalMap){if(F.clearcoatNormalMap.value=E.clearcoatNormalMap,Q(E.clearcoatNormalMap,F.clearcoatNormalMapTransform),F.clearcoatNormalScale.value.copy(E.clearcoatNormalScale),E.side===w8)F.clearcoatNormalScale.value.negate()}}if(E.dispersion>0)F.dispersion.value=E.dispersion;if(E.iridescence>0){if(F.iridescence.value=E.iridescence,F.iridescenceIOR.value=E.iridescenceIOR,F.iridescenceThicknessMinimum.value=E.iridescenceThicknessRange[0],F.iridescenceThicknessMaximum.value=E.iridescenceThicknessRange[1],E.iridescenceMap)F.iridescenceMap.value=E.iridescenceMap,Q(E.iridescenceMap,F.iridescenceMapTransform);if(E.iridescenceThicknessMap)F.iridescenceThicknessMap.value=E.iridescenceThicknessMap,Q(E.iridescenceThicknessMap,F.iridescenceThicknessMapTransform)}if(E.transmission>0){if(F.transmission.value=E.transmission,F.transmissionSamplerMap.value=C.texture,F.transmissionSamplerSize.value.set(C.width,C.height),E.transmissionMap)F.transmissionMap.value=E.transmissionMap,Q(E.transmissionMap,F.transmissionMapTransform);if(F.thickness.value=E.thickness,E.thicknessMap)F.thicknessMap.value=E.thicknessMap,Q(E.thicknessMap,F.thicknessMapTransform);F.attenuationDistance.value=E.attenuationDistance,F.attenuationColor.value.copy(E.attenuationColor)}if(E.anisotropy>0){if(F.anisotropyVector.value.set(E.anisotropy*Math.cos(E.anisotropyRotation),E.anisotropy*Math.sin(E.anisotropyRotation)),E.anisotropyMap)F.anisotropyMap.value=E.anisotropyMap,Q(E.anisotropyMap,F.anisotropyMapTransform)}if(F.specularIntensity.value=E.specularIntensity,F.specularColor.value.copy(E.specularColor),E.specularColorMap)F.specularColorMap.value=E.specularColorMap,Q(E.specularColorMap,F.specularColorMapTransform);if(E.specularIntensityMap)F.specularIntensityMap.value=E.specularIntensityMap,Q(E.specularIntensityMap,F.specularIntensityMapTransform)}function k(F,E){if(E.matcap)F.matcap.value=E.matcap}function z(F,E){let C=$.get(E).light;F.referencePosition.value.setFromMatrixPosition(C.matrixWorld),F.nearDistance.value=C.shadow.camera.near,F.farDistance.value=C.shadow.camera.far}return{refreshFogUniforms:W,refreshMaterialUniforms:Z}}function n5(J,$,Q,W){let Z={},K={},H=[],Y=J.getParameter(J.MAX_UNIFORM_BUFFER_BINDINGS);function X(V,I){let _=I.program;W.uniformBlockBinding(V,_)}function U(V,I){let _=Z[V.id];if(_===void 0)F(V),_=q(V),Z[V.id]=_,V.addEventListener("dispose",C);let w=I.program;W.updateUBOMapping(V,w);let M=$.render.frame;if(K[V.id]!==M)G(V),K[V.id]=M}function q(V){let I=N();V.__bindingPointIndex=I;let _=J.createBuffer(),w=V.__size,M=V.usage;return J.bindBuffer(J.UNIFORM_BUFFER,_),J.bufferData(J.UNIFORM_BUFFER,w,M),J.bindBuffer(J.UNIFORM_BUFFER,null),J.bindBufferBase(J.UNIFORM_BUFFER,I,_),_}function N(){for(let V=0;V<Y;V++)if(H.indexOf(V)===-1)return H.push(V),V;return P0("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function G(V){let I=Z[V.id],_=V.uniforms,w=V.__cache;J.bindBuffer(J.UNIFORM_BUFFER,I);for(let M=0,B=_.length;M<B;M++){let d=_[M];if(Array.isArray(d))for(let P=0,b=d.length;P<b;P++)D(d[P],M,P,w);else D(d,M,0,w)}J.bindBuffer(J.UNIFORM_BUFFER,null)}function D(V,I,_,w){if(z(V,I,_,w)===!0){let{__offset:M,value:B}=V;if(Array.isArray(B)){let d=0;for(let P=0;P<B.length;P++){let b=B[P],o=E(b);if(k(b,V.__data,d),typeof b!=="number"&&typeof b!=="boolean"&&!b.isMatrix3&&!ArrayBuffer.isView(b))d+=o.storage/Float32Array.BYTES_PER_ELEMENT}}else k(B,V.__data,0);J.bufferSubData(J.UNIFORM_BUFFER,M,V.__data)}}function k(V,I,_){if(typeof V==="number"||typeof V==="boolean")I[0]=V;else if(V.isMatrix3)I[0]=V.elements[0],I[1]=V.elements[1],I[2]=V.elements[2],I[3]=0,I[4]=V.elements[3],I[5]=V.elements[4],I[6]=V.elements[5],I[7]=0,I[8]=V.elements[6],I[9]=V.elements[7],I[10]=V.elements[8],I[11]=0;else if(ArrayBuffer.isView(V))I.set(new V.constructor(V.buffer,V.byteOffset,I.length));else V.toArray(I,_)}function z(V,I,_,w){let M=V.value,B=I+"_"+_;if(w[B]===void 0){if(typeof M==="number"||typeof M==="boolean")w[B]=M;else if(ArrayBuffer.isView(M))w[B]=M.slice();else w[B]=M.clone();return!0}else{let d=w[B];if(typeof M==="number"||typeof M==="boolean"){if(d!==M)return w[B]=M,!0}else if(ArrayBuffer.isView(M))return!0;else if(d.equals(M)===!1)return d.copy(M),!0}return!1}function F(V){let I=V.uniforms,_=0,w=16;for(let B=0,d=I.length;B<d;B++){let P=Array.isArray(I[B])?I[B]:[I[B]];for(let b=0,o=P.length;b<o;b++){let g=P[b],c=Array.isArray(g.value)?g.value:[g.value];for(let m=0,f=c.length;m<f;m++){let a=c[m],e=E(a),J0=_%w,k0=J0%e.boundary,D0=J0+k0;if(_+=k0,D0!==0&&w-D0<e.storage)_+=w-D0;g.__data=new Float32Array(e.storage/Float32Array.BYTES_PER_ELEMENT),g.__offset=_,_+=e.storage}}}let M=_%w;if(M>0)_+=w-M;return V.__size=_,V.__cache={},this}function E(V){let I={boundary:0,storage:0};if(typeof V==="number"||typeof V==="boolean")I.boundary=4,I.storage=4;else if(V.isVector2)I.boundary=8,I.storage=8;else if(V.isVector3||V.isColor)I.boundary=16,I.storage=12;else if(V.isVector4)I.boundary=16,I.storage=16;else if(V.isMatrix3)I.boundary=48,I.storage=48;else if(V.isMatrix4)I.boundary=64,I.storage=64;else if(V.isTexture)_0("WebGLRenderer: Texture samplers can not be part of an uniforms group.");else if(ArrayBuffer.isView(V))I.boundary=16,I.storage=V.byteLength;else _0("WebGLRenderer: Unsupported uniform value type.",V);return I}function C(V){let I=V.target;I.removeEventListener("dispose",C);let _=H.indexOf(I.__bindingPointIndex);H.splice(_,1),J.deleteBuffer(Z[I.id]),delete Z[I.id],delete K[I.id]}function A(){for(let V in Z)J.deleteBuffer(Z[V]);H=[],Z={},K={}}return{bind:X,update:U,dispose:A}}var s5=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),W9=null;function i5(){if(W9===null)W9=new d6(s5,16,16,u9,F9),W9.name="DFG_LUT",W9.minFilter=_8,W9.magFilter=_8,W9.wrapS=w7,W9.wrapT=w7,W9.generateMipmaps=!1,W9.needsUpdate=!0;return W9}class zQ{constructor(J={}){let{canvas:$=XZ(),context:Q=null,depth:W=!0,stencil:Z=!1,alpha:K=!1,antialias:H=!1,premultipliedAlpha:Y=!0,preserveDrawingBuffer:X=!1,powerPreference:U="default",failIfMajorPerformanceCaveat:q=!1,reversedDepthBuffer:N=!1,outputBufferType:G=h8}=J;this.isWebGLRenderer=!0;let D;if(Q!==null){if(typeof WebGLRenderingContext<"u"&&Q instanceof WebGLRenderingContext)throw Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");D=Q.getContextAttributes().alpha}else D=K;let k=G,z=new Set([Q$,$$,J$]),F=new Set([h8,P9,x6,L6,tJ,eJ]),E=new Uint32Array(4),C=new Int32Array(4),A=new y,V=null,I=null,_=[],w=[],M=null;this.domElement=$,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=a8,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let B=this,d=!1,P=null,b=null,o=null,g=null;this._outputColorSpace=x7;let c=0,m=0,f=null,a=-1,e=null,J0=new K8,k0=new K8,D0=null,l0=new p0(0),u0=0,n=$.width,W0=$.height,K0=1,H0=null,L0=null,j0=new K8(0,0,n,W0),f0=new K8(0,0,n,W0),y0=!1,o0=new i7,b0=!1,x0=!1,O8=new Z8,p8=new y,Q8=new K8,k8={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},M8=!1;function q8(){return f===null?K0:1}let j=Q;function m8(R,v){return $.getContext(R,v)}try{let R={alpha:!0,depth:W,stencil:Z,antialias:H,premultipliedAlpha:Y,preserveDrawingBuffer:X,powerPreference:U,failIfMajorPerformanceCaveat:q};if("setAttribute"in $)$.setAttribute("data-engine",`three.js r${qW}`);if($.addEventListener("webglcontextlost",T0,!1),$.addEventListener("webglcontextrestored",H8,!1),$.addEventListener("webglcontextcreationerror",J8,!1),j===null){if(j=m8("webgl2",R),j===null)if(m8("webgl2"))throw Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.");else throw Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(R){throw P0("WebGLRenderer: "+R.message),R}let s0,W8,L,O,T,l,t,$0,U0,u,i,F0,B0,G0,Q0,C0,A0,c0,S,Z0,s,Y0,O0;function r(){if(s0=new $U(j),s0.init(),s=new m5(j,s0),W8=new sX(j,s0,J,s),L=new g5(j,s0),W8.reversedDepthBuffer&&N)L.buffers.depth.setReversed(!0);b=j.createFramebuffer(),o=j.createFramebuffer(),g=j.createFramebuffer(),O=new ZU(j),T=new C5,l=new p5(j,s0,L,T,W8,s,O),t=new JU(B),$0=new XH(j),Y0=new cX(j,$0),U0=new QU(j,$0,O,Y0),u=new HU(j,U0,$0,Y0,O),c0=new KU(j,W8,l),Q0=new iX(T),i=new I5(B,t,s0,W8,Y0,Q0),F0=new c5(B,T),B0=new A5,G0=new v5(s0),A0=new uX(B,t,L,u,D,Y),C0=new x5(B,u,W8),O0=new n5(j,O,W8,L),S=new nX(j,s0,O),Z0=new WU(j,s0,O),O.programs=i.programs,B.capabilities=W8,B.extensions=s0,B.properties=T,B.renderLists=B0,B.shadowMap=C0,B.state=L,B.info=O}if(r(),k!==h8)M=new XU(k,$.width,$.height,H,W,Z);let X0=new aZ(B,j);this.xr=X0,this.getContext=function(){return j},this.getContextAttributes=function(){return j.getContextAttributes()},this.forceContextLoss=function(){let R=s0.get("WEBGL_lose_context");if(R)R.loseContext()},this.forceContextRestore=function(){let R=s0.get("WEBGL_lose_context");if(R)R.restoreContext()},this.getPixelRatio=function(){return K0},this.setPixelRatio=function(R){if(R===void 0)return;K0=R,this.setSize(n,W0,!1)},this.getSize=function(R){return R.set(n,W0)},this.setSize=function(R,v,p=!0){if(X0.isPresenting){_0("WebGLRenderer: Can't change size while VR device is presenting.");return}if(n=R,W0=v,$.width=Math.floor(R*K0),$.height=Math.floor(v*K0),p===!0)$.style.width=R+"px",$.style.height=v+"px";if(M!==null)M.setSize($.width,$.height);this.setViewport(0,0,R,v)},this.getDrawingBufferSize=function(R){return R.set(n*K0,W0*K0).floor()},this.setDrawingBufferSize=function(R,v,p){n=R,W0=v,K0=p,$.width=Math.floor(R*p),$.height=Math.floor(v*p),this.setViewport(0,0,R,v)},this.setEffects=function(R){if(k===h8){P0("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(R){for(let v=0;v<R.length;v++)if(R[v].isOutputPass===!0){_0("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}M.setEffects(R||[])},this.getCurrentViewport=function(R){return R.copy(J0)},this.getViewport=function(R){return R.copy(j0)},this.setViewport=function(R,v,p,h){if(R.isVector4)j0.set(R.x,R.y,R.z,R.w);else j0.set(R,v,p,h);L.viewport(J0.copy(j0).multiplyScalar(K0).round())},this.getScissor=function(R){return R.copy(f0)},this.setScissor=function(R,v,p,h){if(R.isVector4)f0.set(R.x,R.y,R.z,R.w);else f0.set(R,v,p,h);L.scissor(k0.copy(f0).multiplyScalar(K0).round())},this.getScissorTest=function(){return y0},this.setScissorTest=function(R){L.setScissorTest(y0=R)},this.setOpaqueSort=function(R){H0=R},this.setTransparentSort=function(R){L0=R},this.getClearColor=function(R){return R.copy(A0.getClearColor())},this.setClearColor=function(){A0.setClearColor(...arguments)},this.getClearAlpha=function(){return A0.getClearAlpha()},this.setClearAlpha=function(){A0.setClearAlpha(...arguments)},this.clear=function(R=!0,v=!0,p=!0){let h=0;if(R){let x=!1;if(f!==null){let q0=f.texture.format;x=z.has(q0)}if(x){let q0=f.texture.type,R0=F.has(q0),E0=A0.getClearColor(),V0=A0.getClearAlpha(),z0=E0.r,S0=E0.g,h0=E0.b;if(R0)E[0]=z0,E[1]=S0,E[2]=h0,E[3]=V0,j.clearBufferuiv(j.COLOR,0,E);else C[0]=z0,C[1]=S0,C[2]=h0,C[3]=V0,j.clearBufferiv(j.COLOR,0,C)}else h|=j.COLOR_BUFFER_BIT}if(v)h|=j.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0);if(p)h|=j.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295);if(h!==0)j.clear(h)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(R){R.setRenderer(this),P=R},this.dispose=function(){$.removeEventListener("webglcontextlost",T0,!1),$.removeEventListener("webglcontextrestored",H8,!1),$.removeEventListener("webglcontextcreationerror",J8,!1),A0.dispose(),B0.dispose(),G0.dispose(),T.dispose(),t.dispose(),u.dispose(),Y0.dispose(),O0.dispose(),i.dispose(),X0.dispose(),X0.removeEventListener("sessionstart",fQ),X0.removeEventListener("sessionend",yQ),f9.stop()};function T0(R){R.preventDefault(),g$("WebGLRenderer: Context Lost."),d=!0}function H8(){g$("WebGLRenderer: Context Restored."),d=!1;let R=O.autoReset,v=C0.enabled,p=C0.autoUpdate,h=C0.needsUpdate,x=C0.type;r(),O.autoReset=R,C0.enabled=v,C0.autoUpdate=p,C0.needsUpdate=h,C0.type=x}function J8(R){P0("WebGLRenderer: A WebGL context could not be created. Reason: ",R.statusMessage)}function r8(R){let v=R.target;v.removeEventListener("dispose",r8),K9(v)}function K9(R){BK(R),T.remove(R)}function BK(R){let v=T.get(R).programs;if(v!==void 0){if(v.forEach(function(p){i.releaseProgram(p)}),R.isShaderMaterial)i.releaseShaderCache(R)}}this.renderBufferDirect=function(R,v,p,h,x,q0){if(v===null)v=k8;let R0=x.isMesh&&x.matrixWorld.determinantAffine()<0,E0=CK(R,v,p,h,x);L.setMaterial(h,R0);let V0=p.index,z0=1;if(h.wireframe===!0){if(V0=U0.getWireframeAttribute(p),V0===void 0)return;z0=2}let S0=p.drawRange,h0=p.attributes.position,I0=S0.start*z0,a0=(S0.start+S0.count)*z0;if(q0!==null)I0=Math.max(I0,q0.start*z0),a0=Math.min(a0,(q0.start+q0.count)*z0);if(V0!==null)I0=Math.max(I0,0),a0=Math.min(a0,V0.count);else if(h0!==void 0&&h0!==null)I0=Math.max(I0,0),a0=Math.min(a0,h0.count);let U8=a0-I0;if(U8<0||U8===1/0)return;Y0.setup(x,h,E0,p,V0);let Y8,r0=S;if(V0!==null)Y8=$0.get(V0),r0=Z0,r0.setIndex(Y8);if(x.isMesh)if(h.wireframe===!0)L.setLineWidth(h.wireframeLinewidth*q8()),r0.setMode(j.LINES);else r0.setMode(j.TRIANGLES);else if(x.isLine){let V8=h.linewidth;if(V8===void 0)V8=1;if(L.setLineWidth(V8*q8()),x.isLineSegments)r0.setMode(j.LINES);else if(x.isLineLoop)r0.setMode(j.LINE_LOOP);else r0.setMode(j.LINE_STRIP)}else if(x.isPoints)r0.setMode(j.POINTS);else if(x.isSprite)r0.setMode(j.TRIANGLES);if(x.isBatchedMesh)if(!s0.get("WEBGL_multi_draw")){let{_multiDrawStarts:V8,_multiDrawCounts:M0,_multiDrawCount:S8}=x,d0=V0?$0.get(V0).bytesPerElement:1,l8=T.get(h).currentProgram.getUniforms();for(let t8=0;t8<S8;t8++)l8.setValue(j,"_gl_DrawID",t8),r0.render(V8[t8]/d0,M0[t8])}else r0.renderMultiDraw(x._multiDrawStarts,x._multiDrawCounts,x._multiDrawCount);else if(x.isInstancedMesh)r0.renderInstances(I0,U8,x.count);else if(p.isInstancedBufferGeometry){let V8=p._maxInstanceCount!==void 0?p._maxInstanceCount:1/0,M0=Math.min(p.instanceCount,V8);r0.renderInstances(I0,U8,M0)}else r0.render(I0,U8)};function vQ(R,v,p){if(R.transparent===!0&&R.side===J9&&R.forceSinglePass===!1)R.side=w8,R.needsUpdate=!0,t6(R,v,p),R.side=M6,R.needsUpdate=!0,t6(R,v,p),R.side=J9;else t6(R,v,p)}this.compile=function(R,v,p=null){if(p===null)p=R;if(I=G0.get(p),I.init(v),w.push(I),p.traverseVisible(function(x){if(x.isLight&&x.layers.test(v.layers)){if(I.pushLight(x),x.castShadow)I.pushShadow(x)}}),R!==p)R.traverseVisible(function(x){if(x.isLight&&x.layers.test(v.layers)){if(I.pushLight(x),x.castShadow)I.pushShadow(x)}});I.setupLights();let h=new Set;return R.traverse(function(x){if(!(x.isMesh||x.isPoints||x.isLine||x.isSprite))return;let q0=x.material;if(q0)if(Array.isArray(q0))for(let R0=0;R0<q0.length;R0++){let E0=q0[R0];vQ(E0,p,x),h.add(E0)}else vQ(q0,p,x),h.add(q0)}),I=w.pop(),h},this.compileAsync=function(R,v,p=null){let h=this.compile(R,v,p);return new Promise((x)=>{function q0(){if(h.forEach(function(R0){if(T.get(R0).currentProgram.isReady())h.delete(R0)}),h.size===0){x(R);return}setTimeout(q0,10)}if(s0.get("KHR_parallel_shader_compile")!==null)q0();else setTimeout(q0,10)})};let EJ=null;function zK(R){if(EJ)EJ(R)}function fQ(){f9.stop()}function yQ(){f9.start()}let f9=new xZ;if(f9.setAnimationLoop(zK),typeof self<"u")f9.setContext(self);this.setAnimationLoop=function(R){EJ=R,X0.setAnimationLoop(R),R===null?f9.stop():f9.start()},X0.addEventListener("sessionstart",fQ),X0.addEventListener("sessionend",yQ),this.render=function(R,v){if(v!==void 0&&v.isCamera!==!0){P0("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(d===!0)return;if(P!==null)P.renderStart(R,v);let p=X0.enabled===!0&&X0.isPresenting===!0,h=M!==null&&(f===null||p)&&M.begin(B,f);if(R.matrixWorldAutoUpdate===!0)R.updateMatrixWorld();if(v.parent===null&&v.matrixWorldAutoUpdate===!0)v.updateMatrixWorld();if(X0.enabled===!0&&X0.isPresenting===!0&&(M===null||M.isCompositing()===!1)){if(X0.cameraAutoUpdate===!0)X0.updateCamera(v);v=X0.getCamera()}if(R.isScene===!0)R.onBeforeRender(B,R,v,f);if(I=G0.get(R,w.length),I.init(v),I.state.textureUnits=l.getTextureUnits(),w.push(I),O8.multiplyMatrices(v.projectionMatrix,v.matrixWorldInverse),o0.setFromProjectionMatrix(O8,x$,v.reversedDepth),x0=this.localClippingEnabled,b0=Q0.init(this.clippingPlanes,x0),V=B0.get(R,_.length),V.init(),_.push(V),X0.enabled===!0&&X0.isPresenting===!0){let R0=B.xr.getDepthSensingMesh();if(R0!==null)qJ(R0,v,-1/0,B.sortObjects)}if(qJ(R,v,0,B.sortObjects),V.finish(),B.sortObjects===!0)V.sort(H0,L0,v.reversedDepth);if(M8=X0.enabled===!1||X0.isPresenting===!1||X0.hasDepthSensing()===!1,M8)A0.addToRenderList(V,R);if(this.info.render.frame++,this.info.autoReset===!0)this.info.reset();if(b0===!0)Q0.beginShadows();let x=I.state.shadowsArray;if(C0.render(x,R,v),b0===!0)Q0.endShadows();if((h&&M.hasRenderPass())===!1){let{opaque:R0,transmissive:E0}=V;if(I.setupLights(),v.isArrayCamera){let V0=v.cameras;if(E0.length>0)for(let z0=0,S0=V0.length;z0<S0;z0++){let h0=V0[z0];bQ(R0,E0,R,h0)}if(M8)A0.render(R);for(let z0=0,S0=V0.length;z0<S0;z0++){let h0=V0[z0];hQ(V,R,h0,h0.viewport)}}else{if(E0.length>0)bQ(R0,E0,R,v);if(M8)A0.render(R);hQ(V,R,v)}}if(f!==null&&m===0)l.updateMultisampleRenderTarget(f),l.updateRenderTargetMipmap(f);if(h)M.end(B);if(R.isScene===!0)R.onAfterRender(B,R,v);if(Y0.resetDefaultState(),a=-1,e=null,w.pop(),w.length>0){if(I=w[w.length-1],l.setTextureUnits(I.state.textureUnits),b0===!0)Q0.setGlobalState(B.clippingPlanes,I.state.camera)}else I=null;if(_.pop(),_.length>0)V=_[_.length-1];else V=null;if(P!==null)P.renderEnd()};function qJ(R,v,p,h){if(R.visible===!1)return;if(R.layers.test(v.layers)){if(R.isGroup)p=R.renderOrder;else if(R.isLOD){if(R.autoUpdate===!0)R.update(v)}else if(R.isLightProbeGrid)I.pushLightProbeGrid(R);else if(R.isLight){if(I.pushLight(R),R.castShadow)I.pushShadow(R)}else if(R.isSprite){if(!R.frustumCulled||o0.intersectsSprite(R)){if(h)Q8.setFromMatrixPosition(R.matrixWorld).applyMatrix4(O8);let R0=u.update(R),E0=R.material;if(E0.visible)V.push(R,R0,E0,p,Q8.z,null)}}else if(R.isMesh||R.isLine||R.isPoints){if(!R.frustumCulled||o0.intersectsObject(R)){let R0=u.update(R),E0=R.material;if(h){if(R.boundingSphere!==void 0){if(R.boundingSphere===null)R.computeBoundingSphere();Q8.copy(R.boundingSphere.center)}else{if(R0.boundingSphere===null)R0.computeBoundingSphere();Q8.copy(R0.boundingSphere.center)}Q8.applyMatrix4(R.matrixWorld).applyMatrix4(O8)}if(Array.isArray(E0)){let V0=R0.groups;for(let z0=0,S0=V0.length;z0<S0;z0++){let h0=V0[z0],I0=E0[h0.materialIndex];if(I0&&I0.visible)V.push(R,R0,I0,p,Q8.z,h0)}}else if(E0.visible)V.push(R,R0,E0,p,Q8.z,null)}}}let q0=R.children;for(let R0=0,E0=q0.length;R0<E0;R0++)qJ(q0[R0],v,p,h)}function hQ(R,v,p,h){let{opaque:x,transmissive:q0,transparent:R0}=R;if(I.setupLightsView(p),b0===!0)Q0.setGlobalState(B.clippingPlanes,p);if(h)L.viewport(J0.copy(h));if(x.length>0)r6(x,v,p);if(q0.length>0)r6(q0,v,p);if(R0.length>0)r6(R0,v,p);L.buffers.depth.setTest(!0),L.buffers.depth.setMask(!0),L.buffers.color.setMask(!0),L.setPolygonOffset(!1)}function bQ(R,v,p,h){if((p.isScene===!0?p.overrideMaterial:null)!==null)return;if(I.state.transmissionRenderTarget[h.id]===void 0){let I0=s0.has("EXT_color_buffer_half_float")||s0.has("EXT_color_buffer_float");I.state.transmissionRenderTarget[h.id]=new c8(1,1,{generateMipmaps:!0,type:I0?F9:h8,minFilter:m9,samples:Math.max(4,W8.samples),stencilBuffer:Z,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:g0.workingColorSpace})}let q0=I.state.transmissionRenderTarget[h.id],R0=h.viewport||J0;q0.setSize(R0.z*B.transmissionResolutionScale,R0.w*B.transmissionResolutionScale);let E0=B.getRenderTarget(),V0=B.getActiveCubeFace(),z0=B.getActiveMipmapLevel();if(B.setRenderTarget(q0),B.getClearColor(l0),u0=B.getClearAlpha(),u0<1)B.setClearColor(16777215,0.5);if(B.clear(),M8)A0.render(p);let S0=B.toneMapping;B.toneMapping=a8;let h0=h.viewport;if(h.viewport!==void 0)h.viewport=void 0;if(I.setupLightsView(h),b0===!0)Q0.setGlobalState(B.clippingPlanes,h);if(r6(R,p,h),l.updateMultisampleRenderTarget(q0),l.updateRenderTargetMipmap(q0),s0.has("WEBGL_multisampled_render_to_texture")===!1){let I0=!1;for(let a0=0,U8=v.length;a0<U8;a0++){let Y8=v[a0],{object:r0,geometry:V8,material:M0,group:S8}=Y8;if(M0.side===J9&&r0.layers.test(h.layers)){let d0=M0.side;M0.side=w8,M0.needsUpdate=!0,xQ(r0,p,h,V8,M0,S8),M0.side=d0,M0.needsUpdate=!0,I0=!0}}if(I0===!0)l.updateMultisampleRenderTarget(q0),l.updateRenderTargetMipmap(q0)}if(B.setRenderTarget(E0,V0,z0),B.setClearColor(l0,u0),h0!==void 0)h.viewport=h0;B.toneMapping=S0}function r6(R,v,p){let h=v.isScene===!0?v.overrideMaterial:null;for(let x=0,q0=R.length;x<q0;x++){let R0=R[x],{object:E0,geometry:V0,group:z0}=R0,S0=R0.material;if(S0.allowOverride===!0&&h!==null)S0=h;if(E0.layers.test(p.layers))xQ(E0,v,p,V0,S0,z0)}}function xQ(R,v,p,h,x,q0){if(R.onBeforeRender(B,v,p,h,x,q0),R.modelViewMatrix.multiplyMatrices(p.matrixWorldInverse,R.matrixWorld),R.normalMatrix.getNormalMatrix(R.modelViewMatrix),x.onBeforeRender(B,v,p,h,R,q0),x.transparent===!0&&x.side===J9&&x.forceSinglePass===!1)x.side=w8,x.needsUpdate=!0,B.renderBufferDirect(p,v,h,x,R,q0),x.side=M6,x.needsUpdate=!0,B.renderBufferDirect(p,v,h,x,R,q0),x.side=J9;else B.renderBufferDirect(p,v,h,x,R,q0);R.onAfterRender(B,v,p,h,x,q0)}function t6(R,v,p){if(v.isScene!==!0)v=k8;let h=T.get(R),x=I.state.lights,q0=I.state.shadowsArray,R0=x.state.version,E0=i.getParameters(R,x.state,q0,v,p,I.state.lightProbeGridArray),V0=i.getProgramCacheKey(E0),z0=h.programs;h.environment=R.isMeshStandardMaterial||R.isMeshLambertMaterial||R.isMeshPhongMaterial?v.environment:null,h.fog=v.fog;let S0=R.isMeshStandardMaterial||R.isMeshLambertMaterial&&!R.envMap||R.isMeshPhongMaterial&&!R.envMap;if(h.envMap=t.get(R.envMap||h.environment,S0),h.envMapRotation=h.environment!==null&&R.envMap===null?v.environmentRotation:R.envMapRotation,z0===void 0)R.addEventListener("dispose",r8),z0=new Map,h.programs=z0;let h0=z0.get(V0);if(h0!==void 0){if(h.currentProgram===h0&&h.lightsStateVersion===R0)return pQ(R,E0),h0}else{if(E0.uniforms=i.getUniforms(R),P!==null&&R.isNodeMaterial)P.build(R,p,E0);R.onBeforeCompile(E0,B),h0=i.acquireProgram(E0,V0),z0.set(V0,h0),h.uniforms=E0.uniforms}let I0=h.uniforms;if(!R.isShaderMaterial&&!R.isRawShaderMaterial||R.clipping===!0)I0.clippingPlanes=Q0.uniform;if(pQ(R,E0),h.needsLights=AK(R),h.lightsStateVersion=R0,h.needsLights)I0.ambientLightColor.value=x.state.ambient,I0.lightProbe.value=x.state.probe,I0.directionalLights.value=x.state.directional,I0.directionalLightShadows.value=x.state.directionalShadow,I0.spotLights.value=x.state.spot,I0.spotLightShadows.value=x.state.spotShadow,I0.rectAreaLights.value=x.state.rectArea,I0.ltc_1.value=x.state.rectAreaLTC1,I0.ltc_2.value=x.state.rectAreaLTC2,I0.pointLights.value=x.state.point,I0.pointLightShadows.value=x.state.pointShadow,I0.hemisphereLights.value=x.state.hemi,I0.directionalShadowMatrix.value=x.state.directionalShadowMatrix,I0.spotLightMatrix.value=x.state.spotLightMatrix,I0.spotLightMap.value=x.state.spotLightMap,I0.pointShadowMatrix.value=x.state.pointShadowMatrix;return h.lightProbeGrid=I.state.lightProbeGridArray.length>0,h.currentProgram=h0,h.uniformsList=null,h0}function gQ(R){if(R.uniformsList===null){let v=R.currentProgram.getUniforms();R.uniformsList=i6.seqWithValue(v.seq,R.uniforms)}return R.uniformsList}function pQ(R,v){let p=T.get(R);p.outputColorSpace=v.outputColorSpace,p.batching=v.batching,p.batchingColor=v.batchingColor,p.instancing=v.instancing,p.instancingColor=v.instancingColor,p.instancingMorph=v.instancingMorph,p.skinning=v.skinning,p.morphTargets=v.morphTargets,p.morphNormals=v.morphNormals,p.morphColors=v.morphColors,p.morphTargetsCount=v.morphTargetsCount,p.numClippingPlanes=v.numClippingPlanes,p.numIntersection=v.numClipIntersection,p.vertexAlphas=v.vertexAlphas,p.vertexTangents=v.vertexTangents,p.toneMapping=v.toneMapping}function IK(R,v){if(R.length===0)return null;if(R.length===1)return R[0].texture!==null?R[0]:null;A.setFromMatrixPosition(v.matrixWorld);for(let p=0,h=R.length;p<h;p++){let x=R[p];if(x.texture!==null&&x.boundingBox.containsPoint(A))return x}return null}function CK(R,v,p,h,x){if(v.isScene!==!0)v=k8;l.resetTextureUnits();let q0=v.fog,R0=h.isMeshStandardMaterial||h.isMeshLambertMaterial||h.isMeshPhongMaterial?v.environment:null,E0=f===null?B.outputColorSpace:f.isXRRenderTarget===!0?f.texture.colorSpace:g0.workingColorSpace,V0=h.isMeshStandardMaterial||h.isMeshLambertMaterial&&!h.envMap||h.isMeshPhongMaterial&&!h.envMap,z0=t.get(h.envMap||R0,V0),S0=h.vertexColors===!0&&!!p.attributes.color&&p.attributes.color.itemSize===4,h0=!!p.attributes.tangent&&(!!h.normalMap||h.anisotropy>0),I0=!!p.morphAttributes.position,a0=!!p.morphAttributes.normal,U8=!!p.morphAttributes.color,Y8=a8;if(h.toneMapped){if(f===null||f.isXRRenderTarget===!0)Y8=B.toneMapping}let r0=p.morphAttributes.position||p.morphAttributes.normal||p.morphAttributes.color,V8=r0!==void 0?r0.length:0,M0=T.get(h),S8=I.state.lights;if(b0===!0){if(x0===!0||R!==e){let $8=R===e&&h.id===a;Q0.setState(h,R,$8)}}let d0=!1;if(h.version===M0.__version){if(M0.needsLights&&M0.lightsStateVersion!==S8.state.version)d0=!0;else if(M0.outputColorSpace!==E0)d0=!0;else if(x.isBatchedMesh&&M0.batching===!1)d0=!0;else if(!x.isBatchedMesh&&M0.batching===!0)d0=!0;else if(x.isBatchedMesh&&M0.batchingColor===!0&&x.colorTexture===null)d0=!0;else if(x.isBatchedMesh&&M0.batchingColor===!1&&x.colorTexture!==null)d0=!0;else if(x.isInstancedMesh&&M0.instancing===!1)d0=!0;else if(!x.isInstancedMesh&&M0.instancing===!0)d0=!0;else if(x.isSkinnedMesh&&M0.skinning===!1)d0=!0;else if(!x.isSkinnedMesh&&M0.skinning===!0)d0=!0;else if(x.isInstancedMesh&&M0.instancingColor===!0&&x.instanceColor===null)d0=!0;else if(x.isInstancedMesh&&M0.instancingColor===!1&&x.instanceColor!==null)d0=!0;else if(x.isInstancedMesh&&M0.instancingMorph===!0&&x.morphTexture===null)d0=!0;else if(x.isInstancedMesh&&M0.instancingMorph===!1&&x.morphTexture!==null)d0=!0;else if(M0.envMap!==z0)d0=!0;else if(h.fog===!0&&M0.fog!==q0)d0=!0;else if(M0.numClippingPlanes!==void 0&&(M0.numClippingPlanes!==Q0.numPlanes||M0.numIntersection!==Q0.numIntersection))d0=!0;else if(M0.vertexAlphas!==S0)d0=!0;else if(M0.vertexTangents!==h0)d0=!0;else if(M0.morphTargets!==I0)d0=!0;else if(M0.morphNormals!==a0)d0=!0;else if(M0.morphColors!==U8)d0=!0;else if(M0.toneMapping!==Y8)d0=!0;else if(M0.morphTargetsCount!==V8)d0=!0;else if(!!M0.lightProbeGrid!==I.state.lightProbeGridArray.length>0)d0=!0}else d0=!0,M0.__version=h.version;let l8=M0.currentProgram;if(d0===!0){if(l8=t6(h,v,x),P&&h.isNodeMaterial)P.onUpdateProgram(h,l8,M0)}let t8=!1,M9=!1,e9=!1,t0=l8.getUniforms(),G8=M0.uniforms;if(L.useProgram(l8.program))t8=!0,M9=!0,e9=!0;if(h.id!==a)a=h.id,M9=!0;if(M0.needsLights){let $8=IK(I.state.lightProbeGridArray,x);if(M0.lightProbeGrid!==$8)M0.lightProbeGrid=$8,M9=!0}if(t8||e!==R){if(L.buffers.depth.getReversed()&&R.reversedDepth!==!0)R._reversedDepth=!0,R.updateProjectionMatrix();t0.setValue(j,"projectionMatrix",R.projectionMatrix),t0.setValue(j,"viewMatrix",R.matrixWorldInverse);let k9=t0.map.cameraPosition;if(k9!==void 0)k9.setValue(j,p8.setFromMatrixPosition(R.matrixWorld));if(W8.logarithmicDepthBuffer)t0.setValue(j,"logDepthBufFC",2/(Math.log(R.far+1)/Math.LN2));if(h.isMeshPhongMaterial||h.isMeshToonMaterial||h.isMeshLambertMaterial||h.isMeshBasicMaterial||h.isMeshStandardMaterial||h.isShaderMaterial)t0.setValue(j,"isOrthographic",R.isOrthographicCamera===!0);if(e!==R)e=R,M9=!0,e9=!0}if(M0.needsLights){if(S8.state.directionalShadowMap.length>0)t0.setValue(j,"directionalShadowMap",S8.state.directionalShadowMap,l);if(S8.state.spotShadowMap.length>0)t0.setValue(j,"spotShadowMap",S8.state.spotShadowMap,l);if(S8.state.pointShadowMap.length>0)t0.setValue(j,"pointShadowMap",S8.state.pointShadowMap,l)}if(x.isSkinnedMesh){t0.setOptional(j,x,"bindMatrix"),t0.setOptional(j,x,"bindMatrixInverse");let $8=x.skeleton;if($8){if($8.boneTexture===null)$8.computeBoneTexture();t0.setValue(j,"boneTexture",$8.boneTexture,l)}}if(x.isBatchedMesh){if(t0.setOptional(j,x,"batchingTexture"),t0.setValue(j,"batchingTexture",x._matricesTexture,l),t0.setOptional(j,x,"batchingIdTexture"),t0.setValue(j,"batchingIdTexture",x._indirectTexture,l),t0.setOptional(j,x,"batchingColorTexture"),x._colorsTexture!==null)t0.setValue(j,"batchingColorTexture",x._colorsTexture,l)}let R9=p.morphAttributes;if(R9.position!==void 0||R9.normal!==void 0||R9.color!==void 0)c0.update(x,p,l8);if(M9||M0.receiveShadow!==x.receiveShadow)M0.receiveShadow=x.receiveShadow,t0.setValue(j,"receiveShadow",x.receiveShadow);if((h.isMeshStandardMaterial||h.isMeshLambertMaterial||h.isMeshPhongMaterial)&&h.envMap===null&&v.environment!==null)G8.envMapIntensity.value=v.environmentIntensity;if(G8.dfgLUT!==void 0)G8.dfgLUT.value=i5();if(M9){if(t0.setValue(j,"toneMappingExposure",B.toneMappingExposure),M0.needsLights)_K(G8,e9);if(q0&&h.fog===!0)F0.refreshFogUniforms(G8,q0);if(F0.refreshMaterialUniforms(G8,h,K0,W0,I.state.transmissionRenderTarget[R.id]),M0.needsLights&&M0.lightProbeGrid){let $8=M0.lightProbeGrid;G8.probesSH.value=$8.texture,G8.probesMin.value.copy($8.boundingBox.min),G8.probesMax.value.copy($8.boundingBox.max),G8.probesResolution.value.copy($8.resolution)}i6.upload(j,gQ(M0),G8,l)}if(h.isShaderMaterial&&h.uniformsNeedUpdate===!0)i6.upload(j,gQ(M0),G8,l),h.uniformsNeedUpdate=!1;if(h.isSpriteMaterial)t0.setValue(j,"center",x.center);if(t0.setValue(j,"modelViewMatrix",x.modelViewMatrix),t0.setValue(j,"normalMatrix",x.normalMatrix),t0.setValue(j,"modelMatrix",x.matrixWorld),h.uniformsGroups!==void 0){let $8=h.uniformsGroups;for(let k9=0,J6=$8.length;k9<J6;k9++){let mQ=$8[k9];O0.update(mQ,l8),O0.bind(mQ,l8)}}return l8}function _K(R,v){R.ambientLightColor.needsUpdate=v,R.lightProbe.needsUpdate=v,R.directionalLights.needsUpdate=v,R.directionalLightShadows.needsUpdate=v,R.pointLights.needsUpdate=v,R.pointLightShadows.needsUpdate=v,R.spotLights.needsUpdate=v,R.spotLightShadows.needsUpdate=v,R.rectAreaLights.needsUpdate=v,R.hemisphereLights.needsUpdate=v}function AK(R){return R.isMeshLambertMaterial||R.isMeshToonMaterial||R.isMeshPhongMaterial||R.isMeshStandardMaterial||R.isShadowMaterial||R.isShaderMaterial&&R.lights===!0}if(this.getActiveCubeFace=function(){return c},this.getActiveMipmapLevel=function(){return m},this.getRenderTarget=function(){return f},this.setRenderTargetTextures=function(R,v,p){let h=T.get(R);if(h.__autoAllocateDepthBuffer=R.resolveDepthBuffer===!1,h.__autoAllocateDepthBuffer===!1)h.__useRenderToTexture=!1;T.get(R.texture).__webglTexture=v,T.get(R.depthTexture).__webglTexture=h.__autoAllocateDepthBuffer?void 0:p,h.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(R,v){let p=T.get(R);p.__webglFramebuffer=v,p.__useDefaultFramebuffer=v===void 0},this.setRenderTarget=function(R,v=0,p=0){f=R,c=v,m=p;let h=null,x=!1,q0=!1;if(R){let E0=T.get(R);if(E0.__useDefaultFramebuffer!==void 0){L.bindFramebuffer(j.FRAMEBUFFER,E0.__webglFramebuffer),J0.copy(R.viewport),k0.copy(R.scissor),D0=R.scissorTest,L.viewport(J0),L.scissor(k0),L.setScissorTest(D0),a=-1;return}else if(E0.__webglFramebuffer===void 0)l.setupRenderTarget(R);else if(E0.__hasExternalTextures)l.rebindTextures(R,T.get(R.texture).__webglTexture,T.get(R.depthTexture).__webglTexture);else if(R.depthBuffer){let S0=R.depthTexture;if(E0.__boundDepthTexture!==S0){if(S0!==null&&T.has(S0)&&(R.width!==S0.image.width||R.height!==S0.image.height))throw Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");l.setupDepthRenderbuffer(R)}}let V0=R.texture;if(V0.isData3DTexture||V0.isDataArrayTexture||V0.isCompressedArrayTexture)q0=!0;let z0=T.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget){if(Array.isArray(z0[v]))h=z0[v][p];else h=z0[v];x=!0}else if(R.samples>0&&l.useMultisampledRTT(R)===!1)h=T.get(R).__webglMultisampledFramebuffer;else if(Array.isArray(z0))h=z0[p];else h=z0;J0.copy(R.viewport),k0.copy(R.scissor),D0=R.scissorTest}else J0.copy(j0).multiplyScalar(K0).floor(),k0.copy(f0).multiplyScalar(K0).floor(),D0=y0;if(p!==0)h=b;if(L.bindFramebuffer(j.FRAMEBUFFER,h))L.drawBuffers(R,h);if(L.viewport(J0),L.scissor(k0),L.setScissorTest(D0),x){let E0=T.get(R.texture);j.framebufferTexture2D(j.FRAMEBUFFER,j.COLOR_ATTACHMENT0,j.TEXTURE_CUBE_MAP_POSITIVE_X+v,E0.__webglTexture,p)}else if(q0){let E0=v;for(let V0=0;V0<R.textures.length;V0++){let z0=T.get(R.textures[V0]);j.framebufferTextureLayer(j.FRAMEBUFFER,j.COLOR_ATTACHMENT0+V0,z0.__webglTexture,p,E0)}}else if(R!==null&&p!==0){let E0=T.get(R.texture);j.framebufferTexture2D(j.FRAMEBUFFER,j.COLOR_ATTACHMENT0,j.TEXTURE_2D,E0.__webglTexture,p)}a=-1},this.readRenderTargetPixels=function(R,v,p,h,x,q0,R0,E0=0){if(!(R&&R.isWebGLRenderTarget)){P0("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let V0=T.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&R0!==void 0)V0=V0[R0];if(V0){L.bindFramebuffer(j.FRAMEBUFFER,V0);try{let z0=R.textures[E0],S0=z0.format,h0=z0.type;if(R.textures.length>1)j.readBuffer(j.COLOR_ATTACHMENT0+E0);if(!W8.textureFormatReadable(S0)){P0("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!W8.textureTypeReadable(h0)){P0("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}if(v>=0&&v<=R.width-h&&(p>=0&&p<=R.height-x))j.readPixels(v,p,h,x,s.convert(S0),s.convert(h0),q0)}finally{let z0=f!==null?T.get(f).__webglFramebuffer:null;L.bindFramebuffer(j.FRAMEBUFFER,z0)}}},this.readRenderTargetPixelsAsync=async function(R,v,p,h,x,q0,R0,E0=0){if(!(R&&R.isWebGLRenderTarget))throw Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let V0=T.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&R0!==void 0)V0=V0[R0];if(V0)if(v>=0&&v<=R.width-h&&(p>=0&&p<=R.height-x)){L.bindFramebuffer(j.FRAMEBUFFER,V0);let z0=R.textures[E0],S0=z0.format,h0=z0.type;if(R.textures.length>1)j.readBuffer(j.COLOR_ATTACHMENT0+E0);if(!W8.textureFormatReadable(S0))throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!W8.textureTypeReadable(h0))throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let I0=j.createBuffer();j.bindBuffer(j.PIXEL_PACK_BUFFER,I0),j.bufferData(j.PIXEL_PACK_BUFFER,q0.byteLength,j.STREAM_READ),j.readPixels(v,p,h,x,s.convert(S0),s.convert(h0),0);let a0=f!==null?T.get(f).__webglFramebuffer:null;L.bindFramebuffer(j.FRAMEBUFFER,a0);let U8=j.fenceSync(j.SYNC_GPU_COMMANDS_COMPLETE,0);return j.flush(),await GZ(j,U8,4),j.bindBuffer(j.PIXEL_PACK_BUFFER,I0),j.getBufferSubData(j.PIXEL_PACK_BUFFER,0,q0),j.deleteBuffer(I0),j.deleteSync(U8),q0}else throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(R,v=null,p=0){let h=Math.pow(2,-p),x=Math.floor(R.image.width*h),q0=Math.floor(R.image.height*h),R0=v!==null?v.x:0,E0=v!==null?v.y:0;l.setTexture2D(R,0),j.copyTexSubImage2D(j.TEXTURE_2D,p,0,0,R0,E0,x,q0),L.unbindTexture()},this.copyTextureToTexture=function(R,v,p=null,h=null,x=0,q0=0){let R0,E0,V0,z0,S0,h0,I0,a0,U8,Y8=R.isCompressedTexture?R.mipmaps[q0]:R.image;if(p!==null)R0=p.max.x-p.min.x,E0=p.max.y-p.min.y,V0=p.isBox3?p.max.z-p.min.z:1,z0=p.min.x,S0=p.min.y,h0=p.isBox3?p.min.z:0;else{let G8=Math.pow(2,-x);if(R0=Math.floor(Y8.width*G8),E0=Math.floor(Y8.height*G8),R.isDataArrayTexture)V0=Y8.depth;else if(R.isData3DTexture)V0=Math.floor(Y8.depth*G8);else V0=1;z0=0,S0=0,h0=0}if(h!==null)I0=h.x,a0=h.y,U8=h.z;else I0=0,a0=0,U8=0;let r0=s.convert(v.format),V8=s.convert(v.type),M0;if(v.isData3DTexture)l.setTexture3D(v,0),M0=j.TEXTURE_3D;else if(v.isDataArrayTexture||v.isCompressedArrayTexture)l.setTexture2DArray(v,0),M0=j.TEXTURE_2D_ARRAY;else l.setTexture2D(v,0),M0=j.TEXTURE_2D;L.activeTexture(j.TEXTURE0),L.pixelStorei(j.UNPACK_FLIP_Y_WEBGL,v.flipY),L.pixelStorei(j.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),L.pixelStorei(j.UNPACK_ALIGNMENT,v.unpackAlignment);let S8=L.getParameter(j.UNPACK_ROW_LENGTH),d0=L.getParameter(j.UNPACK_IMAGE_HEIGHT),l8=L.getParameter(j.UNPACK_SKIP_PIXELS),t8=L.getParameter(j.UNPACK_SKIP_ROWS),M9=L.getParameter(j.UNPACK_SKIP_IMAGES);L.pixelStorei(j.UNPACK_ROW_LENGTH,Y8.width),L.pixelStorei(j.UNPACK_IMAGE_HEIGHT,Y8.height),L.pixelStorei(j.UNPACK_SKIP_PIXELS,z0),L.pixelStorei(j.UNPACK_SKIP_ROWS,S0),L.pixelStorei(j.UNPACK_SKIP_IMAGES,h0);let e9=R.isDataArrayTexture||R.isData3DTexture,t0=v.isDataArrayTexture||v.isData3DTexture;if(R.isDepthTexture){let G8=T.get(R),R9=T.get(v),$8=T.get(G8.__renderTarget),k9=T.get(R9.__renderTarget);L.bindFramebuffer(j.READ_FRAMEBUFFER,$8.__webglFramebuffer),L.bindFramebuffer(j.DRAW_FRAMEBUFFER,k9.__webglFramebuffer);for(let J6=0;J6<V0;J6++){if(e9)j.framebufferTextureLayer(j.READ_FRAMEBUFFER,j.COLOR_ATTACHMENT0,T.get(R).__webglTexture,x,h0+J6),j.framebufferTextureLayer(j.DRAW_FRAMEBUFFER,j.COLOR_ATTACHMENT0,T.get(v).__webglTexture,q0,U8+J6);j.blitFramebuffer(z0,S0,R0,E0,I0,a0,R0,E0,j.DEPTH_BUFFER_BIT,j.NEAREST)}L.bindFramebuffer(j.READ_FRAMEBUFFER,null),L.bindFramebuffer(j.DRAW_FRAMEBUFFER,null)}else if(x!==0||R.isRenderTargetTexture||T.has(R)){let G8=T.get(R),R9=T.get(v);L.bindFramebuffer(j.READ_FRAMEBUFFER,o),L.bindFramebuffer(j.DRAW_FRAMEBUFFER,g);for(let $8=0;$8<V0;$8++){if(e9)j.framebufferTextureLayer(j.READ_FRAMEBUFFER,j.COLOR_ATTACHMENT0,G8.__webglTexture,x,h0+$8);else j.framebufferTexture2D(j.READ_FRAMEBUFFER,j.COLOR_ATTACHMENT0,j.TEXTURE_2D,G8.__webglTexture,x);if(t0)j.framebufferTextureLayer(j.DRAW_FRAMEBUFFER,j.COLOR_ATTACHMENT0,R9.__webglTexture,q0,U8+$8);else j.framebufferTexture2D(j.DRAW_FRAMEBUFFER,j.COLOR_ATTACHMENT0,j.TEXTURE_2D,R9.__webglTexture,q0);if(x!==0)j.blitFramebuffer(z0,S0,R0,E0,I0,a0,R0,E0,j.COLOR_BUFFER_BIT,j.NEAREST);else if(t0)j.copyTexSubImage3D(M0,q0,I0,a0,U8+$8,z0,S0,R0,E0);else j.copyTexSubImage2D(M0,q0,I0,a0,z0,S0,R0,E0)}L.bindFramebuffer(j.READ_FRAMEBUFFER,null),L.bindFramebuffer(j.DRAW_FRAMEBUFFER,null)}else if(t0)if(R.isDataTexture||R.isData3DTexture)j.texSubImage3D(M0,q0,I0,a0,U8,R0,E0,V0,r0,V8,Y8.data);else if(v.isCompressedArrayTexture)j.compressedTexSubImage3D(M0,q0,I0,a0,U8,R0,E0,V0,r0,Y8.data);else j.texSubImage3D(M0,q0,I0,a0,U8,R0,E0,V0,r0,V8,Y8);else if(R.isDataTexture)j.texSubImage2D(j.TEXTURE_2D,q0,I0,a0,R0,E0,r0,V8,Y8.data);else if(R.isCompressedTexture)j.compressedTexSubImage2D(j.TEXTURE_2D,q0,I0,a0,Y8.width,Y8.height,r0,Y8.data);else j.texSubImage2D(j.TEXTURE_2D,q0,I0,a0,R0,E0,r0,V8,Y8);if(L.pixelStorei(j.UNPACK_ROW_LENGTH,S8),L.pixelStorei(j.UNPACK_IMAGE_HEIGHT,d0),L.pixelStorei(j.UNPACK_SKIP_PIXELS,l8),L.pixelStorei(j.UNPACK_SKIP_ROWS,t8),L.pixelStorei(j.UNPACK_SKIP_IMAGES,M9),q0===0&&v.generateMipmaps)j.generateMipmap(M0);L.unbindTexture()},this.initRenderTarget=function(R){if(T.get(R).__webglFramebuffer===void 0)l.setupRenderTarget(R)},this.initTexture=function(R){if(R.isCubeTexture)l.setTextureCube(R,0);else if(R.isData3DTexture)l.setTexture3D(R,0);else if(R.isDataArrayTexture||R.isCompressedArrayTexture)l.setTexture2DArray(R,0);else l.setTexture2D(R,0);L.unbindTexture()},this.resetState=function(){c=0,m=0,f=null,L.reset(),Y0.reset()},typeof __THREE_DEVTOOLS__<"u")__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return x$}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(J){this._outputColorSpace=J;let $=this.getContext();$.drawingBufferColorSpace=g0._getDrawingBufferColorSpace(J),$.unpackColorSpace=g0._getUnpackColorSpace()}}var IQ=`
varying vec2 vUv;
