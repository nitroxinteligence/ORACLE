...
void main() {
	...
	`}class M$ extends u8{constructor(J=1,Q={}){super(J,J,Q);this.isWebGLCubeRenderTarget=!0;let $={width:J,height:J,depth:1},Z=[$,$,$,$,$,$];this.texture=new s7(Z),this._setTextureOptions(Q),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(J,Q){this.texture.type=Q.type,this.texture.colorSpace=Q.colorSpace,this.texture.generateMipmaps=Q.generateMipmaps,this.texture.minFilter=Q.minFilter,this.texture.magFilter=Q.magFilter;let $={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},Z=new V6(5,5,5),W=new T8({name:"CubemapFromEquirect",uniforms:i9($.uniforms),vertexShader:$.vertexShader,fragmentShader:$.fragmentShader,side:w8,blending:Q9});W.uniforms.tEquirect.value=Q;let K=new h8(Z,W),H=Q.minFilter;if(Q.minFilter===m9)Q.minFilter=C8;return new Z$(1,10,this).update(J,K),Q.minFilter=H,K.geometry.dispose(),K.material.dispose(),this}clear(J,Q=!0,$=!0,Z=!0){let W=J.getRenderTarget();for(let K=0;K<6;K++)J.setRenderTarget(this,K),J.clear(Q,$,Z);J.setRenderTarget(W)}}function pX(J){let Q=new WeakMap,$=new WeakMap,Z=null;function W(G,D=!1){if(G===null||G===void 0)return null;if(D)return H(G);return K(G)}function K(G){if(G&&G.isTexture){let D=G.mapping;if(D===z7||D===I7)if(Q.has(G)){let k=Q.get(G).texture;return Y(k,G.mapping)}else{let k=G.image;if(k&&k.height>0){let z=new M$(k.height);return z.fromEquirectangularTexture(J,G),Q.set(G,z),G.addEventListener("dispose",U),Y(z.texture,G.mapping)}else return null}}return G}function H(G){if(G&&G.isTexture){let D=G.mapping,k=D===z7||D===I7,z=D===k6||D===p9;if(k||z){let F=$.get(G),E=F!==void 0?F.texture.pmremVersion:0;if(G.isRenderTargetTexture&&G.pmremVersion!==E){if(Z===null)Z=new D$(J);return F=k?Z.fromEquirectangular(G,F):Z.fromCubemap(G,F),F.texture.pmremVersion=G.pmremVersion,$.set(G,F),F.texture}else if(F!==void 0)return F.texture;else{let I=G.image;if(k&&I&&I.height>0||z&&I&&X(I)){if(Z===null)Z=new D$(J);return F=k?Z.fromEquirectangular(G):Z.fromCubemap(G),F.texture.pmremVersion=G.pmremVersion,$.set(G,F),G.addEventListener("dispose",q),F.texture}else return null}}}return G}function Y(G,D){if(D===z7)G.mapping=k6;else if(D===I7)G.mapping=p9;return G}function X(G){let D=0,k=6;for(let z=0;z<k;z++)if(G[z]!==void 0)D++;return D===k}function U(G){let D=G.target;D.removeEventListener("dispose",U);let k=Q.get(D);if(k!==void 0)Q.delete(D),k.dispose()}function q(G){let D=G.target;D.removeEventListener("dispose",q);let k=$.get(D);if(k!==void 0)$.delete(D),k.dispose()}function N(){if(Q=new WeakMap,$=new WeakMap,Z!==null)Z.dispose(),Z=null}return{get:W,dispose:N}}function mX(J){let Q={};function $(Z){if(Q[Z]!==void 0)return Q[Z];let W=J.getExtension(Z);return Q[Z]=W,W}return{has:function(Z){return $(Z)!==null},init:function(){$("EXT_color_buffer_float"),$("WEBGL_clip_cull_distance"),$("OES_texture_float_linear"),$("EXT_color_buffer_half_float"),$("WEBGL_multisampled_render_to_texture"),$("WEBGL_render_shared_exponent")},get:function(Z){let W=$(Z);if(W===null)g9("WebGLRenderer: "+Z+" extension not supported.");return W}}}function lX(J,Q,$,Z){let W={},K=new WeakMap;function H(N){let G=N.target;if(G.index!==null)Q.remove(G.index);for(let k in G.attributes)Q.remove(G.attributes[k]);G.removeEventListener("dispose",H),delete W[G.id];let D=K.get(G);if(D)Q.remove(D),K.delete(G);if(Z.releaseStatesOfGeometry(G),G.isInstancedBufferGeometry===!0)delete G._maxInstanceCount;$.memory.geometries--}function Y(N,G){if(W[G.id]===!0)return G;return G.addEventListener("dispose",H),W[G.id]=!0,$.memory.geometries++,G}function X(N){let G=N.attributes;for(let D in G)Q.update(G[D],J.ARRAY_BUFFER)}function U(N){let G=[],D=N.index,k=N.attributes.position,z=0;if(k===void 0)return;if(D!==null){let I=D.array;z=D.version;for(let A=0,V=I.length;A<V;A+=3){let _=I[A+0],C=I[A+1],w=I[A+2];G.push(_,C,C,w,w,_)}}else{let I=k.array;z=k.version;for(let A=0,V=I.length/3-1;A<V;A+=3){let _=A+0,C=A+1,w=A+2;G.push(_,C,C,w,w,_)}}let F=new(k.count>=65535?l7:m7)(G,1);F.version=z;let E=K.get(N);if(E)Q.remove(E);K.set(N,F)}function q(N){let G=K.get(N);if(G){let D=N.index;if(D!==null){if(G.version<D.version)U(N)}}else U(N);return K.get(N)}return{get:Y,update:X,getWireframeAttribute:q}}function dX(J,Q,$){let Z;function W(N){Z=N}let K,H;function Y(N){K=N.type,H=N.bytesPerElement}function X(N,G){J.drawElements(Z,G,K,N*H),$.update(G,Z,1)}function U(N,G,D){if(D===0)return;J.drawElementsInstanced(Z,G,K,N*H,D),$.update(G,Z,D)}function q(N,G,D){if(D===0)return;Q.get("WEBGL_multi_draw").multiDrawElementsWEBGL(Z,G,0,K,N,0,D);let z=0;for(let F=0;F<D;F++)z+=G[F];$.update(z,Z,1)}this.setMode=W,this.setIndex=Y,this.render=X,this.renderInstances=U,this.renderMultiDraw=q}function uX(J){let Q={geometries:0,textures:0},$={frame:0,calls:0,triangles:0,points:0,lines:0};function Z(K,H,Y){switch($.calls++,H){case J.TRIANGLES:$.triangles+=Y*(K/3);break;case J.LINES:$.lines+=Y*(K/2);break;case J.LINE_STRIP:$.lines+=Y*(K-1);break;case J.LINE_LOOP:$.lines+=Y*K;break;case J.POINTS:$.points+=Y*K;break;default:P0("WebGLInfo: Unknown draw mode:",H);break}}function W(){$.calls=0,$.triangles=0,$.points=0,$.lines=0}return{memory:Q,render:$,programs:null,autoReset:!0,reset:W,update:Z}}function cX(J,Q,$){let Z=new WeakMap,W=new K8;function K(H,Y,X){let U=H.morphTargetInfluences,q=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,N=q!==void 0?q.length:0,G=Z.get(Y);if(G===void 0||G.count!==N){let B=function(){w.dispose(),Z.delete(Y),Y.removeEventListener("dispose",B)};if(G!==void 0)G.texture.dispose();let D=Y.morphAttributes.position!==void 0,k=Y.morphAttributes.normal!==void 0,z=Y.morphAttributes.color!==void 0,F=Y.morphAttributes.position||[],E=Y.morphAttributes.normal||[],I=Y.morphAttributes.color||[],A=0;if(D===!0)A=1;if(k===!0)A=2;if(z===!0)A=3;let V=Y.attributes.position.count*A,_=1;if(V>Q.maxTextureSize)_=Math.ceil(V/Q.maxTextureSize),V=Q.maxTextureSize;let C=new Float32Array(V*_*4*N),w=new x7(C,V,_,N);w.type=q9,w.needsUpdate=!0;let R=A*4;for(let d=0;d<N;d++){let P=F[d],h=E[d],o=I[d],g=V*_*4*d;for(let c=0;c<P.count;c++){let m=c*R;if(D===!0)W.fromBufferAttribute(P,c),C[g+m+0]=W.x,C[g+m+1]=W.y,C[g+m+2]=W.z,C[g+m+3]=0;if(k===!0)W.fromBufferAttribute(h,c),C[g+m+4]=W.x,C[g+m+5]=W.y,C[g+m+6]=W.z,C[g+m+7]=0;if(z===!0)W.fromBufferAttribute(o,c),C[g+m+8]=W.x,C[g+m+9]=W.y,C[g+m+10]=W.z,C[g+m+11]=o.itemSize===4?W.w:1}}G={count:N,texture:w,size:new n0(V,_)},Z.set(Y,G),Y.addEventListener("dispose",B)}if(H.isInstancedMesh===!0&&H.morphTexture!==null)X.getUniforms().setValue(J,"morphTexture",H.morphTexture,$);else{let D=0;for(let z=0;z<U.length;z++)D+=U[z];let k=Y.morphTargetsRelative?1:1-D;X.getUniforms().setValue(J,"morphTargetBaseInfluence",k),X.getUniforms().setValue(J,"morphTargetInfluences",U)}X.getUniforms().setValue(J,"morphTargetsTexture",G.texture,$),X.getUniforms().setValue(J,"morphTargetsTextureSize",G.size)}return{update:K}}function nX(J,Q,$,Z,W){let K=new WeakMap;function H(U){let q=W.render.frame,N=U.geometry,G=Q.get(U,N);if(K.get(G)!==q)Q.update(G),K.set(G,q);if(U.isInstancedMesh){if(U.hasEventListener("dispose",X)===!1)U.addEventListener("dispose",X);if(K.get(U)!==q){if($.update(U.instanceMatrix,J.ARRAY_BUFFER),U.instanceColor!==null)$.update(U.instanceColor,J.ARRAY_BUFFER);K.set(U,q)}}if(U.isSkinnedMesh){let D=U.skeleton;if(K.get(D)!==q)D.update(),K.set(D,q)}return G}function Y(){K=new WeakMap}function X(U){let q=U.target;if(q.removeEventListener("dispose",X),Z.releaseStatesOfObject(q),$.remove(q.instanceMatrix),q.instanceColor!==null)$.remove(q.instanceColor)}return{update:H,dispose:Y}}var sX={[pJ]:"LINEAR_TONE_MAPPING",[mJ]:"REINHARD_TONE_MAPPING",[lJ]:"CINEON_TONE_MAPPING",[dJ]:"ACES_FILMIC_TONE_MAPPING",[cJ]:"AGX_TONE_MAPPING",[nJ]:"NEUTRAL_TONE_MAPPING",[uJ]:"CUSTOM_TONE_MAPPING"};function iX(J,Q,$,Z,W,K){let H=new u8(Q,$,{type:J,depthBuffer:W,stencilBuffer:K,samples:Z?4:0,depthTexture:W?new T9(Q,$):void 0}),Y=new u8(Q,$,{type:F9,depthBuffer:!1,stencilBuffer:!1}),X=new L8;X.setAttribute("position",new y8([-1,3,0,-1,-1,0,3,-1,0],3)),X.setAttribute("uv",new y8([0,2,0,0,2,0],2));let U=new uQ({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)}var mU={[pJ]:"Linear",[mJ]:"Reinhard",[lJ]:"Cineon",[dJ]:"ACESFilmic",[cJ]:"AgX",[nJ]:"Neutral",[uJ]:"Custom"};function lU(J,Q){let $=mU[Q];if($===void 0)return C0("WebGLProgram: Unsupported toneMapping:",Q),"vec3 "+J+"( vec3 color ) { return LinearToneMapping( color ); }";return"vec3 "+J+"( vec3 color ) { return "+$+"ToneMapping( color ); }"}var e7=new y;function dU(){g0.getLuminanceCoefficients(e7);let J=e7.x.toFixed(4),Q=e7.y.toFixed(4),$=e7.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${Q}, ${$} );`,"\treturn dot( weights, rgb );","}"].join(`
...
`)+`
`+F,E=["#define varying in",$.glslVersion===vQ?"":"layout(location = 0) out highp vec4 pc_fragColor;",$.glslVersion===vQ?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+E;let A=I+F+H,V=I+E+Y,_=LW(W,W.VERTEX_SHADER,A),C=LW(W,W.FRAGMENT_SHADER,V);if(W.attachShader(z,_),W.attachShader(z,C),$.index0AttributeName!==void 0)W.bindAttribLocation(z,0,$.index0AttributeName);else if($.hasPositionAttribute===!0)W.bindAttribLocation(z,0,"position");W.linkProgram(z);function w(P){if(J.debug.checkShaderErrors){let h=W.getProgramInfoLog(z)||"",o=W.getShaderInfoLog(_)||"",g=W.getShaderInfoLog(C)||"",c=h.trim(),m=o.trim(),f=g.trim(),a=!0,e=!0;if(W.getProgramParameter(z,W.LINK_STATUS)===!1)if(a=!1,typeof J.debug.onShaderError==="function")J.debug.onShaderError(W,z,_,C);else{let J0=BW(W,_,"vertex"),k0=BW(W,C,"fragment");P0("WebGLProgram: Shader Error "+W.getError()+" - VALIDATE_STATUS "+W.getProgramParameter(z,W.VALIDATE_STATUS)+`
