...
1. Run `base + ["--setup", "apply"]`, then `base + ["--setup", "verify"]`. These deterministic operations resume only owned work and verify file contents; collisions preserve original files.
