...
#endif`,RY="gl_FragColor = linearToOutputTexel( gl_FragColor );",kY=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:$9,depthTest:!1,depthWrite:!1})}function jU(J,Q,$){let W=new Float32Array(J6),Z=new h(0,1,0);return new T8({name:"SphericalGaussianBlur",defines:{n:J6,CUBEUV_TEXEL_WIDTH:1/Q,CUBEUV_TEXEL_HEIGHT:1/$,CUBEUV_MAX_MIP:`${J}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:W},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:Z}},vertexShader:XJ(),fragmentShader:`
	...
	`}class f$ extends c8{constructor(J=1,Q={}){super(J,J,Q);this.isWebGLCubeRenderTarget=!0;let $={width:J,height:J,depth:1},W=[$,$,$,$,$,$];this.texture=new QJ(W),this._setTextureOptions(Q),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(J,Q){this.texture.type=Q.type,this.texture.colorSpace=Q.colorSpace,this.texture.generateMipmaps=Q.generateMipmaps,this.texture.minFilter=Q.minFilter,this.texture.magFilter=Q.magFilter;let $={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},W=new _6(5,5,5),Z=new T8({name:"CubemapFromEquirect",uniforms:a9($.uniforms),vertexShader:$.vertexShader,fragmentShader:$.fragmentShader,side:w8,blending:$9});Z.uniforms.tEquirect.value=Q;let K=new x8(W,Z),H=Q.minFilter;if(Q.minFilter===d9)Q.minFilter=_8;return new k$(1,10,this).update(J,K),Q.minFilter=H,K.geometry.dispose(),K.material.dispose(),this}clear(J,Q=!0,$=!0,W=!0){let Z=J.getRenderTarget();for(let K=0;K<6;K++)J.setRenderTarget(this,K),J.clear(Q,$,W);J.setRenderTarget(Z)}}function vU(J){let Q=new WeakMap,$=new WeakMap,W=null;function Z(G,F=!1){if(G===null||G===void 0)return null;if(F)return H(G);return K(G)}function K(G){if(G&&G.isTexture){let F=G.mapping;if(F===T7||F===S7)if(Q.has(G)){let R=Q.get(G).texture;return Y(R,G.mapping)}else{let R=G.image;if(R&&R.height>0){let I=new f$(R.height);return I.fromEquirectangularTexture(J,G),Q.set(G,I),G.addEventListener("dispose",U),Y(I.texture,G.mapping)}else return null}}return G}function H(G){if(G&&G.isTexture){let F=G.mapping,R=F===T7||F===S7,I=F===z6||F===l9;if(R||I){let D=$.get(G),q=D!==void 0?D.texture.pmremVersion:0;if(G.isRenderTargetTexture&&G.pmremVersion!==q){if(W===null)W=new S$(J);return D=R?W.fromEquirectangular(G,D):W.fromCubemap(G,D),D.texture.pmremVersion=G.pmremVersion,$.set(G,D),D.texture}else if(D!==void 0)return D.texture;else{let C=G.image;if(R&&C&&C.height>0||I&&C&&X(C)){if(W===null)W=new S$(J);return D=R?W.fromEquirectangular(G):W.fromCubemap(G),D.texture.pmremVersion=G.pmremVersion,$.set(G,D),G.addEventListener("dispose",E),D.texture}else return null}}}return G}function Y(G,F){if(F===T7)G.mapping=z6;else if(F===S7)G.mapping=l9;return G}function X(G){let F=0,R=6;for(let I=0;I<R;I++)if(G[I]!==void 0)F++;return F===R}function U(G){let F=G.target;F.removeEventListener("dispose",U);let R=Q.get(F);if(R!==void 0)Q.delete(F),R.dispose()}function E(G){let F=G.target;F.removeEventListener("dispose",E);let R=$.get(F);if(R!==void 0)$.delete(F),R.dispose()}function N(){if(Q=new WeakMap,$=new WeakMap,W!==null)W.dispose(),W=null}return{get:Z,dispose:N}}function fU(J){let Q={};function $(W){if(Q[W]!==void 0)return Q[W];let Z=J.getExtension(W);return Q[W]=Z,Z}return{has:function(W){return $(W)!==null},init:function(){$("EXT_color_buffer_float"),$("WEBGL_clip_cull_distance"),$("OES_texture_float_linear"),$("EXT_color_buffer_half_float"),$("WEBGL_multisampled_render_to_texture"),$("WEBGL_render_shared_exponent")},get:function(W){let Z=$(W);if(Z===null)m9("WebGLRenderer: "+W+" extension not supported.");return Z}}}function yU(J,Q,$,W){let Z={},K=new WeakMap;function H(N){let G=N.target;if(G.index!==null)Q.remove(G.index);for(let R in G.attributes)Q.remove(G.attributes[R]);G.removeEventListener("dispose",H),delete Z[G.id];let F=K.get(G);if(F)Q.remove(F),K.delete(G);if(W.releaseStatesOfGeometry(G),G.isInstancedBufferGeometry===!0)delete G._maxInstanceCount;$.memory.geometries--}function Y(N,G){if(Z[G.id]===!0)return G;return G.addEventListener("dispose",H),Z[G.id]=!0,$.memory.geometries++,G}function X(N){let G=N.attributes;for(let F in G)Q.update(G[F],J.ARRAY_BUFFER)}function U(N){let G=[],F=N.index,R=N.attributes.position,I=0;if(R===void 0)return;if(F!==null){let C=F.array;I=F.version;for(let P=0,k=C.length;P<k;P+=3){let V=C[P+0],_=C[P+1],A=C[P+2];G.push(V,_,_,A,A,V)}}else{let C=R.array;I=R.version;for(let P=0,k=C.length/3-1;P<k;P+=3){let V=P+0,_=P+1,A=P+2;G.push(V,_,_,A,A,V)}}let D=new(R.count>=65535?o7:i7)(G,1);D.version=I;let q=K.get(N);if(q)Q.remove(q);K.set(N,D)}function E(N){let G=K.get(N);if(G){let F=N.index;if(F!==null){if(G.version<F.version)U(N)}}else U(N);return K.get(N)}return{get:Y,update:X,getWireframeAttribute:E}}function bU(J,Q,$){let W;function Z(N){W=N}let K,H;function Y(N){K=N.type,H=N.bytesPerElement}function X(N,G){J.drawElements(W,G,K,N*H),$.update(G,W,1)}function U(N,G,F){if(F===0)return;J.drawElementsInstanced(W,G,K,N*H,F),$.update(G,W,F)}function E(N,G,F){if(F===0)return;Q.get("WEBGL_multi_draw").multiDrawElementsWEBGL(W,G,0,K,N,0,F);let I=0;for(let D=0;D<F;D++)I+=G[D];$.update(I,W,1)}this.setMode=Z,this.setIndex=Y,this.render=X,this.renderInstances=U,this.renderMultiDraw=E}function hU(J){let Q={geometries:0,textures:0},$={frame:0,calls:0,triangles:0,points:0,lines:0};function W(K,H,Y){switch($.calls++,H){case J.TRIANGLES:$.triangles+=Y*(K/3);break;case J.LINES:$.lines+=Y*(K/2);break;case J.LINE_STRIP:$.lines+=Y*(K-1);break;case J.LINE_LOOP:$.lines+=Y*K;break;case J.POINTS:$.points+=Y*K;break;default:P0("WebGLInfo: Unknown draw mode:",H);break}}function Z(){$.calls=0,$.triangles=0,$.points=0,$.lines=0}return{memory:Q,render:$,programs:null,autoReset:!0,reset:Z,update:W}}function xU(J,Q,$){let W=new WeakMap,Z=new K8;function K(H,Y,X){let U=H.morphTargetInfluences,E=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,N=E!==void 0?E.length:0,G=W.get(Y);if(G===void 0||G.count!==N){let z=function(){A.dispose(),W.delete(Y),Y.removeEventListener("dispose",z)};if(G!==void 0)G.texture.dispose();let F=Y.morphAttributes.position!==void 0,R=Y.morphAttributes.normal!==void 0,I=Y.morphAttributes.color!==void 0,D=Y.morphAttributes.position||[],q=Y.morphAttributes.normal||[],C=Y.morphAttributes.color||[],P=0;if(F===!0)P=1;if(R===!0)P=2;if(I===!0)P=3;let k=Y.attributes.position.count*P,V=1;if(k>Q.maxTextureSize)V=Math.ceil(k/Q.maxTextureSize),k=Q.maxTextureSize;let _=new Float32Array(k*V*4*N),A=new c7(_,k,V,N);A.type=F9,A.needsUpdate=!0;let O=P*4;for(let p=0;p<N;p++){let w=D[p],y=q[p],c=C[p],b=k*V*4*p;for(let u=0;u<w.count;u++){let m=u*O;if(F===!0)Z.fromBufferAttribute(w,u),_[b+m+0]=Z.x,_[b+m+1]=Z.y,_[b+m+2]=Z.z,_[b+m+3]=0;if(R===!0)Z.fromBufferAttribute(y,u),_[b+m+4]=Z.x,_[b+m+5]=Z.y,_[b+m+6]=Z.z,_[b+m+7]=0;if(I===!0)Z.fromBufferAttribute(c,u),_[b+m+8]=Z.x,_[b+m+9]=Z.y,_[b+m+10]=Z.z,_[b+m+11]=c.itemSize===4?Z.w:1}}G={count:N,texture:A,size:new n0(k,V)},W.set(Y,G),Y.addEventListener("dispose",z)}if(H.isInstancedMesh===!0&&H.morphTexture!==null)X.getUniforms().setValue(J,"morphTexture",H.morphTexture,$);else{let F=0;for(let I=0;I<U.length;I++)F+=U[I];let R=Y.morphTargetsRelative?1:1-F;X.getUniforms().setValue(J,"morphTargetBaseInfluence",R),X.getUniforms().setValue(J,"morphTargetInfluences",U)}X.getUniforms().setValue(J,"morphTargetsTexture",G.texture,$),X.getUniforms().setValue(J,"morphTargetsTextureSize",G.size)}return{update:K}}function gU(J,Q,$,W,Z){let K=new WeakMap;function H(U){let E=Z.render.frame,N=U.geometry,G=Q.get(U,N);if(K.get(G)!==E)Q.update(G),K.set(G,E);if(U.isInstancedMesh){if(U.hasEventListener("dispose",X)===!1)U.addEventListener("dispose",X);if(K.get(U)!==E){if($.update(U.instanceMatrix,J.ARRAY_BUFFER),U.instanceColor!==null)$.update(U.instanceColor,J.ARRAY_BUFFER);K.set(U,E)}}if(U.isSkinnedMesh){let F=U.skeleton;if(K.get(F)!==E)F.update(),K.set(F,E)}return G}function Y(){K=new WeakMap}function X(U){let E=U.target;if(E.removeEventListener("dispose",X),W.releaseStatesOfObject(E),$.remove(E.instanceMatrix),E.instanceColor!==null)$.remove(E.instanceColor)}return{update:H,dispose:Y}}var pU={[$Q]:"LINEAR_TONE_MAPPING",[WQ]:"REINHARD_TONE_MAPPING",[ZQ]:"CINEON_TONE_MAPPING",[KQ]:"ACES_FILMIC_TONE_MAPPING",[YQ]:"AGX_TONE_MAPPING",[XQ]:"NEUTRAL_TONE_MAPPING",[HQ]:"CUSTOM_TONE_MAPPING"};function mU(J,Q,$,W,Z,K){let H=new c8(Q,$,{type:J,depthBuffer:Z,stencilBuffer:K,samples:W?4:0,depthTexture:Z?new v9(Q,$):void 0}),Y=new c8(Q,$,{type:D9,depthBuffer:!1,stencilBuffer:!1}),X=new C8;X.setAttribute("position",new b8([-1,3,0,-1,-1,0,3,-1,0],3)),X.setAttribute("uv",new b8([0,2,0,0,2,0],2));let U=new H$({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),E=new x8(X,U),N=new C6(-1,1,1,-1,0,1),G=null,F=null,R=!1,I,D=null,q=[],C=!1;this.setSize=function(P,k){H.setSize(P,k),Y.setSize(P,k);for(let V=0;V<q.length;V++){let _=q[V];if(_.setSize)_.setSize(P,k)}},this.setEffects=function(P){q=P,C=q.length>0&&q[0].isRenderPass===!0;let{width:k,height:V}=H;for(let _=0;_<q.length;_++){let A=q[_];if(A.setSize)A.setSize(k,V)}},this.begin=function(P,k){if(R)return!1;if(P.toneMapping===r8&&q.length===0)return!1;if(D=k,k!==null){let{width:V,height:_}=k;if(H.width!==V||H.height!==_)this.setSize(V,_)}if(C===!1)P.setRenderTarget(H);return I=P.toneMapping,P.toneMapping=r8,!0},this.hasRenderPass=function(){return C},this.end=function(P,k){P.toneMapping=I,R=!0;let V=H,_=Y;for(let A=0;A<q.length;A++){let O=q[A];if(O.enabled===!1)continue;if(O.render(P,_,V,k),O.needsSwap!==!1){let z=V;V=_,_=z}}if(G!==P.outputColorSpace||F!==P.toneMapping){if(G=P.outputColorSpace,F=P.toneMapping,U.defines={},g0.getTransfer(G)===e0)U.defines.SRGB_TRANSFER="";let A=pU[F];if(A)U.defines[A]="";U.needsUpdate=!0}U.uniforms.tDiffuse.value=V.texture,P.setRenderTarget(D),P.render(E,N),D=null,R=!1},this.isCompositing=function(){return R},this.dispose=function(){if(H.depthTexture)H.depthTexture.dispose();H.dispose(),Y.dispose(),X.dispose(),U.dispose()}}var XK=new z8,j$=new v9(1,1),UK=new c7,GK=new J$,NK=new QJ,dZ=[],uZ=[],cZ=new Float32Array(16),nZ=new Float32Array(9),sZ=new Float32Array(4);function P6(J,Q,$){let W=J[0];if(W<=0||W>0)return J;let Z=Q*$,K=dZ[Z];if(K===void 0)K=new Float32Array(Z),dZ[Z]=K;if(Q!==0){W.toArray(K,0);for(let H=1,Y=0;H!==Q;++H)Y+=$,J[H].toArray(K,Y)}return K}function q8(J,Q){if(J.length!==Q.length)return!1;for(let $=0,W=J.length;$<W;$++)if(J[$]!==Q[$])return!1;return!0}function F8(J,Q){for(let $=0,W=Q.length;$<W;$++)J[$]=Q[$]}function UJ(J,Q){let $=uZ[Q];if($===void 0)$=new Int32Array(Q),uZ[Q]=$;for(let W=0;W!==Q;++W)$[W]=J.allocateTextureUnit();return $}function lU(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1f(this.addr,Q),$[0]=Q}function dU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2f(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(q8($,Q))return;J.uniform2fv(this.addr,Q),F8($,Q)}}function uU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3f(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else if(Q.r!==void 0){if($[0]!==Q.r||$[1]!==Q.g||$[2]!==Q.b)J.uniform3f(this.addr,Q.r,Q.g,Q.b),$[0]=Q.r,$[1]=Q.g,$[2]=Q.b}else{if(q8($,Q))return;J.uniform3fv(this.addr,Q),F8($,Q)}}function cU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4f(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(q8($,Q))return;J.uniform4fv(this.addr,Q),F8($,Q)}}function nU(J,Q){let $=this.cache,W=Q.elements;if(W===void 0){if(q8($,Q))return;J.uniformMatrix2fv(this.addr,!1,Q),F8($,Q)}else{if(q8($,W))return;sZ.set(W),J.uniformMatrix2fv(this.addr,!1,sZ),F8($,W)}}function sU(J,Q){let $=this.cache,W=Q.elements;if(W===void 0){if(q8($,Q))return;J.uniformMatrix3fv(this.addr,!1,Q),F8($,Q)}else{if(q8($,W))return;nZ.set(W),J.uniformMatrix3fv(this.addr,!1,nZ),F8($,W)}}function iU(J,Q){let $=this.cache,W=Q.elements;if(W===void 0){if(q8($,Q))return;J.uniformMatrix4fv(this.addr,!1,Q),F8($,Q)}else{if(q8($,W))return;cZ.set(W),J.uniformMatrix4fv(this.addr,!1,cZ),F8($,W)}}function oU(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1i(this.addr,Q),$[0]=Q}function aU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2i(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(q8($,Q))return;J.uniform2iv(this.addr,Q),F8($,Q)}}function rU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3i(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(q8($,Q))return;J.uniform3iv(this.addr,Q),F8($,Q)}}function tU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4i(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(q8($,Q))return;J.uniform4iv(this.addr,Q),F8($,Q)}}function eU(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1ui(this.addr,Q),$[0]=Q}function J5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2ui(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(q8($,Q))return;J.uniform2uiv(this.addr,Q),F8($,Q)}}function Q5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3ui(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(q8($,Q))return;J.uniform3uiv(this.addr,Q),F8($,Q)}}function $5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4ui(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(q8($,Q))return;J.uniform4uiv(this.addr,Q),F8($,Q)}}function W5(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;let K;if(this.type===J.SAMPLER_2D_SHADOW)j$.compareFunction=$.isReversedDepthBuffer()?u7:d7,K=j$;else K=XK;$.setTexture2D(Q||K,Z)}function Z5(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;$.setTexture3D(Q||GK,Z)}function K5(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;$.setTextureCube(Q||NK,Z)}function H5(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;$.setTexture2DArray(Q||UK,Z)}function Y5(J){switch(J){case 5126:return lU;case 35664:return dU;case 35665:return uU;case 35666:return cU;case 35674:return nU;case 35675:return sU;case 35676:return iU;case 5124:case 35670:return oU;case 35667:case 35671:return aU;case 35668:case 35672:return rU;case 35669:case 35673:return tU;case 5125:return eU;case 36294:return J5;case 36295:return Q5;case 36296:return $5;case 35678:case 36198:case 36298:case 36306:case 35682:return W5;case 35679:case 36299:case 36307:return Z5;case 35680:case 36300:case 36308:case 36293:return K5;case 36289:case 36303:case 36311:case 36292:return H5}}function X5(J,Q){J.uniform1fv(this.addr,Q)}function U5(J,Q){let $=P6(Q,this.size,2);J.uniform2fv(this.addr,$)}function G5(J,Q){let $=P6(Q,this.size,3);J.uniform3fv(this.addr,$)}function N5(J,Q){let $=P6(Q,this.size,4);J.uniform4fv(this.addr,$)}function E5(J,Q){let $=P6(Q,this.size,4);J.uniformMatrix2fv(this.addr,!1,$)}function q5(J,Q){let $=P6(Q,this.size,9);J.uniformMatrix3fv(this.addr,!1,$)}function F5(J,Q){let $=P6(Q,this.size,16);J.uniformMatrix4fv(this.addr,!1,$)}function D5(J,Q){J.uniform1iv(this.addr,Q)}function O5(J,Q){J.uniform2iv(this.addr,Q)}function M5(J,Q){J.uniform3iv(this.addr,Q)}function R5(J,Q){J.uniform4iv(this.addr,Q)}function k5(J,Q){J.uniform1uiv(this.addr,Q)}function L5(J,Q){J.uniform2uiv(this.addr,Q)}function V5(J,Q){J.uniform3uiv(this.addr,Q)}function B5(J,Q){J.uniform4uiv(this.addr,Q)}function z5(J,Q,$){let W=this.cache,Z=Q.length,K=UJ($,Z);if(!q8(W,K))J.uniform1iv(this.addr,K),F8(W,K);let H;if(this.type===J.SAMPLER_2D_SHADOW)H=j$;else H=XK;for(let Y=0;Y!==Z;++Y)$.setTexture2D(Q[Y]||H,K[Y])}function I5(J,Q,$){let W=this.cache,Z=Q.length,K=UJ($,Z);if(!q8(W,K))J.uniform1iv(this.addr,K),F8(W,K);for(let H=0;H!==Z;++H)$.setTexture3D(Q[H]||GK,K[H])}function _5(J,Q,$){let W=this.cache,Z=Q.length,K=UJ($,Z);if(!q8(W,K))J.uniform1iv(this.addr,K),F8(W,K);for(let H=0;H!==Z;++H)$.setTextureCube(Q[H]||NK,K[H])}function C5(J,Q,$){let W=this.cache,Z=Q.length,K=UJ($,Z);if(!q8(W,K))J.uniform1iv(this.addr,K),F8(W,K);for(let H=0;H!==Z;++H)$.setTexture2DArray(Q[H]||UK,K[H])}function A5(J){switch(J){case 5126:return X5;case 35664:return U5;case 35665:return G5;case 35666:return N5;case 35674:return E5;case 35675:return q5;case 35676:return F5;case 5124:case 35670:return D5;case 35667:case 35671:return O5;case 35668:case 35672:return M5;case 35669:case 35673:return R5;case 5125:return k5;case 36294:return L5;case 36295:return V5;case 36296:return B5;case 35678:case 36198:case 36298:case 36306:case 35682:return z5;case 35679:case 36299:case 36307:return I5;case 35680:case 36300:case 36308:case 36293:return _5;case 36289:case 36303:case 36311:case 36292:return C5}}class EK{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.setValue=Y5(Q.type)}}class qK{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.size=Q.size,this.setValue=A5(Q.type)}}class FK{constructor(J){this.id=J,this.seq=[],this.map={}}setValue(J,Q,$){let W=this.seq;for(let Z=0,K=W.length;Z!==K;++Z){let H=W[Z];H.setValue(J,Q[H.id],$)}}}var w$=/(\w+)(\])?(\[|\.)?/g;function iZ(J,Q){J.seq.push(Q),J.map[Q.id]=Q}function P5(J,Q,$){let W=J.name,Z=W.length;w$.lastIndex=0;while(!0){let K=w$.exec(W),H=w$.lastIndex,Y=K[1],X=K[2]==="]",U=K[3];if(X)Y=Y|0;if(U===void 0||U==="["&&H+2===Z){iZ($,U===void 0?new EK(Y,J,Q):new qK(Y,J,Q));break}else{let N=$.map[Y];if(N===void 0)N=new FK(Y),iZ($,N);$=N}}}class r6{constructor(J,Q){this.seq=[],this.map={};let $=J.getProgramParameter(Q,J.ACTIVE_UNIFORMS);for(let K=0;K<$;++K){let H=J.getActiveUniform(Q,K),Y=J.getUniformLocation(Q,H.name);P5(H,Y,this)}let W=[],Z=[];for(let K of this.seq)if(K.type===J.SAMPLER_2D_SHADOW||K.type===J.SAMPLER_CUBE_SHADOW||K.type===J.SAMPLER_2D_ARRAY_SHADOW)W.push(K);else Z.push(K);if(W.length>0)this.seq=W.concat(Z)}setValue(J,Q,$,W){let Z=this.map[Q];if(Z!==void 0)Z.setValue(J,$,W)}setOptional(J,Q,$){let W=Q[$];if(W!==void 0)this.setValue(J,$,W)}static upload(J,Q,$,W){for(let Z=0,K=Q.length;Z!==K;++Z){let H=Q[Z],Y=$[H.id];if(Y.needsUpdate!==!1)H.setValue(J,Y.value,W)}}static seqWithValue(J,Q){let $=[];for(let W=0,Z=J.length;W!==Z;++W){let K=J[W];if(K.id in Q)$.push(K)}return $}}function oZ(J,Q,$){let W=J.createShader(Q);return J.shaderSource(W,$),J.compileShader(W),W}var w5=37297,T5=0;function S5(J,Q){let $=J.split(`
`),W=[],Z=Math.max(Q-6,0),K=Math.min(Q+6,$.length);for(let H=Z;H<K;H++){let Y=H+1;W.push(`${Y===Q?">":" "} ${Y}: ${$[H]}`)}return W.join(`
`)}var aZ=new w0;function j5(J){g0._getMatrix(aZ,g0.workingColorSpace,J);let Q=`mat3( ${aZ.elements.map(($)=>$.toFixed(4))} )`;switch(g0.getTransfer(J)){case sQ:return[Q,"LinearTransferOETF"];case e0:return[Q,"sRGBTransferOETF"];default:return C0("WebGLProgram: Unsupported color space: ",J),[Q,"LinearTransferOETF"]}}function rZ(J,Q,$){let W=J.getShaderParameter(Q,J.COMPILE_STATUS),K=(J.getShaderInfoLog(Q)||"").trim();if(W&&K==="")return"";let H=/ERROR: 0:(\d+)/.exec(K);if(H){let Y=parseInt(H[1]);return $.toUpperCase()+`

`+K+`

`+S5(J.getShaderSource(Q),Y)}else return K}function v5(J,Q){let $=j5(Q);return[`vec4 ${J}( vec4 value ) {`,`	return ${$[1]}( vec4( value.rgb * ${$[0]}, value.a ) );`,"}"].join(`
`)}var f5={[$Q]:"Linear",[WQ]:"Reinhard",[ZQ]:"Cineon",[KQ]:"ACESFilmic",[YQ]:"AgX",[XQ]:"Neutral",[HQ]:"Custom"};function y5(J,Q){let $=f5[Q];if($===void 0)return C0("WebGLProgram: Unsupported toneMapping:",Q),"vec3 "+J+"( vec3 color ) { return LinearToneMapping( color ); }";return"vec3 "+J+"( vec3 color ) { return "+$+"ToneMapping( color ); }"}var YJ=new h;function b5(){g0.getLuminanceCoefficients(YJ);let J=YJ.x.toFixed(4),Q=YJ.y.toFixed(4),$=YJ.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${Q}, ${$} );`,"\treturn dot( weights, rgb );","}"].join(`
`)}function h5(J){return[J.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",J.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(a6).join(`
`)}function x5(J){let Q=[];for(let $ in J){let W=J[$];if(W===!1)continue;Q.push("#define "+$+" "+W)}return Q.join(`
`)}function g5(J,Q){let $={},W=J.getProgramParameter(Q,J.ACTIVE_ATTRIBUTES);for(let Z=0;Z<W;Z++){let K=J.getActiveAttrib(Q,Z),H=K.name,Y=1;if(K.type===J.FLOAT_MAT2)Y=2;if(K.type===J.FLOAT_MAT3)Y=3;if(K.type===J.FLOAT_MAT4)Y=4;$[H]={type:K.type,location:J.getAttribLocation(Q,H),locationSize:Y}}return $}function a6(J){return J!==""}function tZ(J,Q){let $=Q.numSpotLightShadows+Q.numSpotLightMaps-Q.numSpotLightShadowsWithMaps;return J.replace(/NUM_DIR_LIGHTS/g,Q.numDirLights).replace(/NUM_SPOT_LIGHTS/g,Q.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,Q.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,$).replace(/NUM_RECT_AREA_LIGHTS/g,Q.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,Q.numPointLights).replace(/NUM_HEMI_LIGHTS/g,Q.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,Q.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,Q.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,Q.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,Q.numPointLightShadows)}function eZ(J,Q){return J.replace(/NUM_CLIPPING_PLANES/g,Q.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,Q.numClippingPlanes-Q.numClipIntersection)}var p5=/^[ \t]*#include +<([\w\d./]+)>/gm;function v$(J){return J.replace(p5,l5)}var m5=new Map;function l5(J,Q){let $=v0[Q];if($===void 0){let W=m5.get(Q);if(W!==void 0)$=v0[W],C0('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',Q,W);else throw Error("THREE.WebGLProgram: Can not resolve #include <"+Q+">")}return v$($)}var d5=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function JK(J){return J.replace(d5,u5)}function u5(J,Q,$,W){let Z="";for(let K=parseInt(Q);K<parseInt($);K++)Z+=W.replace(/\[\s*i\s*\]/g,"[ "+K+" ]").replace(/UNROLLED_LOOP_INDEX/g,K);return Z}function QK(J){let Q=`precision ${J.precision} float;
...
#define LOW_PRECISION`;return Q}var c5={[x6]:"SHADOWMAP_TYPE_PCF",[L6]:"SHADOWMAP_TYPE_VSM"};function n5(J){return c5[J.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var s5={[z6]:"ENVMAP_TYPE_CUBE",[l9]:"ENVMAP_TYPE_CUBE",[p6]:"ENVMAP_TYPE_CUBE_UV"};function i5(J){if(J.envMap===!1)return"ENVMAP_TYPE_CUBE";return s5[J.envMapMode]||"ENVMAP_TYPE_CUBE"}var o5={[l9]:"ENVMAP_MODE_REFRACTION"};function a5(J){if(J.envMap===!1)return"ENVMAP_MODE_REFLECTION";return o5[J.envMapMode]||"ENVMAP_MODE_REFLECTION"}var r5={[EZ]:"ENVMAP_BLENDING_MULTIPLY",[qZ]:"ENVMAP_BLENDING_MIX",[FZ]:"ENVMAP_BLENDING_ADD"};function t5(J){if(J.envMap===!1)return"ENVMAP_BLENDING_NONE";return r5[J.combine]||"ENVMAP_BLENDING_NONE"}function e5(J){let Q=J.envMapCubeUVHeight;if(Q===null)return null;let $=Math.log2(Q)-2,W=1/Q;return{texelWidth:1/(3*Math.max(Math.pow(2,$),112)),texelHeight:W,maxMip:$}}function J1(J,Q,$,W){let Z=J.getContext(),K=$.defines,H=$.vertexShader,Y=$.fragmentShader,X=n5($),U=i5($),E=a5($),N=t5($),G=e5($),F=h5($),R=x5(K),I=Z.createProgram(),D,q,C=$.glslVersion?"#version "+$.glslVersion+`
...
`)+`
`+q;let P=C+D+H,k=C+q+Y,V=oZ(Z,Z.VERTEX_SHADER,P),_=oZ(Z,Z.FRAGMENT_SHADER,k);if(Z.attachShader(I,V),Z.attachShader(I,_),$.index0AttributeName!==void 0)Z.bindAttribLocation(I,0,$.index0AttributeName);else if($.hasPositionAttribute===!0)Z.bindAttribLocation(I,0,"position");Z.linkProgram(I);function A(w){if(J.debug.checkShaderErrors){let y=Z.getProgramInfoLog(I)||"",c=Z.getShaderInfoLog(V)||"",b=Z.getShaderInfoLog(_)||"",u=y.trim(),m=c.trim(),f=b.trim(),a=!0,e=!0;if(Z.getProgramParameter(I,Z.LINK_STATUS)===!1)if(a=!1,typeof J.debug.onShaderError==="function")J.debug.onShaderError(Z,I,V,_);else{let J0=rZ(Z,V,"vertex"),k0=rZ(Z,_,"fragment");P0("WebGLProgram: Shader Error "+Z.getError()+" - VALIDATE_STATUS "+Z.getProgramParameter(I,Z.VALIDATE_STATUS)+`
