...
#endif`,LY="gl_FragColor = linearToOutputTexel( gl_FragColor );",VY=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:$9,depthTest:!1,depthWrite:!1})}function fU(J,Q,$){let W=new Float32Array(J6),Z=new h(0,1,0);return new T8({name:"SphericalGaussianBlur",defines:{n:J6,CUBEUV_TEXEL_WIDTH:1/Q,CUBEUV_TEXEL_HEIGHT:1/$,CUBEUV_MAX_MIP:`${J}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:W},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:Z}},vertexShader:XJ(),fragmentShader:`
		...
		`,blending:$9,depthTest:!1,depthWrite:!1})}function uZ(){return new T8({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:XJ(),fragmentShader:`
		...
		`,blending:$9,depthTest:!1,depthWrite:!1})}function cZ(){return new T8({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:XJ(),fragmentShader:`
	...
	`}class y$ extends c8{constructor(J=1,Q={}){super(J,J,Q);this.isWebGLCubeRenderTarget=!0;let $={width:J,height:J,depth:1},W=[$,$,$,$,$,$];this.texture=new QJ(W),this._setTextureOptions(Q),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(J,Q){this.texture.type=Q.type,this.texture.colorSpace=Q.colorSpace,this.texture.generateMipmaps=Q.generateMipmaps,this.texture.minFilter=Q.minFilter,this.texture.magFilter=Q.magFilter;let $={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),E=new x8(X,U),N=new C6(-1,1,1,-1,0,1),G=null,F=null,R=!1,I,D=null,q=[],C=!1;this.setSize=function(P,k){H.setSize(P,k),Y.setSize(P,k);for(let _=0;_<q.length;_++){let V=q[_];if(V.setSize)V.setSize(P,k)}},this.setEffects=function(P){q=P,C=q.length>0&&q[0].isRenderPass===!0;let{width:k,height:_}=H;for(let V=0;V<q.length;V++){let A=q[V];if(A.setSize)A.setSize(k,_)}},this.begin=function(P,k){if(R)return!1;if(P.toneMapping===r8&&q.length===0)return!1;if(D=k,k!==null){let{width:_,height:V}=k;if(H.width!==_||H.height!==V)this.setSize(_,V)}if(C===!1)P.setRenderTarget(H);return I=P.toneMapping,P.toneMapping=r8,!0},this.hasRenderPass=function(){return C},this.end=function(P,k){P.toneMapping=I,R=!0;let _=H,V=Y;for(let A=0;A<q.length;A++){let O=q[A];if(O.enabled===!1)continue;if(O.render(P,V,_,k),O.needsSwap!==!1){let z=_;_=V,V=z}}if(G!==P.outputColorSpace||F!==P.toneMapping){if(G=P.outputColorSpace,F=P.toneMapping,U.defines={},g0.getTransfer(G)===e0)U.defines.SRGB_TRANSFER="";let A=lU[F];if(A)U.defines[A]="";U.needsUpdate=!0}U.uniforms.tDiffuse.value=_.texture,P.setRenderTarget(D),P.render(E,N),D=null,R=!1},this.isCompositing=function(){return R},this.dispose=function(){if(H.depthTexture)H.depthTexture.dispose();H.dispose(),Y.dispose(),X.dispose(),U.dispose()}}var NK=new z8,v$=new v9(1,1),EK=new c7,qK=new Q$,FK=new QJ,nZ=[],sZ=[],iZ=new Float32Array(16),oZ=new Float32Array(9),aZ=new Float32Array(4);function P6(J,Q,$){let W=J[0];if(W<=0||W>0)return J;let Z=Q*$,K=nZ[Z];if(K===void 0)K=new Float32Array(Z),nZ[Z]=K;if(Q!==0){W.toArray(K,0);for(let H=1,Y=0;H!==Q;++H)Y+=$,J[H].toArray(K,Y)}return K}function q8(J,Q){if(J.length!==Q.length)return!1;for(let $=0,W=J.length;$<W;$++)if(J[$]!==Q[$])return!1;return!0}function F8(J,Q){for(let $=0,W=Q.length;$<W;$++)J[$]=Q[$]}function UJ(J,Q){let $=sZ[Q];if($===void 0)$=new Int32Array(Q),sZ[Q]=$;for(let W=0;W!==Q;++W)$[W]=J.allocateTextureUnit();return $}function uU(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1f(this.addr,Q),$[0]=Q}function cU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2f(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(q8($,Q))return;J.uniform2fv(this.addr,Q),F8($,Q)}}function nU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3f(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else if(Q.r!==void 0){if($[0]!==Q.r||$[1]!==Q.g||$[2]!==Q.b)J.uniform3f(this.addr,Q.r,Q.g,Q.b),$[0]=Q.r,$[1]=Q.g,$[2]=Q.b}else{if(q8($,Q))return;J.uniform3fv(this.addr,Q),F8($,Q)}}function sU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4f(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(q8($,Q))return;J.uniform4fv(this.addr,Q),F8($,Q)}}function iU(J,Q){let $=this.cache,W=Q.elements;if(W===void 0){if(q8($,Q))return;J.uniformMatrix2fv(this.addr,!1,Q),F8($,Q)}else{if(q8($,W))return;aZ.set(W),J.uniformMatrix2fv(this.addr,!1,aZ),F8($,W)}}function oU(J,Q){let $=this.cache,W=Q.elements;if(W===void 0){if(q8($,Q))return;J.uniformMatrix3fv(this.addr,!1,Q),F8($,Q)}else{if(q8($,W))return;oZ.set(W),J.uniformMatrix3fv(this.addr,!1,oZ),F8($,W)}}function aU(J,Q){let $=this.cache,W=Q.elements;if(W===void 0){if(q8($,Q))return;J.uniformMatrix4fv(this.addr,!1,Q),F8($,Q)}else{if(q8($,W))return;iZ.set(W),J.uniformMatrix4fv(this.addr,!1,iZ),F8($,W)}}function rU(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1i(this.addr,Q),$[0]=Q}function tU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2i(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(q8($,Q))return;J.uniform2iv(this.addr,Q),F8($,Q)}}function eU(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3i(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(q8($,Q))return;J.uniform3iv(this.addr,Q),F8($,Q)}}function J5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4i(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(q8($,Q))return;J.uniform4iv(this.addr,Q),F8($,Q)}}function Q5(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1ui(this.addr,Q),$[0]=Q}function $5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2ui(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(q8($,Q))return;J.uniform2uiv(this.addr,Q),F8($,Q)}}function W5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3ui(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(q8($,Q))return;J.uniform3uiv(this.addr,Q),F8($,Q)}}function Z5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4ui(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(q8($,Q))return;J.uniform4uiv(this.addr,Q),F8($,Q)}}function K5(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;let K;if(this.type===J.SAMPLER_2D_SHADOW)v$.compareFunction=$.isReversedDepthBuffer()?u7:d7,K=v$;else K=NK;$.setTexture2D(Q||K,Z)}function H5(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;$.setTexture3D(Q||qK,Z)}function Y5(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;$.setTextureCube(Q||FK,Z)}function X5(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;$.setTexture2DArray(Q||EK,Z)}function U5(J){switch(J){case 5126:return uU;case 35664:return cU;case 35665:return nU;case 35666:return sU;case 35674:return iU;case 35675:return oU;case 35676:return aU;case 5124:case 35670:return rU;case 35667:case 35671:return tU;case 35668:case 35672:return eU;case 35669:case 35673:return J5;case 5125:return Q5;case 36294:return $5;case 36295:return W5;case 36296:return Z5;case 35678:case 36198:case 36298:case 36306:case 35682:return K5;case 35679:case 36299:case 36307:return H5;case 35680:case 36300:case 36308:case 36293:return Y5;case 36289:case 36303:case 36311:case 36292:return X5}}function G5(J,Q){J.uniform1fv(this.addr,Q)}function N5(J,Q){let $=P6(Q,this.size,2);J.uniform2fv(this.addr,$)}function E5(J,Q){let $=P6(Q,this.size,3);J.uniform3fv(this.addr,$)}function q5(J,Q){let $=P6(Q,this.size,4);J.uniform4fv(this.addr,$)}function F5(J,Q){let $=P6(Q,this.size,4);J.uniformMatrix2fv(this.addr,!1,$)}function D5(J,Q){let $=P6(Q,this.size,9);J.uniformMatrix3fv(this.addr,!1,$)}function O5(J,Q){let $=P6(Q,this.size,16);J.uniformMatrix4fv(this.addr,!1,$)}function M5(J,Q){J.uniform1iv(this.addr,Q)}function R5(J,Q){J.uniform2iv(this.addr,Q)}function k5(J,Q){J.uniform3iv(this.addr,Q)}function L5(J,Q){J.uniform4iv(this.addr,Q)}function V5(J,Q){J.uniform1uiv(this.addr,Q)}function B5(J,Q){J.uniform2uiv(this.addr,Q)}function z5(J,Q){J.uniform3uiv(this.addr,Q)}function I5(J,Q){J.uniform4uiv(this.addr,Q)}function _5(J,Q,$){let W=this.cache,Z=Q.length,K=UJ($,Z);if(!q8(W,K))J.uniform1iv(this.addr,K),F8(W,K);let H;if(this.type===J.SAMPLER_2D_SHADOW)H=v$;else H=NK;for(let Y=0;Y!==Z;++Y)$.setTexture2D(Q[Y]||H,K[Y])}function C5(J,Q,$){let W=this.cache,Z=Q.length,K=UJ($,Z);if(!q8(W,K))J.uniform1iv(this.addr,K),F8(W,K);for(let H=0;H!==Z;++H)$.setTexture3D(Q[H]||qK,K[H])}function A5(J,Q,$){let W=this.cache,Z=Q.length,K=UJ($,Z);if(!q8(W,K))J.uniform1iv(this.addr,K),F8(W,K);for(let H=0;H!==Z;++H)$.setTextureCube(Q[H]||FK,K[H])}function P5(J,Q,$){let W=this.cache,Z=Q.length,K=UJ($,Z);if(!q8(W,K))J.uniform1iv(this.addr,K),F8(W,K);for(let H=0;H!==Z;++H)$.setTexture2DArray(Q[H]||EK,K[H])}function w5(J){switch(J){case 5126:return G5;case 35664:return N5;case 35665:return E5;case 35666:return q5;case 35674:return F5;case 35675:return D5;case 35676:return O5;case 5124:case 35670:return M5;case 35667:case 35671:return R5;case 35668:case 35672:return k5;case 35669:case 35673:return L5;case 5125:return V5;case 36294:return B5;case 36295:return z5;case 36296:return I5;case 35678:case 36198:case 36298:case 36306:case 35682:return _5;case 35679:case 36299:case 36307:return C5;case 35680:case 36300:case 36308:case 36293:return A5;case 36289:case 36303:case 36311:case 36292:return P5}}class DK{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.setValue=U5(Q.type)}}class OK{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.size=Q.size,this.setValue=w5(Q.type)}}class MK{constructor(J){this.id=J,this.seq=[],this.map={}}setValue(J,Q,$){let W=this.seq;for(let Z=0,K=W.length;Z!==K;++Z){let H=W[Z];H.setValue(J,Q[H.id],$)}}}var T$=/(\w+)(\])?(\[|\.)?/g;function rZ(J,Q){J.seq.push(Q),J.map[Q.id]=Q}function T5(J,Q,$){let W=J.name,Z=W.length;T$.lastIndex=0;while(!0){let K=T$.exec(W),H=T$.lastIndex,Y=K[1],X=K[2]==="]",U=K[3];if(X)Y=Y|0;if(U===void 0||U==="["&&H+2===Z){rZ($,U===void 0?new DK(Y,J,Q):new OK(Y,J,Q));break}else{let N=$.map[Y];if(N===void 0)N=new MK(Y),rZ($,N);$=N}}}class r6{constructor(J,Q){this.seq=[],this.map={};let $=J.getProgramParameter(Q,J.ACTIVE_UNIFORMS);for(let K=0;K<$;++K){let H=J.getActiveUniform(Q,K),Y=J.getUniformLocation(Q,H.name);T5(H,Y,this)}let W=[],Z=[];for(let K of this.seq)if(K.type===J.SAMPLER_2D_SHADOW||K.type===J.SAMPLER_CUBE_SHADOW||K.type===J.SAMPLER_2D_ARRAY_SHADOW)W.push(K);else Z.push(K);if(W.length>0)this.seq=W.concat(Z)}setValue(J,Q,$,W){let Z=this.map[Q];if(Z!==void 0)Z.setValue(J,$,W)}setOptional(J,Q,$){let W=Q[$];if(W!==void 0)this.setValue(J,$,W)}static upload(J,Q,$,W){for(let Z=0,K=Q.length;Z!==K;++Z){let H=Q[Z],Y=$[H.id];if(Y.needsUpdate!==!1)H.setValue(J,Y.value,W)}}static seqWithValue(J,Q){let $=[];for(let W=0,Z=J.length;W!==Z;++W){let K=J[W];if(K.id in Q)$.push(K)}return $}}function tZ(J,Q,$){let W=J.createShader(Q);return J.shaderSource(W,$),J.compileShader(W),W}var S5=37297,j5=0;function v5(J,Q){let $=J.split(`
`),W=[],Z=Math.max(Q-6,0),K=Math.min(Q+6,$.length);for(let H=Z;H<K;H++){let Y=H+1;W.push(`${Y===Q?">":" "} ${Y}: ${$[H]}`)}return W.join(`
`)}var eZ=new w0;function f5(J){g0._getMatrix(eZ,g0.workingColorSpace,J);let Q=`mat3( ${eZ.elements.map(($)=>$.toFixed(4))} )`;switch(g0.getTransfer(J)){case iQ:return[Q,"LinearTransferOETF"];case e0:return[Q,"sRGBTransferOETF"];default:return C0("WebGLProgram: Unsupported color space: ",J),[Q,"LinearTransferOETF"]}}function JK(J,Q,$){let W=J.getShaderParameter(Q,J.COMPILE_STATUS),K=(J.getShaderInfoLog(Q)||"").trim();if(W&&K==="")return"";let H=/ERROR: 0:(\d+)/.exec(K);if(H){let Y=parseInt(H[1]);return $.toUpperCase()+`

`+K+`

`+v5(J.getShaderSource(Q),Y)}else return K}function y5(J,Q){let $=f5(Q);return[`vec4 ${J}( vec4 value ) {`,`	return ${$[1]}( vec4( value.rgb * ${$[0]}, value.a ) );`,"}"].join(`
`)}var b5={[WQ]:"Linear",[ZQ]:"Reinhard",[KQ]:"Cineon",[HQ]:"ACESFilmic",[XQ]:"AgX",[UQ]:"Neutral",[YQ]:"Custom"};function h5(J,Q){let $=b5[Q];if($===void 0)return C0("WebGLProgram: Unsupported toneMapping:",Q),"vec3 "+J+"( vec3 color ) { return LinearToneMapping( color ); }";return"vec3 "+J+"( vec3 color ) { return "+$+"ToneMapping( color ); }"}var YJ=new h;function x5(){g0.getLuminanceCoefficients(YJ);let J=YJ.x.toFixed(4),Q=YJ.y.toFixed(4),$=YJ.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${Q}, ${$} );`,"\treturn dot( weights, rgb );","}"].join(`
`)}function g5(J){return[J.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",J.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(a6).join(`
`)}function p5(J){let Q=[];for(let $ in J){let W=J[$];if(W===!1)continue;Q.push("#define "+$+" "+W)}return Q.join(`
`)}function m5(J,Q){let $={},W=J.getProgramParameter(Q,J.ACTIVE_ATTRIBUTES);for(let Z=0;Z<W;Z++){let K=J.getActiveAttrib(Q,Z),H=K.name,Y=1;if(K.type===J.FLOAT_MAT2)Y=2;if(K.type===J.FLOAT_MAT3)Y=3;if(K.type===J.FLOAT_MAT4)Y=4;$[H]={type:K.type,location:J.getAttribLocation(Q,H),locationSize:Y}}return $}function a6(J){return J!==""}function QK(J,Q){let $=Q.numSpotLightShadows+Q.numSpotLightMaps-Q.numSpotLightShadowsWithMaps;return J.replace(/NUM_DIR_LIGHTS/g,Q.numDirLights).replace(/NUM_SPOT_LIGHTS/g,Q.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,Q.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,$).replace(/NUM_RECT_AREA_LIGHTS/g,Q.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,Q.numPointLights).replace(/NUM_HEMI_LIGHTS/g,Q.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,Q.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,Q.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,Q.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,Q.numPointLightShadows)}function $K(J,Q){return J.replace(/NUM_CLIPPING_PLANES/g,Q.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,Q.numClippingPlanes-Q.numClipIntersection)}var l5=/^[ \t]*#include +<([\w\d./]+)>/gm;function f$(J){return J.replace(l5,u5)}var d5=new Map;function u5(J,Q){let $=v0[Q];if($===void 0){let W=d5.get(Q);if(W!==void 0)$=v0[W],C0('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',Q,W);else throw Error("THREE.WebGLProgram: Can not resolve #include <"+Q+">")}return f$($)}var c5=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function WK(J){return J.replace(c5,n5)}function n5(J,Q,$,W){let Z="";for(let K=parseInt(Q);K<parseInt($);K++)Z+=W.replace(/\[\s*i\s*\]/g,"[ "+K+" ]").replace(/UNROLLED_LOOP_INDEX/g,K);return Z}function ZK(J){let Q=`precision ${J.precision} float;
...
#define LOW_PRECISION`;return Q}var s5={[x6]:"SHADOWMAP_TYPE_PCF",[L6]:"SHADOWMAP_TYPE_VSM"};function i5(J){return s5[J.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var o5={[z6]:"ENVMAP_TYPE_CUBE",[l9]:"ENVMAP_TYPE_CUBE",[p6]:"ENVMAP_TYPE_CUBE_UV"};function a5(J){if(J.envMap===!1)return"ENVMAP_TYPE_CUBE";return o5[J.envMapMode]||"ENVMAP_TYPE_CUBE"}var r5={[l9]:"ENVMAP_MODE_REFRACTION"};function t5(J){if(J.envMap===!1)return"ENVMAP_MODE_REFLECTION";return r5[J.envMapMode]||"ENVMAP_MODE_REFLECTION"}var e5={[DZ]:"ENVMAP_BLENDING_MULTIPLY",[OZ]:"ENVMAP_BLENDING_MIX",[MZ]:"ENVMAP_BLENDING_ADD"};function J1(J){if(J.envMap===!1)return"ENVMAP_BLENDING_NONE";return e5[J.combine]||"ENVMAP_BLENDING_NONE"}function Q1(J){let Q=J.envMapCubeUVHeight;if(Q===null)return null;let $=Math.log2(Q)-2,W=1/Q;return{texelWidth:1/(3*Math.max(Math.pow(2,$),112)),texelHeight:W,maxMip:$}}function $1(J,Q,$,W){let Z=J.getContext(),K=$.defines,H=$.vertexShader,Y=$.fragmentShader,X=i5($),U=a5($),E=t5($),N=J1($),G=Q1($),F=g5($),R=p5(K),I=Z.createProgram(),D,q,C=$.glslVersion?"#version "+$.glslVersion+`
...
`)+`
`+q;let P=C+D+H,k=C+q+Y,_=tZ(Z,Z.VERTEX_SHADER,P),V=tZ(Z,Z.FRAGMENT_SHADER,k);if(Z.attachShader(I,_),Z.attachShader(I,V),$.index0AttributeName!==void 0)Z.bindAttribLocation(I,0,$.index0AttributeName);else if($.hasPositionAttribute===!0)Z.bindAttribLocation(I,0,"position");Z.linkProgram(I);function A(w){if(J.debug.checkShaderErrors){let y=Z.getProgramInfoLog(I)||"",c=Z.getShaderInfoLog(_)||"",b=Z.getShaderInfoLog(V)||"",u=y.trim(),m=c.trim(),f=b.trim(),a=!0,e=!0;if(Z.getProgramParameter(I,Z.LINK_STATUS)===!1)if(a=!1,typeof J.debug.onShaderError==="function")J.debug.onShaderError(Z,I,_,V);else{let J0=JK(Z,_,"vertex"),k0=JK(Z,V,"fragment");P0("WebGLProgram: Shader Error "+Z.getError()+" - VALIDATE_STATUS "+Z.getProgramParameter(I,Z.VALIDATE_STATUS)+`
...
gl_Position=projectionMatrix*modelViewMatrix*vec4(position.xy*(uContext>0.?max(86.,74./uScale):86.)+center,1.,1.);}`,_K=`
...
void main(){vTint=tint;vMeta=leafMeta;vCluster=leafCluster;vLife=leafLife;gl_PointSize=(uContext>1.?23.:17.)*uDpr;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,wK=`
