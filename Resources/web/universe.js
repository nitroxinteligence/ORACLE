...
`)}var HU={[PJ]:"Linear",[TJ]:"Reinhard",[SJ]:"Cineon",[jJ]:"ACESFilmic",[vJ]:"AgX",[fJ]:"Neutral",[yJ]:"Custom"};function YU(J,Q){let $=HU[Q];if($===void 0)return I0("WebGLProgram: Unsupported toneMapping:",Q),"vec3 "+J+"( vec3 color ) { return LinearToneMapping( color ); }";return"vec3 "+J+"( vec3 color ) { return "+$+"ToneMapping( color ); }"}var i7=new v;function XU(){x0.getLuminanceCoefficients(i7);let J=i7.x.toFixed(4),Q=i7.y.toFixed(4),$=i7.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${Q}, ${$} );`,"\treturn dot( weights, rgb );","}"].join(`
