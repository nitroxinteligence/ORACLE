...
let collections: [(String, String, String)] = [("ads","Ads","megaphone"),("code","Code","code"),("contents","Contents","note"),("customer-finder","Customer Finder","search"),("marketing","Marketing","chart"),("personal-branding","Personal Branding","person")]
