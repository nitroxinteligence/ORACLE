...
struct OracleCodexModel {
    ...
    static func choose(_ rows: [[String: Any]], preferred: String? = nil, preferredEffort: String? = nil) throws -> OracleCodexModel {
        ...
        guard let row=chosen,let id=row["model"] as? String,
              let effort=preferredEffort ?? row["defaultReasoningEffort"] as? String,
